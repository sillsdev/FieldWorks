...
```powershell
python .agents/skills/atlassian-readonly-skills/scripts/jira.py issue LT-XXXXX
python .agents/skills/atlassian-readonly-skills/scripts/jira.py comments LT-XXXXX
python .agents/skills/atlassian-readonly-skills/scripts/jira.py attachments LT-XXXXX
```

Use `--all-fields` only when the common field set is not enough. Download screenshots or other evidence with `download-attachments` into `Output/Jira/LT-XXXXX`.
