...
- Documentation changes should follow `Docs/agent-docs-refresh.md` (detect → plan → validate flow) when touching folder docs; maintain `last-reviewed-tree` metadata.
