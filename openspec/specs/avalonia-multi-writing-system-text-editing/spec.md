# avalonia-multi-writing-system-text-editing Specification

## Purpose

Define the managed multi-writing-system text foundation: how `ITsString` fields
round-trip without flattening, how writing-system defaults drive font, direction
and keyboard, and what evidence a parity claim requires.
## Requirements
