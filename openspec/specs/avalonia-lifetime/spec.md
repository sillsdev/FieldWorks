# avalonia-lifetime Specification

## Purpose

Define the thin lifetime and dialog seam that non-view code uses to open, own,
and tear down Avalonia windows, and the limits on using Avalonia's own lifetime
APIs directly.
## Requirements
