# lexical-edit-view-definition Specification

## Purpose

Define the typed view-definition IR as the canonical migration boundary: how
legacy XML Parts/Layout imports into it, how compilation stays deterministic,
cacheable and off the UI thread, and what XML retirement requires.
## Requirements
