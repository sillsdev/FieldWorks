# lexical-edit-font-decommissioning Specification

## Purpose

Define how the native Graphite engine is removed from the Avalonia path:
inventory of Graphite code, settings and assets, migration of font options to
OpenType/HarfBuzz, and classification of the remaining native dependencies.
## Requirements
