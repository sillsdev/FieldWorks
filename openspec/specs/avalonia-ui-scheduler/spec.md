# avalonia-ui-scheduler Specification

## Purpose

Define the thin UI scheduling seam that non-view layers use to marshal work to
the UI thread, and confine direct Avalonia dispatcher use to the UI edge.
## Requirements
