# avalonia-command-focus Specification

## Purpose

Define how global command routing and focus behavior cross the WinForms/Avalonia
boundary, so xCore commands and focus remain FieldWorks-owned rather than
delegated to an Avalonia-native command framework.
## Requirements
