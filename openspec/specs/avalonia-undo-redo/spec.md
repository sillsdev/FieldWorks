# avalonia-undo-redo Specification

## Purpose

Keep undo and redo domain-authoritative across the WinForms/Avalonia boundary,
allowing control-local undo only as leaf history and routing grouped edits
through domain transactions.
## Requirements
