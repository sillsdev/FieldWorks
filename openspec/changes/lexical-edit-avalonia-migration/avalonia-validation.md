...
|---|---|---|
| Validation service | `010-advanced-entry-preview-prototype` | Prototype evaluates required Presentation IR nodes, skips unmaterialized lazy sequence items, returns deterministic errors in layout order. |
| Coverage | `010-advanced-entry-preview-prototype` | Prototype covers required-field ordering and lazy skip behavior. |
