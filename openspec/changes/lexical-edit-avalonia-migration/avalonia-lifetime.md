...
|---|---|---|
| View model lifetime | `010-advanced-entry-preview-prototype` | Prototype owns the currently loaded entry lifetime and disposes it on save/cancel. |
| Window close | `010-advanced-entry-preview-prototype` | Prototype wires close behavior for the preview-host window. |
