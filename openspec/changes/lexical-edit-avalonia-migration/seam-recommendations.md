...
This section and the seam write-ups below are pre-implementation design rationale (2026-06-09). The
seams shipped under different names than proposed here (e.g. `IRegionEditContext`/
`ComposedRegionEditContext`/`LcmRegionEditSession` rather than `IEditSession`) — for the current,
as-built contracts see `specs/avalonia-command-focus/spec.md`, `specs/avalonia-edit-sessions/spec.md`,
`specs/avalonia-lifetime/spec.md`, `specs/avalonia-ui-scheduler/spec.md`,
`specs/avalonia-undo-redo/spec.md`, and `specs/avalonia-validation/spec.md`. The standalone
`avalonia-*.md` supporting docs that used to sit alongside this file were removed as superseded by
those specs.
