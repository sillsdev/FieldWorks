...
|---|---|---|
| Local key bindings | [Src/LexText/AdvancedEntry.Avalonia/Views/MainWindow.axaml](Src/LexText/AdvancedEntry.Avalonia/Views/MainWindow.axaml) | Local `Ctrl+S` save and `Escape` cancel bindings. |
| View-model commands | [Src/LexText/AdvancedEntry.Avalonia/ViewModels/MainWindowViewModel.cs](Src/LexText/AdvancedEntry.Avalonia/ViewModels/MainWindowViewModel.cs) | Save/cancel commands and close request callback. |
