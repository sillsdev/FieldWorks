...
Status update (2026-06-15, `avalonia-multi-writing-system-text-foundation`; closed pending 8.2/10.3
— that change's own `tasks.md` still has 8.2 realized-window manual RTL/Khmer evidence and 10.3
`CI: Full local check` open):
...
(`avalonia-multi-writing-system-text-foundation`, closed pending its own 8.2/10.3) landed, the migrated region now provides every
