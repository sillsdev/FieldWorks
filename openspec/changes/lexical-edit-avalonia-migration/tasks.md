...
- [ ] 2.4 Add true UIA2/FlaUI/Appium smoke baselines for WinForms launcher/chooser workflows and XMLViews table header/filter reachability. The current branch has in-repo smoke substitutes only.
