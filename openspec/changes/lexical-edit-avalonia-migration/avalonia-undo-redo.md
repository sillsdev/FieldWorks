...
| AdvancedEntry spike | Prototype on `010-advanced-entry-preview-prototype` uses a concrete save/cancel session. Local UI currently exposes save/cancel, not a full undo/redo coordinator. |
