...
- [x] 1.3 Define the overlap resolution (SliceSpec ⊂ typed IR; IDataTreeView ⊂ two-adapter flag)
      (`design.md`; the `datatree-model-view-separation/hybrid-alignment.md` this was originally
      recorded against was removed 2026-07-02 — that change was research-only and never implemented).
...
- [x] 3.1 Moot (2026-07-02): `datatree-model-view-separation` was research-only, never implemented,
      and its change folder was removed. Nothing to align.
