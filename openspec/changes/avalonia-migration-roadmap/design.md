...
> **Update (2026-07-02):** the `datatree-model-view-separation` change was a research-only plan that
> was never implemented; its change folder has been removed. It is referenced here only as historical
> rationale for why Gate 1 was redefined.
