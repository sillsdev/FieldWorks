...
- `datatree-model-view-separation` — **superseded as Phase 1** and never implemented; its change
  folder was removed (2026-07-02). Referenced only as historical rationale in `design.md`.
