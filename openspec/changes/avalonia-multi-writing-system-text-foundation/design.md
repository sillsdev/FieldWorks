...
> **Status update (2026-06-15).** Steps 1-5 below have landed (27 of 29 tasks in `tasks.md`
> complete); only 8.2 (realized-window manual RTL/Khmer evidence) and 10.3 (`CI: Full local
> check`) are still open. The plan is kept in its original prospective wording as the design
> record.
