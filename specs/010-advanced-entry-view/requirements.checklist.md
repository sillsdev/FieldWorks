...
- [ ] Confirm the view is constructed from Parts/Layout via a managed interpreter/compiler and does not depend on legacy C++ view runtime (FR-013).
- [ ] Run parity harness assertions against the checklist for P0/P1 slices (FR-014).
- [ ] Enforce performance acceptance: cached/off-UI-thread compilation and virtualized sequences (FR-015).
