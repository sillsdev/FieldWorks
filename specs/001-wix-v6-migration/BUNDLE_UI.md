...
- [x] Confirm [FLExInstaller/wix6/FieldWorks.Bundle.wixproj](../../FLExInstaller/wix6/FieldWorks.Bundle.wixproj) `StageBundlePayloads` continues to stage all theme assets needed by the theme:
