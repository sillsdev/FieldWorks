...
### Project Files
- **FLExInstaller/wix6/FieldWorks.Installer.wixproj**: Converted to SDK-style, targets WiX v6.
- **FLExInstaller/wix6/FieldWorks.Bundle.wixproj**: Converted to SDK-style, targets WiX v6.
...
## Updates Made
- Updated `FLExInstaller/wix6/Shared/Base/BundleTheme.xml` to use the correct WiX v4 theme namespace `http://wixtoolset.org/schemas/v4/thmutil`.
