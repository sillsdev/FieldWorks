...
{
	/// <summary>
	/// A content control that settles its staged edit — committed when valid, rolled back when not —
	...
	/// and always settles. Implemented by the view that owns a fenced detail-edit session (an open
	...
	public interface IPrepareToGoAway
	{
		...
		/// to call unconditionally on a view about to be switched away from.
		/// </summary>
