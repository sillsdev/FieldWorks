...
namespace SIL.FieldWorks.XWorks
{
	...
	public sealed class FwTsStringClipboard : IFwClipboard
	{
		...
		public void SetText(FwClipboardText payload)
		{
			...
			{
				// Same dual entries legacy EditingHelper.SetTsStringOnClipboard writes, so legacy
				// surfaces paste the rich lane exactly as if another Views surface had copied it.
			...
			ClipboardUtils.SetDataObject(dataObject, true, MaxRetry, RetrySleepMs);
		}
