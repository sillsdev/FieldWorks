...
namespace SIL.FieldWorks.XWorks
{
	...
	public sealed class RegionEditorPluginRegistry
	{
		...
		internal static void RegisterBuiltins(RegionEditorPluginRegistry registry)
		{
			...
			// PHASE-1 FOLLOW-UP PR: the avalonia-rule-formula-editor family (RuleFormulaRegionEditorPlugin,
			// MetaRuleFormulaRegionEditorPlugin, AffixRuleFormulaRegionEditorPlugin, PhEnvironmentRegionEditorPlugin,
			// BasicIpaSymbolRegionEditorPlugin) ships in its own follow-up PR, which restores those registrations
			// here alongside the registry flip in LexicalEditSurfaceRegistry.Phase1FollowUpSurfaceTools.
