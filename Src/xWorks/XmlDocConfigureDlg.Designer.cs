namespace SIL.FieldWorks.XWorks
{
	partial class XmlDocConfigureDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnMoveWsDown = new System.Windows.Forms.Button();
			this.m_btnMoveWsUp = new System.Windows.Forms.Button();
			this.m_lvWritingSystems = new System.Windows.Forms.ListView();
			this.columnHeader1 = new System.Windows.Forms.ColumnHeader();
			this.m_lblListView = new System.Windows.Forms.Label();
			...
			this.m_btnDuplicate.Click += new System.EventHandler(this.m_btnDuplicate_Click);
			//
			// m_btnRemove
			//
			...
			this.panel1.Controls.Add(this.m_tbMoreDetail);
			this.panel1.Controls.Add(this.m_tbPanelHeader);
			this.panel1.Controls.Add(this.m_grpSenseNumber);
			this.panel1.Controls.Add(this.m_btnMoveWsDown);
			this.panel1.Controls.Add(this.m_btnMoveWsUp);
			this.panel1.Controls.Add(this.m_lvWritingSystems);
			this.panel1.Controls.Add(this.m_lblListView);
			this.panel1.Controls.Add(this.m_lnkConfigureNow);
			this.panel1.Controls.Add(this.m_lblMoreDetail);
			...
			// m_btnMoveWsDown
			//
			resources.ApplyResources(this.m_btnMoveWsDown, "m_btnMoveWsDown");
			this.m_btnMoveWsDown.Name = "m_btnMoveWsDown";
			this.m_btnMoveWsDown.UseVisualStyleBackColor = true;
			this.m_btnMoveWsDown.Image = Resources.Images.arrowdown;
			this.m_btnMoveWsDown.Click += new System.EventHandler(this.m_btnMoveWsDown_Click);
			//
			// m_btnMoveWsUp
			//
			resources.ApplyResources(this.m_btnMoveWsUp, "m_btnMoveWsUp");
			this.m_btnMoveWsUp.Name = "m_btnMoveWsUp";
			this.m_btnMoveWsUp.UseVisualStyleBackColor = true;
			this.m_btnMoveWsUp.Image = Resources.Images.arrowup;
			this.m_btnMoveWsUp.Click += new System.EventHandler(this.m_btnMoveWsUp_Click);
			//
			// m_lvWritingSystems
			//
			resources.ApplyResources(this.m_lvWritingSystems, "m_lvWritingSystems");
			this.m_lvWritingSystems.Activation = System.Windows.Forms.ItemActivation.OneClick;
			this.m_lvWritingSystems.AutoArrange = false;
			this.m_lvWritingSystems.CheckBoxes = true;
			this.m_lvWritingSystems.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
			this.columnHeader1});
			this.m_lvWritingSystems.FullRowSelect = true;
			this.m_lvWritingSystems.HeaderStyle = System.Windows.Forms.ColumnHeaderStyle.None;
			this.m_lvWritingSystems.HideSelection = false;
			this.m_lvWritingSystems.MultiSelect = false;
			this.m_lvWritingSystems.Name = "m_lvWritingSystems";
			this.m_lvWritingSystems.ShowGroups = false;
			...
			this.m_lvWritingSystems.SelectedIndexChanged += new System.EventHandler(this.m_lvWritingSystems_SelectedIndexChanged);
			//
			// columnHeader1
			//
			...
			// m_lblListView
			//
			resources.ApplyResources(this.m_lblListView, "m_lblListView");
			this.m_lblListView.Name = "m_lblListView";
			//
			// m_lnkConfigureNow
			//
		...
		private System.Windows.Forms.Label m_lblListView;
		private System.Windows.Forms.ListView m_lvWritingSystems;
		private System.Windows.Forms.Button m_btnMoveWsDown;
		private System.Windows.Forms.Button m_btnMoveWsUp;
