...
namespace SIL.FieldWorks.XWorks
{
	...
	/// crash — see FullEntryRegionMessagesCompanionTests). A follow-up PR activates this plugin by
	/// restoring the registration in RegisterBuiltins, at which point this marker should flip to
	/// false (or be removed).
	/// </summary>
