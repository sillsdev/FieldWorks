...
namespace SIL.FieldWorks.XWorks
{
	public static class CssGenerator
	{
		...
		private static void GenerateDictionaryMinorParagraphCss(StyleSheet styleSheet, IPropertyTable propertyTable, FdoCache cache)
		{
		...
		private static StyleRule GenerateRuleforContentFollowIntermediatePara(string baseSelection, IPropertyTable propertyTable, ConfigurableDictionaryNode configNode)
		{
		...
		/// </summary>
		/// <returns></returns>
		private static IEnumerable<StyleRule> GenerateSelectorsFromNode(string parentSelector, ConfigurableDictionaryNode configNode, out string baseSelection, FdoCache cache, IPropertyTable propertyTable)
		{
