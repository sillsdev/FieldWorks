...
namespace SIL.FieldWorks.XWorks
{
	...
	/// windowing platform must be the headless implementation, not the real Win32 one -- any
	/// window,
	...
	/// active platform is resolved through reflection rather than the (compile-time-inaccessible)
	/// locator
	/// API -- the assertion is on the resolved implementation's assembly, which is the
	/// load-bearing fact.
	/// </summary>
	[TestFixture]
