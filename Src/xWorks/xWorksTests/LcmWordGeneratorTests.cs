...
namespace SIL.FieldWorks.XWorks
{
	...
	class LcmWordGeneratorTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase, IDisposable
	{
		...
		static LcmWordGeneratorTests()
		{
			...
			WordNamespaceManager.AddNamespace("w", "http://schemas.openxmlformats.org/wordprocessingml/2006/main");
			WordNamespaceManager.AddNamespace("r", "http://schemas.openxmlformats.org/wordprocessingml/2006/main");
			WordNamespaceManager.AddNamespace("wp", "http://schemas.openxmlformats.org/wordprocessingml/2006/main");
		}
		...
		public void GenerateWordDocForEntry_OneSenseWithGlossGeneratesCorrectResult()
		{
			...
			var glossNode = new ConfigurableDictionaryNode { FieldDescription = "Gloss", DictionaryNodeOptions = wsOpts, Style = "Dictionary-Headword" };
		...
		{
			var wsOpts = ConfiguredXHTMLGeneratorTests.GetWsOptionsForLanguages(new[] { "en" });
			var glossNode = new ConfigurableDictionaryNode { FieldDescription = "Gloss", DictionaryNodeOptions = wsOpts, Style = "Dictionary-Headword", Before = "\\Abefore\\0A"};
			var sensesNode = new ConfigurableDictionaryNode
			{
				FieldDescription = "Senses",
				DictionaryNodeOptions = ConfiguredXHTMLGeneratorTests.GetSenseNodeOptions(),
