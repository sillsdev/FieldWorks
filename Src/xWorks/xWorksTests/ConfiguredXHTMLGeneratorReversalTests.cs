...
namespace SIL.FieldWorks.XWorks
{
	...
	public class ConfiguredXHTMLGeneratorReversalTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase, IDisposable
	{
		...
		public void GenerateXHTMLForEntry_PrimaryEntryReferences_Ordered()
		{
			...
			{
				var result = ConfiguredLcmGenerator.GenerateContentForEntry(reversalEntry, mainRevEntryNode, null, DefaultSettings).ToString(); // SUT
		...
		public void GenerateLetterHeaderIfNeeded_GeneratesHeaderIfNoPreviousHeader()
		{
			...
			using (var XHTMLWriter = XmlWriter.Create(XHTMLStringBuilder))
			{
				...
				Assert.That(() => LcmXhtmlGenerator.GenerateLetterHeaderIfNeeded(entry, ref last, XHTMLWriter, col, DefaultSettings), Throws.Nothing);
		...
		public void GenerateXHTMLForEntry_SameGramInfoCollapsesOnDemand()
		{
			...
			xhtml = ConfiguredLcmGenerator.GenerateContentForEntry(testEntry, mainEntryNode, null, settings).ToString();
