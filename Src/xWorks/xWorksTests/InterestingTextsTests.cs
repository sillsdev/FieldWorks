...
namespace SIL.FieldWorks.XWorks
{
	...
	public class InterestingTextsTests: SIL.FieldWorks.Test.TestUtils.BaseTest
	{
		...
		public void AddAndRemoveScripture()
		{
			...
			var newTexts = new IStText[] {m_sections[0].ContentOA, m_sections[1].ContentOA, m_sections[1].HeadingOA};
			testObj.SetScriptureTexts(newTexts);
			VerifyTextsChangedArgs(2, 3, 0);
			expected.AddRange(newTexts);
			VerifyList(expected, testObj.InterestingTexts, "deleted Scripture texts are removed (HeadingOA)");
