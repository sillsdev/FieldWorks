...
namespace SIL.FieldWorks.XWorks
{
	...
	public class DictionaryConfigurationManagerControllerTests : MemoryOnlyBackendProviderTestBase
	{
		...
		public void FormatFilePath()
		{
			...
			StringAssert.DoesNotContain("?", formattedFilePath);
			StringAssert.DoesNotContain(">", formattedFilePath);
			StringAssert.That(formattedFilePath, Does.Contain("File"));
			StringAssert.That(formattedFilePath, Does.Contain("Name"));
			StringAssert.That(formattedFilePath, Does.Contain("With"));
			StringAssert.That(formattedFilePath, Does.Contain("Chars"));
		}
