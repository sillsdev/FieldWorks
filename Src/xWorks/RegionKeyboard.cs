...
{
	/// <summary>
	/// Activates the per-writing-system keyboard for region editor rows. Extracted from the
	/// region builder so the keyboard concern stands on its own; lives in xWorks because it needs
	/// the LCModel cache (the FwAvalonia view layer is intentionally LCModel-free).
	/// </summary>
	public static class RegionKeyboard
	{
		/// <summary>
		...
		/// </summary>
		public static void ActivateForWritingSystem(LcmCache cache, string wsTag)
		{
			try
			{
