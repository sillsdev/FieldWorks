...
namespace SIL.FieldWorks.ScrImportComponents
{
	...
	public class ModifyMapping : Form, IFWDisposable
	{
		...
		/// <summary></summary>
		public SIL.FieldWorks.ScrImportComponents.MappingDetailsCtrl mappingDetailsCtrl;
		#endregion
		...
		private void InitializeComponent()
		{
			...
			this.mappingDetailsCtrl.ValidStateChanged += new SIL.FieldWorks.ScrImportComponents.MappingDetailsCtrl.ValidStateChangedHandler(this.mappingDetailsCtrl_ValidStateChanged);
			//
			// endMarkerLabel
			//
		...
		{
			ShowHelp.ShowHelpTopic(FwApp.App, "khtpSFMWizardStep4Map-Modify");
		}
