...
namespace SIL.FieldWorks.ScrImportComponents
{
	...
	public class CharacterMappingSettings : Form, IFWDisposable
	{
		...
		/// <summary>exposed to dummy</summary>
		protected SIL.FieldWorks.ScrImportComponents.MappingDetailsCtrl mappingDetailsCtrl;
		#endregion

		#region Construction, etc
		/// -----------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="CharacterMappingSettings"/> class.
		/// </summary>
		/// -----------------------------------------------------------------------------------
		...
		private void InitializeComponent()
		{
			...
			this.mappingDetailsCtrl = new SIL.FieldWorks.ScrImportComponents.MappingDetailsCtrl();
			...
			this.mappingDetailsCtrl.ValidStateChanged += new SIL.FieldWorks.ScrImportComponents.MappingDetailsCtrl.ValidStateChangedHandler(this.mappingDetailsCtrl1_ValidStateChanged);
			//
		...
		{
			ShowHelp.ShowHelpTopic(FwApp.App, "khtpSFMWizardStep4Map-SingleAdditionalMapping");
		}
		...
		{
			MessageBox.Show(this, msg, Application.ProductName, MessageBoxButtons.OK,
