...
namespace XCore
{
	...
	public class MultiPane : CollapsingSplitContainer, IxCoreContentControl, IXCoreUserControl
	{
		...
		private Control MakeSubControl(XmlNode configuration, Size parentSizeHint)
		{
			...
			catch (Exception error)
			{
				...
				SIL.Utils.ErrorReporter.ReportException(new ApplicationException(s, error));
			}
			return null;
		}
