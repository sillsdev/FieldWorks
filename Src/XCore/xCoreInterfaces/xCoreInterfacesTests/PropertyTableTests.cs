...
//			m_modifiedSettingsPath = Path.Combine(DirectoryFinder.FwSourceDirectory, @"XCore\xCoreInterfaces\xCoreInterfacesTests");
		...
		public void TryGetValueTest()
		{
			...
			Assert.That(fPropertyExists, Is.False, String.Format("{0} {1} should not exist.", "best", "NonexistentPropertyA"));
			Assert.That(bestValue, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "NonexistentPropertyA"));
			...
			Assert.That(gpba, Is.False, String.Format("Invalid value for {0} {1}.", "global", "BooleanPropertyA"));

			int gpia;
			fPropertyExists = m_propertyTable.TryGetValue("IntegerPropertyA", PropertyTable.SettingsGroup.GlobalSettings, out gpia);
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "global", "IntegerPropertyA"));
			Assert.That(gpia, Is.EqualTo(253).Within(String.Format("Invalid value for {0} {1}.", "global", "IntegerPropertyA")));

			string gpsa;
			fPropertyExists = m_propertyTable.TryGetValue("StringPropertyA", PropertyTable.SettingsGroup.GlobalSettings, out gpsa);
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "global", "StringPropertyA"));
			Assert.That(gpsa, Is.EqualTo("global_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "global", "StringPropertyA")));
			...
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "local", "BooleanPropertyA"));
			Assert.That(lpba, Is.True, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyA"));

			int lpia;
			fPropertyExists = m_propertyTable.TryGetValue("IntegerPropertyA", PropertyTable.SettingsGroup.LocalSettings, out lpia);
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "local", "IntegerPropertyA"));
			Assert.That(lpia, Is.EqualTo(333).Within(String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyA")));

			string lpsa;
			fPropertyExists = m_propertyTable.TryGetValue("StringPropertyA", PropertyTable.SettingsGroup.LocalSettings, out lpsa);
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "local", "StringPropertyA"));
			Assert.That(lpsa, Is.EqualTo("local_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "local", "StringPropertyA")));
			...
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "best", "BestBooleanPropertyA"));
			Assert.That(ugpba, Is.True, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));
			...
			Assert.That(fPropertyExists, Is.True, String.Format("{0} {1} not found.", "best", "BooleanPropertyA"));
			Assert.That(bpba, Is.True, String.Format("Invalid value for {0} {1}.", "best", "BooleanPropertyA"));
		...
		public void PropertyExists()
		{
			...
			Assert.That(fPropertyExists, Is.False, String.Format("{0} {1} should not exist.", "global", "NonexistentPropertyA"));
			fPropertyExists = m_propertyTable.PropertyExists("NonexistentPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(fPropertyExists, Is.False, String.Format("{0} {1} should not exist.", "local", "NonexistentPropertyA"));
			...
			Assert.That(fPropertyExists, Is.False, String.Format("{0} {1} not found.", "best", "BestIntegerPropertyB"));
		...
		public void GetValue()
		{
			...
			Assert.That(gpbc, Is.True, String.Format("Invalid value for {0} {1}.", "global", "BooleanPropertyC"));
			nullObject = m_propertyTable.GetValue<object>("BooleanPropertyC", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyC"));

			int gpic = m_propertyTable.GetValue("IntegerPropertyC", PropertyTable.SettingsGroup.GlobalSettings, 352);
			Assert.That(gpic, Is.EqualTo(352).Within(String.Format("Invalid value for {0} {1}.", "global", "IntegerPropertyC")));
			nullObject = m_propertyTable.GetValue<object>("IntegerPropertyC", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyC"));
			...
			Assert.That(gpsc, Is.EqualTo("global_StringPropertyC_value").Within(String.Format("Invalid value for {0} {1}.", "global", "StringPropertyC")));
			nullObject = m_propertyTable.GetValue<object>("StringPropertyC", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "local", "StringPropertyC"));
			...
			Assert.That(lpbc, Is.False, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyC"));
			...
			Assert.That(lpic, Is.EqualTo(111).Within(String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyC")));
			...
			Assert.That(lpsc, Is.EqualTo("local_StringPropertyC_value").Within(String.Format("Invalid value for {0} {1}.", "local", "StringPropertyC")));
			...
			Assert.That(bpba, Is.True, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyA"));
			bpba = m_propertyTable.GetValue<bool>("BooleanPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(bpba, Is.False, String.Format("Invalid value for {0} {1}.", "global", "BooleanPropertyA"));

			int bpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(bpia, Is.EqualTo(333).Within(String.Format("Invalid value for {0} {1}.", "best", "IntegerPropertyA")));
			...
			Assert.That(bpia, Is.EqualTo(333).Within(String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyA")));
			bpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(bpia, Is.EqualTo(253).Within(String.Format("Invalid value for {0} {1}.", "global", "IntegerPropertyA")));

			string bpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(bpsa, Is.EqualTo("local_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "StringPropertyA")));
			...
			Assert.That(bpsa, Is.EqualTo("local_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "local", "StringPropertyA")));
			bpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(bpsa, Is.EqualTo("global_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "global", "StringPropertyA")));

			// Match on unique globals.
			bool ubpba = m_propertyTable.GetValue<bool>("BestBooleanPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpba, Is.True, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));
			...
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));

			int ubpia = m_propertyTable.GetValue<int>("BestIntegerPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpia, Is.EqualTo(-101).Within(String.Format("Invalid value for {0} {1}.", "best", "BestIntegerPropertyA")));
			int ugpia = m_propertyTable.GetValue<int>("BestIntegerPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(ugpia, Is.EqualTo(-101).Within(String.Format("Invalid value for {0} {1}.", "best", "BestIntegerPropertyA")));
			...
			Assert.That(ubpsa, Is.EqualTo("global_BestStringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA")));
			string ugpsa = m_propertyTable.GetValue<string>("BestStringPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(ugpsa, Is.EqualTo("global_BestStringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA")));
			...
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA"));

			// Match on unique locals.
			ubpba = m_propertyTable.GetValue<bool>("BestBooleanPropertyB", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyB"));
			...
			Assert.That(ulpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyB"));
			...
			Assert.That(ubpsa, Is.EqualTo("local_BestStringPropertyB_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB")));
			string ulpsa = m_propertyTable.GetValue<string>("BestStringPropertyB", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(ulpsa, Is.EqualTo("local_BestStringPropertyB_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB")));
			...
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB"));

			// Make new best (global) properties
			ugpba = m_propertyTable.GetValue("BestBooleanPropertyC", false);
			Assert.That(ugpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyC"));
			...
			Assert.That(ugpia, Is.EqualTo(-818).Within(String.Format("Invalid value for {0} {1}.", "best", "BestIntegerPropertyC")));
			...
			Assert.That(ugpsa, Is.EqualTo("global_BestStringPropertyC_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyC")));
		...
		public void SetProperty()
		{
			...
			bool lpba = m_propertyTable.GetValue<bool>("BooleanPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpba, Is.False, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyA"));
			...
			Assert.That(gpia, Is.EqualTo(-253).Within(String.Format("Invalid value for {0} {1}.", "global", "IntegerPropertyA")));
			int lpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpia, Is.EqualTo(253).Within(String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyA")));
			...
			Assert.That(gpsa, Is.EqualTo("global_StringPropertyC_value").Within(String.Format("Invalid value for {0} {1}.", "global", "StringPropertyA")));
			string lpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpsa, Is.EqualTo("local_StringPropertyC_value").Within(String.Format("Invalid value for {0} {1}.", "local", "StringPropertyA")));
			...
			bool bpba = m_propertyTable.GetValue<bool>("BooleanPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(bpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BooleanPropertyA"));
			gpba = m_propertyTable.GetValue<bool>("BooleanPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(gpba, Is.True, String.Format("Invalid value for {0} {1}.", "global", "BooleanPropertyA"));
			lpba = m_propertyTable.GetValue<bool>("BooleanPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpba, Is.False, String.Format("Invalid value for {0} {1}.", "local", "BooleanPropertyA"));
			...
			int bpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(bpia, Is.EqualTo(352).Within(String.Format("Invalid value for {0} {1}.", "best", "IntegerPropertyA")));
			gpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(gpia, Is.EqualTo(-253).Within(String.Format("Invalid value for {0} {1}.", "global", "IntegerPropertyA")));
			lpia = m_propertyTable.GetValue<int>("IntegerPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpia, Is.EqualTo(352).Within(String.Format("Invalid value for {0} {1}.", "local", "IntegerPropertyA")));

			m_propertyTable.SetProperty("StringPropertyA", "local_StringPropertyA_value", PropertyTable.SettingsGroup.LocalSettings, true);
			m_propertyTable.SetProperty("StringPropertyA", "global_StringPropertyA_value", PropertyTable.SettingsGroup.GlobalSettings, true);
			m_propertyTable.SetProperty("StringPropertyA", "best_StringPropertyA_value", PropertyTable.SettingsGroup.BestSettings, true);
			string bpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(bpsa, Is.EqualTo("best_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "StringPropertyA")));
			gpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.GlobalSettings, "local_StringPropertyC_value");
			Assert.That(gpsa, Is.EqualTo("global_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "global", "StringPropertyA")));
			lpsa = m_propertyTable.GetValue<string>("StringPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(lpsa, Is.EqualTo("best_StringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "local", "StringPropertyA")));
			...
			bool ubpba = m_propertyTable.GetValue<bool>("BestBooleanPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));
			bool ugpba = m_propertyTable.GetValue<bool>("BestBooleanPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(ugpba, Is.False, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));
			nullObject = m_propertyTable.GetValue<object>("BestBooleanPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestBooleanPropertyA"));
			...
			string ubpsa = m_propertyTable.GetValue<string>("BestStringPropertyA", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpsa, Is.EqualTo("best_BestStringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA")));
			string ugpsa = m_propertyTable.GetValue<string>("BestStringPropertyA", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(ugpsa, Is.EqualTo("best_BestStringPropertyA_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA")));
			nullObject = m_propertyTable.GetValue<object>("BestStringPropertyA", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyA"));
			...
			ubpsa = m_propertyTable.GetValue<string>("BestStringPropertyB", PropertyTable.SettingsGroup.BestSettings);
			Assert.That(ubpsa, Is.EqualTo("best_BestStringPropertyB_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB")));
			string ulpsa = m_propertyTable.GetValue<string>("BestStringPropertyB", PropertyTable.SettingsGroup.LocalSettings);
			Assert.That(ulpsa, Is.EqualTo("best_BestStringPropertyB_value").Within(String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB")));
			nullObject = m_propertyTable.GetValue<object>("BestStringPropertyB", PropertyTable.SettingsGroup.GlobalSettings);
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "best", "BestStringPropertyB"));
		...
		public void SetDefault()
		{
			...
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "local", "BestBooleanPropertyC"));
			...
			Assert.That(nullObject, Is.Null, String.Format("Invalid value for {0} {1}.", "local", "BestIntegerPropertyC"));
		...
		public void ReadOnlyPropertyTable_GetWithDefaultDoesNotSet()
		{
			...
			Assert.That(notDefault, Is.EqualTo(roPropTable.GetStringProperty(noSuchPropName, myDefault)), "Default was used instead of value from property table.");
		}
		...
		public void ReadOnlyPropertyTable_ReplaceDefaultInitialArea()
		{
			...
			Assert.That(initialAreaValue, Is.EqualTo("lexicon"), "Default value not set.");
			LoadOriginalSettings();
			initialAreaValue = m_propertyTable.GetValue<string>(initialAreaKey);
			Assert.That(initialAreaValue, Is.EqualTo("grammar"), "Default value not replaced.");
		}
