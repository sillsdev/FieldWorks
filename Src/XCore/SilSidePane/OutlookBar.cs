	...
	internal class OutlookBar : Control
	{
		...
		private Icon GripIcon
		{
			get
			{
				switch (Renderer)
				{
					case Renderer.Outlook2003: return Properties.Resources.Grip2003;
					case Renderer.Outlook2007: return Properties.Resources.Grip2007;
					case Renderer.Custom: return Properties.Resources.Grip2007;
				}
		...
		private void CreateContextMenu()
		{
			...
			contextMenuStrip.Items.Add(SilSidePane.ShowMoreButtons,
					Properties.Resources.Arrow_Up.ToBitmap(), ShowMoreButtons);

			contextMenuStrip.Items.Add(SilSidePane.ShowFeWerButtons,
					Properties.Resources.Arrow_Down.ToBitmap(), ShowFewerButtons);
