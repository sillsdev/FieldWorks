...
namespace SidebarLibrary.Menus
{
	...
	public class MenuItemEx : MenuItem
	{
		...
		static MenuItemEx()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("SidebarLibrary.Menus.MenuItemEx"));
			ResourceManager rm = new ResourceManager("SidebarLibrary.Resources.ImagesMenu", thisAssembly);
