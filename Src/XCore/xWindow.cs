...
//		}
		...
		/// creating any WinForms UI -- for hosts that render the menu themselves (e.g. the
		/// Avalonia
		...
		{
			string xpath = GetToolXPath(areaName) + "[@value = " + XmlUtils.MakeSafeXPathLiteral(toolName) + "]";
