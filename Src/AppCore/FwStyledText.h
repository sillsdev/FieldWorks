...
namespace FwStyledText
{
	...
	void DecodeFontPropsString(BSTR bstr, bool fExplicit, Vector<WsStyleInfo> & vesiInherited,
		Vector<WsStyleInfo> & vesiExplicit, Vector<ChrpInheritance> & vchrpi, Vector<int> & vwsSoFar,
		Vector<int> & vwsExtra);
