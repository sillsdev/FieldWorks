...
HFONT AfGdi::SelectObjectFont(HDC hdc, HGDIOBJ font, SelType type)
{
...
BOOL AfGdi::DeleteObjectFont(HGDIOBJ font)
{
#ifdef DEBUG_AFGDI
	if (s_fShowFonts)
	{
...
HBITMAP AfGdi::SelectObjectBitmap(HDC hdc, HGDIOBJ bitmap, SelType type)
{
...
BOOL AfGdi::DeleteObjectBitmap(HGDIOBJ bitmap)
{
#ifdef DEBUG_AFGDI
	if (s_fShowBitmaps)
	{
...
HBRUSH AfGdi::SelectObjectBrush(HDC hdc, HGDIOBJ brush, SelType type)
{
...
BOOL AfGdi::DeleteObjectBrush(HGDIOBJ brush)
{
#ifdef DEBUG_AFGDI
	if (s_fShowBrushes)
	{
