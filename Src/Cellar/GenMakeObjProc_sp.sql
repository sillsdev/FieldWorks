 ...
 *
 * Description:
 *	This procedure generates the MakeObj_ stored procedure for a given class.
 *
 * Paramters:
 ...
 *
 * Notes:
 *	This is a slightly modified from its predecessor, DefineCreateProc$. I have heard the dollar
 *	sign in file names creates havoc in Linux.
 **********************************************************************************************/
