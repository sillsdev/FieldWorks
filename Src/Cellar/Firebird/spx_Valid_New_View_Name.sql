...
SET TERM !!;
CREATE OR ALTER PROCEDURE spx_Valid_New_View_Name (
...
BEGIN
	 ...
	 SELECT COUNT(1) AS NameCount
		 ...
		 WHERE RDB$View_Name = CAST(:outValidName AS VARCHAR(31) CHARACTER SET UNICODE_FSS)
		 INTO :vCount;
