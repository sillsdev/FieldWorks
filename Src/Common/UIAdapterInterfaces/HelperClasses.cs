...
//		}
	...
	public class AdapterHelper
	{
		...
		private static bool LoadUIAdapterAssembly()
		{
			...
			string appPath = Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase.Substring(6));
			try
			{
			...
			catch
			{
				MessageBox.Show(String.Format(
					UIAdapterInterfacesStrings.ksCannotLoadX, Path.Combine(appPath, "UIAdapters.dll")),
