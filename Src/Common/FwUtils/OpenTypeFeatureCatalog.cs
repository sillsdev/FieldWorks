	...
	public static class OpenTypeFeatureCatalog
	{
		...
		private static readonly Dictionary<string, OpenTypeFeatureCatalogEntry> s_entries =
			new Dictionary<string, OpenTypeFeatureCatalogEntry>(StringComparer.Ordinal)
			{
				...
				["chws"] = Visible("Contextual Half-width Spacing", OpenTypeFeatureDefaultState.Off),
				...
				["cpsp"] = Visible("Capital Spacing", OpenTypeFeatureDefaultState.Off),
				...
				["halt"] = Visible("Alternative Half Widths", OpenTypeFeatureDefaultState.Off),
				...
				["rand"] = Visible("Randomize", OpenTypeFeatureDefaultState.Off),
