...
namespace FwAvaloniaDialogsTests
{
	...
	/// stays in each fixture's own Show() -- only the realize/pump/snapshot/assert sequence and
	/// the
	...
	internal static class AvaloniaDialogTestHarness
	{
		...
		/// <summary>
		/// Pumps a realized surface to a settled layout without snapshotting or asserting -- for
		/// fixtures
