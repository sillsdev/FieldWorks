...
namespace FwAvaloniaDialogs
{
	...
	public static class DialogThemeBootstrap
	{
		...
		public static void Apply(Control dialogBody)
		{
			...
			// Apply() runs before InitializeComponent, so calling EnsureInitialized() here
			// (idempotent) avoids "Could not create IAssetLoader" if this is the first
			// Avalonia control built in the process.
