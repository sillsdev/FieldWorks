...
namespace FwAvaloniaDialogs
{
	...
	public static class FwAvaloniaDialogsStrings
	{
		...
		public static string UiModeBetaWarning => Text("FwAvaloniaDialogs.UiModeBetaWarning", "Beta: the New mode is incomplete; some features are not yet available.");
		...
		public static string ManageIndividualFeatures => Text("FwAvaloniaDialogs.ManageIndividualFeatures", "Manage Individual Features...");
		...
		public static string OkMnemonic => Text("FwAvaloniaDialogs.OkMnemonic", "_OK");
		public static string CancelMnemonic => Text("FwAvaloniaDialogs.CancelMnemonic", "_Cancel");
		public static string HelpMnemonic => Text("FwAvaloniaDialogs.HelpMnemonic", "_Help");
		...
		public static string FeatureManagerTitle => Text("FwAvaloniaDialogs.FeatureManagerTitle", "Manage Individual Features");
		public static string FeatureManagerSearchWatermark => Text("FwAvaloniaDialogs.FeatureManagerSearchWatermark", "Search by name or description...");
		public static string FeatureManagerSelectAll => Text("FwAvaloniaDialogs.FeatureManagerSelectAll", "Select All");
		public static string FeatureManagerDeselectAll => Text("FwAvaloniaDialogs.FeatureManagerDeselectAll", "Deselect All");
		...
		public static string InsertEntryCreateMnemonic => Text("FwAvaloniaDialogs.InsertEntryCreateMnemonic", "C_reate");
