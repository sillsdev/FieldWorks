...
{
	/// <summary>
	/// The LCModel-free snapshot the "Create New Grammatical Info." view-model writes on OK --
	/// the chosen grammatical
	/// info (the <see cref="FwSandboxMsa"/> the hosted <see cref="MSAGroupBox"/> emitted). The
	/// LCModel-aware
	/// launcher reads this back to find-or-create (or update) the matching MSA -- the lift of
	/// <c>MsaCreatorDlg</c>'s
