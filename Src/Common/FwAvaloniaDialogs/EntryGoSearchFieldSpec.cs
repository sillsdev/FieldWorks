...
{
	/// <summary>
	/// The LCModel-free writing-system presentation spec for the entry-search ("go") dialog's
	/// search box -- the
	...
	public sealed class EntryGoSearchFieldSpec
	{
		...
		/// <summary>The font size in points; 0 (the default) keeps the shared default size -- the
		/// same
