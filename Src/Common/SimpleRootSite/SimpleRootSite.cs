...
#pragma warning restore 219
		...
		/// Views, but looks like a control UI Element. Best place I could think of to put
		/// the common name.
		/// </summary>
		...
		/// </summary>
		public static ITsString MakeUiElementString(string text, int uiWs)
		{
			...
			propsBldr.SetStrPropValue((int)FwTextPropType.ktptNamedStyle, SimpleRootSite.UiElementStylename);
