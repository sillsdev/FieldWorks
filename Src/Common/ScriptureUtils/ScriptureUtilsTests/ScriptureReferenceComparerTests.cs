...
namespace SIL.FieldWorks.Common.ScriptureUtils
{
	...
	internal class DummyScrProjMetaDataProvider : IScrProjMetaDataProvider
	{
		...
		{
			get { return Paratext.ScrVers.English; }
		}
	}
	...
	public class ScriptureReferenceComparerTests : BaseTest
	{
		...
		{
			ScrReference gen1_10 = new ScrReference(1, 1, 10, Paratext.ScrVers.English);
			ScrReference gen1_2 = new ScrReference(1, 1, 2, Paratext.ScrVers.English);

			Assert.Greater(m_comparer.Compare(gen1_10, gen1_2), 0);
			Assert.Less(m_comparer.Compare(gen1_2, gen1_10), 0);
			Assert.AreEqual(m_comparer.Compare(gen1_10, new ScrReference(01001010, Paratext.ScrVers.English)), 0);
		}
		...
		{
			ScrReference gen = new ScrReference(1, 1, 1, Paratext.ScrVers.English);
			ScrReference exo = new ScrReference(2, 1, 1, Paratext.ScrVers.English);
		...
		{
			ScrReference genesis = new ScrReference(1, 1, 1, Paratext.ScrVers.English);
		...
		{
			ScrReference genesis = new ScrReference(1, 0, 0, Paratext.ScrVers.English);
			ScrReference exodus = new ScrReference(2, 0, 0, Paratext.ScrVers.English);
		...
		{
			m_comparer.Compare(01001001, new CmObject());
		}
	}
}
