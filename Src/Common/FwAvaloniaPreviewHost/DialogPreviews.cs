...
// Previewable dialogs, one entry per surface, selected with
// `--module <id>`. Kept out of FwAvaloniaDialogs so no product
// references preview-only code. Adding one is a window class plus an
// attribute.
