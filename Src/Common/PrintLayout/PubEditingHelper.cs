...
namespace SIL.FieldWorks.Common.PrintLayout
{
	...
	/// ----------------------------------------------------------------------------------------
	public class PubEditingHelper: RootSiteEditingHelper
	{
		#region Data members
		private RootSiteEditingHelper m_decoratedEditingHelper;
		#endregion
		...
		{
			if (m_decoratedEditingHelper != null)
				m_decoratedEditingHelper.OnKeyPress(e, modifiers);
			else
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public override bool PasteClipboard()
		{
			if (m_decoratedEditingHelper != null)
				return m_decoratedEditingHelper.PasteClipboard();
			return base.PasteClipboard();
		}
		...
		{
			if (m_decoratedEditingHelper != null)
				m_decoratedEditingHelper.HandleSelectionChange(prootb, vwselNew);
			else
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public override void ClearCurrentSelection()
		{
			if (m_decoratedEditingHelper != null)
				m_decoratedEditingHelper.ClearCurrentSelection();
			base.ClearCurrentSelection();
		}
