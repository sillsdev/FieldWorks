...
//					page.ReadyForDrawing = true;
		...
		/// </returns>
		/// ------------------------------------------------------------------------------------
		protected bool LayoutToPageIfNeeded(int pageIndex, float dpiX, float dpiY, IProgress dlg)
		{
			lock (m_pages)
			{
...
//			}
		...
		/// ------------------------------------------------------------------------------------
		private object UpdatePageBreaks(IProgress dialog, object[] parameters)
		{
