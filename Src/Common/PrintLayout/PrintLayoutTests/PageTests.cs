...
namespace SIL.FieldWorks.Common.PrintLayout
{
	...
	public class PageTests : BaseTest
	{
		...
		public void GetLastElement_OneElement()
		{
			...
			{
				DummyPublication dummyPub = new DummyPublication(null, division, DateTime.Now);

				PageElement element = new PageElement(division, stream, false, new Rectangle(720, 1440,
					(int)(6.5 * 720), (int)(9 * 1440)), 0, true, 1, 1, 0, 9 * 1440, 0, false);

				DummyPage page = new DummyPage(dummyPub);
