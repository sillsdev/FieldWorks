...
namespace SIL.FieldWorks.Common.ScriptureUtils
{
	...
	public static class ScrStyleNames
	{
		...
		/// <summary>Identifies a first-level line that is quoted, usually from the Old Testament</summary>
		public const string CitationLine1 = "Citation Line1";

		/// <summary>Identifies a second-level line that is quoted, usually from the Old Testament</summary>
		public const string CitationLine2 = "Citation Line2";
