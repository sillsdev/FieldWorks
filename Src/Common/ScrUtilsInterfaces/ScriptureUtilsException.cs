...
//		ChapterNumberOutOfOrder,
		...
		/// <summary>
		/// Unexpected paragraph element in an OXES XML file
		/// </summary>
		UnexpectedParagraph,
	...
	public class ScriptureUtilsException: Exception
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets whether this error is an "Unable to Import Back Translation" error.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public bool IsBackTransError
		{
			get { return m_errorCode >= SUE_ErrorCode.BackTransMin; }
		}
