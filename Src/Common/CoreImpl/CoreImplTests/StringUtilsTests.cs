...
namespace SIL.CoreImpl
{
		...
		// can't derive from BaseTest, but instantiate DebugProcs instead
	{
		...
		{
			((PalasoWritingSystemManager)m_wsf).Dispose();
		...
		public void GetCleanTsString_TssHasORCs()
		{
			...
			ITsString noORCText = StringUtils.GetCleanTsString(tss, null);
		...
		public void GetCleanTsString_NumbersWithinSpaces()
		{
			...
			ITsString tssORCsRemoved = StringUtils.GetCleanTsString(tss, null);
		...
		{
			ITsString tssClean = StringUtils.GetCleanTsString(StringUtils.MakeTss(" ", 42), null);
		...
		{
			ITsString tssClean = StringUtils.GetCleanTsString(
				StringUtils.MakeTss(String.Empty, 42), null);
			Assert.AreEqual(0, tssClean.Length);
		...
		{
			ITsString tssClean = StringUtils.GetCleanTsString(
				StringUtils.MakeTss(StringUtils.kChObject.ToString(), 42), null);
			Assert.AreEqual(0, tssClean.Length);
			Assert.AreEqual(42, tssClean.get_WritingSystemAt(0));
		}
		...
		{
			ITsString tss = StringUtils.MakeTss(StringUtils.kChObject.ToString(), 42);
			ITsString tssClean = StringUtils.GetCleanTsString(tss, null, false, true, false);
		...
		{
			Assert.IsNull(StringUtils.GetCleanTsString(null));
		}
		...
		public void TurnOwnedOrcIntoUnownedOrc_OwnedOrc_Run0()
		{
			...
			StringUtils.InsertOrcIntoPara(expectedGuid, FwObjDataTypes.kodtOwnNameGuidHot, bldr, 0, 0, 5);
			StringUtils.TurnOwnedOrcIntoUnownedOrc(bldr, 0);

			FwObjDataTypes odt;
			Guid guid = StringUtils.GetGuidFromProps(bldr.get_Properties(0), null, out odt);
		...
		public void TurnOwnedOrcIntoUnownedOrc_OwnedOrc_DifferentRun()
		{
			...
			StringUtils.InsertOrcIntoPara(expectedGuid, FwObjDataTypes.kodtOwnNameGuidHot, bldr, 6, 6, 5);
			StringUtils.TurnOwnedOrcIntoUnownedOrc(bldr, 1);
			...
			FwObjDataTypes odt;
			Guid guid = StringUtils.GetGuidFromProps(bldr.get_Properties(1), null, out odt);
		...
		public void TurnOwnedOrcIntoUnownedOrc_UnownedOrc()
		{
			Guid expectedGuid = Guid.NewGuid();
			ITsStrBldr bldr = TsStrBldrClass.Create();
			StringUtils.InsertOrcIntoPara(expectedGuid, FwObjDataTypes.kodtNameGuidHot, bldr, 0, 0, 5);
			StringUtils.TurnOwnedOrcIntoUnownedOrc(bldr, 0);
		...
		public void TurnOwnedOrcIntoUnownedOrc_PictureOrc()
		{
			Guid expectedGuid = Guid.NewGuid();
			ITsStrBldr bldr = TsStrBldrClass.Create();
			StringUtils.InsertOrcIntoPara(expectedGuid, FwObjDataTypes.kodtGuidMoveableObjDisp, bldr, 0, 0, 5);
			StringUtils.TurnOwnedOrcIntoUnownedOrc(bldr, 0);
		...
		public void RemoveIntProp()
		{
			...
			ITsString newTss = StringUtils.RemoveIntProp(tss, (int)FwTextPropType.ktptFontSize);
		...
		public void TrimNonWordFormingCharsTest_WithNewLine()
		{
			...
			ITsString result = StringUtils.TrimNonWordFormingChars(bldr.GetString(), m_wsf);
		...
		{
			ITsString tss = StringUtils.MakeTss("funky munky", m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("A munky", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("Another munky", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("One guy", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("Happiness is good.", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("Gold is good.", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("God 'is good.'", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("Good. Yeah!", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		{
			ITsString tss = StringUtils.MakeTss("Gideon had 300 men.", m_wsf.UserWs);
			ILgCharacterPropertyEngine cpe = m_wsf.get_CharPropEngine(m_wsf.UserWs);
		...
		public void WriteHref_WrongTextPropType()
		{
			using (var stream = new StringWriter())
			{
				...
				{
					Assert.IsFalse(StringUtils.WriteHref(-56, new string(new[] {
		...
		public void ValidateCharacterSequence_SingleLineSeparator()
		{
			...
			Assert.AreEqual("\u2028", StringUtils.ValidateCharacterSequence("\u2028",
		...
		public void ValidateCharacterSequence_SingleLetter()
		{
			...
			Assert.AreEqual("c", StringUtils.ValidateCharacterSequence("c",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_SingleNumber()
		{
			...
			cpe.SetupResult("get_IsSymbol", false, typeof(int));
			cpe.SetupResult("get_IsMark", false, typeof(int));
			Assert.AreEqual("2", StringUtils.ValidateCharacterSequence("2",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_SingleUndefinedChar()
		{
			...
			cpe.SetupResult("get_IsSymbol", false, typeof(int));
			cpe.SetupResult("get_IsMark", false, typeof(int));
			Assert.AreEqual(string.Empty, StringUtils.ValidateCharacterSequence("\uE000",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_BaseCharacterPlusDiacritic()
		{
			...
			Assert.AreEqual("n\u0301", StringUtils.ValidateCharacterSequence("n\u0301",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_BaseCharacterPlusMultipleDiacritics()
		{
			...
			Assert.AreEqual("\u05E9\u05C1\u05B4\u0596",
				StringUtils.ValidateCharacterSequence("\u05E9\u05C1\u05B4\u0596",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_SingleDiacritic()
		{
			...
			Assert.AreEqual(string.Empty, StringUtils.ValidateCharacterSequence("\u0301",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_MultipleLetters()
		{
			...
			cpe.SetupResult("get_IsSymbol", false, typeof(int));
			cpe.SetupResult("get_IsMark", false, typeof(int));
			Assert.AreEqual("n", StringUtils.ValidateCharacterSequence("no",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_DiacriticBeforeLetter()
		{
			...
			Assert.AreEqual("o", StringUtils.ValidateCharacterSequence("\u0301o",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_MultipleBaseCharsThatComposeIntoASingleBaseChar()
		{
			...
			cpe.SetupResult("get_IsMark", false, typeof(int));
			Assert.AreEqual("\uAC10",
				StringUtils.ValidateCharacterSequence("\u1100\u1161\u11B7",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ValidateCharacterSequence_MultipleBaseCharsJoinedByZWJ()
		{
			...
			Assert.AreEqual("\u05E9\u05C1\u05B4\u200D\u0596",
				StringUtils.ValidateCharacterSequence("\u05E9\u05C1\u05B4\u200D\u0596",
				(ILgCharacterPropertyEngine)cpe.MockInstance));
		...
		public void ValidateCharacterSequence_AllowZwnj()
		{
			...
			cpe.SetupResultForParams("get_IsMark", false, 0x200C);
			Assert.AreEqual("\u200C",
				StringUtils.ValidateCharacterSequence("\u200C", (ILgCharacterPropertyEngine)cpe.MockInstance));
		}
		...
		public void ParseCharString_Simple()
		{
			...
			List<string> validChars = StringUtils.ParseCharString("a b c", " ",
		...
		public void ParseCharString_LeadingSpace()
		{
			...
			cpe.SetupResult("get_IsMark", false, typeof(int));
			List<string> invalidChars;
			List<string> validChars = StringUtils.ParseCharString("  a b", " ",
				(ILgCharacterPropertyEngine)cpe.MockInstance, out invalidChars);
			Assert.AreEqual(3, validChars.Count);
		...
		public void ParseCharString_BogusCharacter()
		{
			...
			cpe.SetupResultForParams("get_IsMark", true, 0x0301);
			List<string> invalidChars;
			List<string> validChars = StringUtils.ParseCharString("\u0301", " ",
				(ILgCharacterPropertyEngine)cpe.MockInstance, out invalidChars);
		...
		void VerifyStringDiffs(ITsString tss1, ITsString tss2, bool fEqual, int ichMinEx, int cchInsEx, int cchDelEx, string id)
		{
			...
			TsStringDiffInfo diffInfo = StringUtils.GetDiffsInTsStrings(tss1, tss2);
			if (fEqual)
		...
		{
			return StringUtils.TrimNonWordFormingChars(StringUtils.MakeTss(test, wsf.get_Engine("en").Handle), wsf).Text;
		}

		string TrimNonWordFormingChars(string test, ILgWritingSystemFactory wsf, bool atStart, bool atEnd)
		{
			return StringUtils.TrimNonWordFormingChars(StringUtils.MakeTss(test, wsf.get_Engine("en").Handle), wsf, atStart, atEnd).Text;
		}
		#endregion
		...
		public void ObjDataCorrect()
		{
			...
			byte[] objData = StringUtils.GetObjData(guid, (byte)'X');
		...
		/// </summary>
		/// <remarks>
		/// The StringUtils.GetTsString() method for converting from XML to an ITsString
		...
		public void GetXmlRep_EmptyTss()
		{
			...
			ITsString tssClean = StringUtils.GetCleanTsString(StringUtils.MakeTss(String.Empty, m_wsf.UserWs), null);
			...
			string result = StringUtils.GetXmlRep(tssClean, m_wsf, 0, true); // 0 means Str not AStr
