...
namespace SIL.FieldWorks
{
	...
	internal partial class WelcomeToFieldWorksDlg : Form
	{
		...
		{
			// Migrated Options dialog: in New (Avalonia) UI mode, show the owned
			// Avalonia dialog. This pre-project path has no cache/mediator/project,
			// so Plugins are unavailable. Legacy mode keeps WinForms dialog.
		...
		private void ShowAvaloniaOptionsDialog(FwApplicationSettings settings)
		{
