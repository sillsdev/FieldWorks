	...
	public class BadSpellingMatcher : BaseMatcher
	{
		...
		public override FdoCache Cache
		{
			set
			{
				...
				m_dict = EnchantHelper.GetDictionary(m_ws, value.WritingSystemFactory);
			}
		}

		/// <summary>
		/// We don't normally make one unless there is a dictionary for the WS, but restoring a project
		/// from another system there might not be a suitable one available.
		/// </summary>
		public override bool IsValid()
		{
			return base.IsValid() && m_dict != null;
		}
	}
