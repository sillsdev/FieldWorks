...
namespace SIL.FieldWorks.Common.PrintLayout
{
	...
	public class HeaderFooterModifyDlg : Form, IFWDisposable
	{
		...
		protected void m_btnOK_Click(object sender, System.EventArgs e)
		{
			...
			m_curHFSet.Description.Text = m_txtBoxDescription.Text;
		...
		private void LoadRealDataIntoSec()
		{
			...
			ITsString tssDesc = m_curHFSet.Description.UnderlyingTsString;
			cda.CacheStringProp(khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidDescription,
				tssDesc);
			string sName = m_curHFSet.Name;
			if (sName == null)
				sName = "";
			cda.CacheUnicodeProp(khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidName,
				sName, sName.Length);
			...
			m_hvoDefaultHeaderSec = m_caches.FindOrCreateSecAnalysis(
				...
				(int)PubHeader.kClassId, khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidDefaultHeader,
				"DefaultHeader", kflidDefaultHeaderName);
			tssInside = m_curHFSet.DefaultHeaderOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.DefaultHeaderOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.DefaultHeaderOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultHeaderSec,
			...
			m_hvoDefaultFooterSec = m_caches.FindOrCreateSecAnalysis(
				...
				(int)PubHeader.kClassId,
				khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidDefaultFooter,
				"DefaultFooter",
				kflidDefaultFooterName);
			tssInside = m_curHFSet.DefaultFooterOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.DefaultFooterOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.DefaultFooterOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText,
				tssOutside);
			...
			m_hvoFirstHeaderSec = m_caches.FindOrCreateSecAnalysis(m_curHFSet.FirstHeaderOA.Hvo,
				(int)PubHeader.kClassId,
				khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidFirstHeader,
				"FirstHeader",
				kflidFirstHeaderName);
			tssInside = m_curHFSet.FirstHeaderOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.FirstHeaderOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.FirstHeaderOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText,
				tssOutside);
			...
			m_hvoFirstFooterSec = m_caches.FindOrCreateSecAnalysis(m_curHFSet.FirstFooterOA.Hvo,
				(int)PubHeader.kClassId,
				khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidFirstFooter,
				"FirstFooter",
				kflidFirstFooterName);
			tssInside = m_curHFSet.FirstFooterOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.FirstFooterOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.FirstFooterOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText,
				tssOutside);
			...
			m_hvoEvenHeaderSec = m_caches.FindOrCreateSecAnalysis(m_curHFSet.EvenHeaderOA.Hvo,
				(int)PubHeader.kClassId,
				khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidEvenHeader,
				"EvenHeader",
				kflidEvenHeaderName);
			tssInside = m_curHFSet.EvenHeaderOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.EvenHeaderOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.EvenHeaderOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText,
				tssOutside);
			...
			m_hvoEvenFooterSec = m_caches.FindOrCreateSecAnalysis(m_curHFSet.EvenFooterOA.Hvo,
				(int)PubHeader.kClassId,
				khvoPHFSet,
				(int)PubHFSet.PubHFSetTags.kflidEvenFooter,
				"EvenFooter",
				kflidEvenFooterName);
			tssInside = m_curHFSet.EvenFooterOA.InsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText,
				tssInside);
			tssCenter = m_curHFSet.EvenFooterOA.CenteredText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText,
				tssCenter);
			tssOutside = m_curHFSet.EvenFooterOA.OutsideAlignedText.UnderlyingTsString;
			cda.CacheStringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText,
				tssOutside);
		}
		...
		private void StoreFromSecToReal()
		{
			...
			m_curHFSet.DefaultHeaderOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.DefaultHeaderOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.DefaultHeaderOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);

			m_curHFSet.DefaultFooterOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.DefaultFooterOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.DefaultFooterOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoDefaultFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);

			m_curHFSet.FirstHeaderOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.FirstHeaderOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.FirstHeaderOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);

			m_curHFSet.FirstFooterOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.FirstFooterOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.FirstFooterOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoFirstFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);

			m_curHFSet.EvenHeaderOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.EvenHeaderOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.EvenHeaderOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenHeaderSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);

			m_curHFSet.EvenFooterOA.InsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidInsideAlignedText);

			m_curHFSet.EvenFooterOA.CenteredText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidCenteredText);

			m_curHFSet.EvenFooterOA.OutsideAlignedText.UnderlyingTsString =
				sda.get_StringProp(m_hvoEvenFooterSec,
				(int)PubHeader.PubHeaderTags.kflidOutsideAlignedText);
		}
		...
		private HFSetView ChangePanelToView(Panel pan, int hvoToDisplay)
		{
			...
			info.PageNumber = 1;
			HFModifyDlgVC vc = new HFModifyDlgVC(info, m_caches.MainCache.DefaultVernWs,
		...
		private void AddORCToText(Guid guid)
		{
			m_lastFocusedView.RootBox.Selection.ReplaceWithTsString(
				StringUtils.CreateOrcFromGuid(guid,
	...
	public class HFModifyDlgVC : HeaderFooterVc
	{
		...
		protected override void Dispose(bool disposing)
		{
			...
			m_resources.ReleaseAllResources();
			m_resources = null;
		...
		private ITsString CreateTss(string text)
		{
			...
			propsBldr.SetIntPropValues((int)FwTextPropType.ktptBackColor,
				(int)FwTextPropVar.ktpvDefault,
				(int)ColorUtil.ConvertColorToBGR(Color.LightGray));
			strBuilder.Replace(0, 0, text, propsBldr.GetTextProps());
