...
namespace SIL.FieldWorks.Common.PrintLayout
{
	...
	public class PageSetupDlg : Form, IFWDisposable, IPageSetupDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_udmFooter.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmHeader.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmGutter.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmRight.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmBottom.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmLeft.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmTop.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmPaperHeight.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_udmPaperWidth.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
		...
		/// </summary>
		/// <param name="sender">The source of the event.</param>
		/// <param name="e">The <see cref="System.Windows.Forms.PreviewKeyDownEventArgs"/>
		...
		private void panelPreview_Paint(object sender, PaintEventArgs e)
		{
			...
			Pen dashedPen = new Pen(SystemColors.GrayText);
			...
			SolidBrush lineBrush = new SolidBrush(Color.FromArgb(darkness, darkness, darkness));
			SolidBrush backgroundBrush = new SolidBrush(panel.BackColor);
		...
		/// </summary>
		/// <exception cref="ArgumentOutOfRangeException">thrown if value other than 1 or 2 is
		/// passed</exception>
		/// ------------------------------------------------------------------------------------
		...
		private void DisplayErrorMessage(PageSetupErrorType error)
		{
			...
			if (msg != null)
				MessageBox.Show(this, msg, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
