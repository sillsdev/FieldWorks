...
namespace SIL.FieldWorks.Common.Framework
{
	...
	public class UndoRedoDropDown : UserControl, IFWDisposable
	{
		...
		private string m_NumberOfActionsSingle;
		private string m_NumberOfActionsPlural;
		...
		/// Initializes a new instance of the <see cref="UndoRedoDropDown"/> class.
		/// </summary>
		/// <param name="numberOfActionsSingle">The string that contains the number of selected
		/// actions, e.g. Undo 1 action (no formatting instructions)</param>
		/// <param name="numberOfActionsPlural">The string that contains the number of selected
		/// actions, e.g. Undo {0} actions (may contain formatting instructions)</param>
		/// <param name="cancel">The string thats shown to cancel the undo/redo</param>
		/// ------------------------------------------------------------------------------------
