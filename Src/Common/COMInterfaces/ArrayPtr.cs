...
namespace SIL.FieldWorks.Common.COMInterfaces
{
	...
	/// </summary>
	/// <remarks>Use this class for passing unmanaged arrays as [out] parameter to a COM
	/// object, where the caller allocates the memory for the array with
	/// Marshal.AllocCoTaskMem</remarks>
	/// ----------------------------------------------------------------------------------------
	public class ArrayPtr : IFWDisposable
	{
		...
		protected virtual void Dispose(bool disposing)
		{
			...
			Debug.WriteLineIf(!disposing && this != s_Null,
				"****************** " + GetType().Name + " 'disposing' is false. ******************");
			if (disposing)
			{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Resizes the memory allocated by the IntPtr
		/// </summary>
