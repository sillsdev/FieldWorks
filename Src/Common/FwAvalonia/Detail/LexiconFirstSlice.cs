...
namespace SIL.FieldWorks.Common.FwAvalonia.Detail
{
	...
	/// which has no part definition in the shipped inventory -- legacy <c>DataTree</c> walks the
	/// class
	...
	public static class LexiconFirstSlice
	{
		...
		/// <summary>Subclass -> base class chain for part-ref resolution, mirroring the LCModel
		/// hierarchy.</summary>
