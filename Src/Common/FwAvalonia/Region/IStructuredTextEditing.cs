...
{
	/// <summary>
	/// The optional paragraph-CRUD capability of a <see cref="RegionFieldKind.StructuredText"/> (StText)
	/// field, kept off the core <see cref="IRegionEditContext"/> so only a context that actually edits
	...
	/// structured text implements this alongside <see cref="IRegionEditContext"/>.
	/// </summary>
