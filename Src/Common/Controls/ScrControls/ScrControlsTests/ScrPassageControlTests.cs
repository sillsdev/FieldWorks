...
namespace SIL.FieldWorks.Common.Controls.FwControls
{
	...
	/// </summary>
	[TestFixture]
	public class ScrPassageControlTest: IWsFactoryProvider
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual ILgWritingSystemFactory NewILgWritingSystemFactory
		{
			get
			{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		private void WaitForDropDownWindow()
		{
			int i = 0;
			do
			{
			...
			while (i < 5 && m_dbScp.DropDownWindow == null);
		}
