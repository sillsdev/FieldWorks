...
namespace SIL.FieldWorks.Common.Controls
{
	...
	internal class DrawOfficeXPMenuHelper : IMenuDrawingHelper
	{
		...
		private SolidBrush m_brush = new SolidBrush(Color.Empty);
		private Pen m_pen = new Pen(Color.Empty, 1);
		#endregion
		...
		private Rectangle GetMenuRect
		{
			get
			{
				...
				bool success = Win32.GetMenuItemRect(IntPtr.Zero, m_menuItem.Parent.Handle,
