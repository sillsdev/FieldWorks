...
namespace SIL.FieldWorks.Common.Drawing
{
	...
	public class BorderDrawing : Component, IFWDisposable
	{
		...
		public void Draw()
		{
			...
			{
				Pen penDarkEdge = new Pen(m_clrSingleBorder, 1);
	...
	public class LineDrawing : Component, IFWDisposable
	{
		...
		/// </summary>
		//*******************************************************************************************
		bool ShouldSerializeLightColor()
		{
			return (g_LineType != LineTypes.Solid &&
		...
		/// </summary>
		//*******************************************************************************************
		bool ShouldSerializeSolidLineColor()
		{
			return (g_LineType == LineTypes.Solid &&
		...
		/// </summary>
		//*******************************************************************************************
		bool ShouldSerializeSolidLineThickness()
		{
		...
		/// </summary>
		//*******************************************************************************************
		bool ShouldSerializeStartLocation()
		{
		...
		/// </summary>
		//*******************************************************************************************
		bool ShouldSerializeEndLocation()
		{
