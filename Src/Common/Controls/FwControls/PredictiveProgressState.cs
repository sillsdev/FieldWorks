...
namespace SIL.FieldWorks.Common.Controls
{
	...
	public class RegistryAccess
	{
		...
		private const string COMPANY_NAME = "SIL";
		...
		/// <returns></returns>
		static public string GetStringRegistryValue(string key, string sub, string defaultValue)
		{
			...
			if( rkCompany != null )
			{
				rkApplication = rkCompany.OpenSubKey(sub, true);
		...
		static public void SetStringRegistryValue(string key,string sub, string stringValue)
		{
			...
			if( rkCompany != null )
			{
				rkApplication = rkCompany.CreateSubKey(sub);
				if( rkApplication != null )
				{
