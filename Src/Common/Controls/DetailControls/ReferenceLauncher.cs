...
{
	/// <summary>
	/// Summary description for ReferenceLauncher.
	/// </summary>
	public class ReferenceLauncher : ButtonLauncher
	{
		...
		public virtual bool AllowsDuplicates
		{
			...
			{
				CheckDisposed();
				return (m_cache.GetFieldType(m_flid) == FieldType.kcptReferenceSequence);
			}
		}
		...
		/// <summary>
		/// Subclasses must override this to set the new value.
		/// </summary>
		/// <param name="hvo"></param>
		public virtual void AddItem(int hvo)
		{
			CheckDisposed();
		...
		/// <summary>
		/// Subclasses msut override this to set the new value.
		/// </summary>
		/// <param name="rghvosChosen"></param>
		public virtual void SetItems(List<int> rghvosChosen)
		{
			CheckDisposed();
