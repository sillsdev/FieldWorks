...
namespace SIL.FieldWorks.Common.Framework.DetailControls
{
	...
	public class SliceFactoryTests : DeleteCustomListTestsBase
	{
		...
		{
			var configurationNode = DetailControls.SliceTests.CreateXmlElementFromOuterXmlOf("<slice editor=\"autoCustom\" menu=\"mnuDataTree-Help\" helpTopicID=\"khtpCustomFields\" />");
