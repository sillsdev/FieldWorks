...
namespace SIL.FieldWorks.Common.Framework.DetailControls
{
	...
	internal class LiteralLabelView : RootSiteControl
	{
		...
		public override void MakeRoot()
		{
			...
			rootb.SetSite(this);
			var bldr = m_fdoCache.TsStrFactory.MakeString(m_text, m_fdoCache.WritingSystemFactory.UserWs).GetBldr();
			bldr.SetStrPropValue(0, bldr.Length, (int)FwTextPropType.ktptNamedStyle, UiElementStylename);
			m_vc = new LiteralLabelVc(bldr.GetString());
