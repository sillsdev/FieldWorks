...
namespace SIL.FieldWorks.Common.Widgets
{
	...
	/// </summary>
	public class FwListBox : Panel, IFWDisposable, IVwNotifyChange
	{
		/// <summary></summary>
		...
		public virtual ITsString TextOfItem(object item)
		{
			...
			return tsf.MakeString(item.ToString(), WritingSystemCode);
		}
		...
		public class ObjectCollection : IList, ICollection, IEnumerable, IFWDisposable
		{
			...
			public virtual object this[int index]
			{
				...
				set
				{
					...
					{
						int hvo = m_owner.m_innerFwListBox.DataAccess.get_VecItem(
							InnerFwListBox.khvoRoot, InnerFwListBox.ktagItems, index);
						m_owner.m_innerFwListBox.DataAccess.SetString(hvo,
							InnerFwListBox.ktagText, newText);
						m_owner.m_innerFwListBox.DataAccess.PropChanged(null,
							(int)PropChangeType.kpctNotifyAll,
			...
			public void AddRange(Object[] items)
			{
				...
				{
					int hvoNew = m_owner.m_innerFwListBox.DataAccess.MakeNewObject(InnerFwListBox.kclsItem,
						InnerFwListBox.khvoRoot,
						InnerFwListBox.ktagItems, index + i);
					m_owner.m_innerFwListBox.DataAccess.SetString(hvoNew,
			...
			public virtual void Clear()
			{
				...
				m_list.Clear();
				IVwCacheDa cda = m_owner.m_innerFwListBox.DataAccess as IVwCacheDa;
				if (cda == null)
			...
			public virtual void RemoveAt(int index)
			{
				...
				int hvoObj = m_owner.m_innerFwListBox.DataAccess.get_VecItem(
					InnerFwListBox.khvoRoot, InnerFwListBox.ktagItems, index);
				m_owner.m_innerFwListBox.DataAccess.DeleteObjOwner(
	...
	internal class InnerFwListBox : SimpleRootSite
	{
		...
		protected void HighlightFromMouse(Point pt, Rectangle rcSrcRoot, Rectangle rcDstRoot)
		{
			...
			IVwSelection sel = m_rootb.MakeSelAt(pt.X, pt.Y,
				new SIL.FieldWorks.Common.Utils.Rect(rcSrcRoot.Left, rcSrcRoot.Top,
				rcSrcRoot.Right, rcSrcRoot.Bottom),
				new SIL.FieldWorks.Common.Utils.Rect(rcDstRoot.Left, rcDstRoot.Top,
	...
	internal class ListBoxVc : VwBaseVc
	{
		protected InnerFwListBox m_listbox;
