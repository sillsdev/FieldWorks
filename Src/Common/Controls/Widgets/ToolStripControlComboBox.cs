...
namespace SIL.FieldWorks.Common.Widgets
{
	...
	public class ToolStripControlComboBox: ToolStripDropDownItem
	{
		...
		private Dictionary<Color, Pen> m_Pens = new Dictionary<Color, Pen>();
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="ToolStripControlComboBox"/> class.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the pen for the given color.
		/// </summary>
		/// <param name="color">The color.</param>
		/// <returns>The desired pen.</returns>
		/// ------------------------------------------------------------------------------------
		private Pen GetPen(Color color)
		{
			Pen pen;
			if (!m_Pens.TryGetValue(color, out pen))
			{
				pen = new Pen(color);
				m_Pens.Add(color, pen);
			}
		...
		/// </summary>
		/// <param name="sender">The sender.</param>
		/// <param name="args">The <see cref="System.EventArgs"/> instance containing the event
		/// data.</param>
		/// ------------------------------------------------------------------------------------
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			Pen pen = GetPen(m_fHover || DropDown.Visible ? ForeColor : BackColor);
