...
namespace SIL.FieldWorks.FDO
{
	...
	public interface IFdoSet<T> : ICollection<T>, IFdoVector
	...
	/// <summary>
	/// Exception thrown when lock file is locked and we try to open it.
	/// </summary>
	public class FdoFileLockedException : ApplicationException
	{
		/// <summary>
		/// The name of the project we can't open.
		/// </summary>
