...
namespace SIL.FieldWorks.FDO.Infrastructure.Impl
{
	...
	internal class FdoVectorVirtualChanged : FdoVectorPropertyChanged
	{
		...
		/// correct. This helps when we are doing Undo, especially, since often for virtual
		/// properties the correct alternative value cannot be determined.
		/// </summary>
		...
		{
			if (!fForUndo)
				return base.ChangeInfo; // can't do better than original Do code.
