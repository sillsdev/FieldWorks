	...
	internal sealed class UndoStack : IActionHandler, IActionHandlerExtensions
	{
		...
		private void EndUndoTaskCommon(bool updateDateModified)
		{
			...
			if (updateDateModified)
			{
				...
				{
					SIL.FieldWorks.FDO.DomainImpl.LangProject proj = m_currentBundle.DirtyObjects.ElementAt(0).Cache.LangProject as SIL.FieldWorks.FDO.DomainImpl.LangProject;
