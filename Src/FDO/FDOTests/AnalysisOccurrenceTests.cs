...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	public class AnalysisOccurrenceTests : MemoryOnlyBackendProviderBasicTestBase
	{
		...
		private void DoSetupFixture()
		{
			...
			m_para0.Contents = StringUtils.MakeTss("Xxxhope xxxthis xxxwill xxxdo. xxxI xxxhope.", Cache.DefaultVernWs);
			m_para1 = m_stText.AddNewTextPara(null);
			m_para1.Contents = StringUtils.MakeTss("Xxxcertain xxxto xxxcatch xxxa xxxfrog. xxxCertainly xxxcan. xxxOn xxxLake xxxMonroe.", Cache.DefaultVernWs);
			m_para2 = null;
		...
		private void Setup2ndText()
		{
			...
			m_para2.Contents = StringUtils.MakeTss("Small one segment paragraph.", Cache.DefaultVernWs);
		...
		private IStTxtPara MakeSimpleParsedText()
		{
			...
			para0.Contents =
				StringUtils.MakeTss("the book is red. the pages in the book are the color of the paper.",
					Cache.DefaultVernWs);
