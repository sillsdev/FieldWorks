...
namespace SIL.FieldWorks.FDO.FDOTests.DataMigrationTests
{
	...
	public sealed class DataMigrationTests7000030 : DataMigrationTestsBase
	{
		...
		{
			var newCmFolderObjsurGuids = CmFolders[CmFolderTags.LocalFilePathsInTsStrings];
		...
		private void CheckCmFoldersAndCountsBeforeMigration(Dictionary<string, HashSet<string>> CmFolders)
		{
			...
			Assert.AreEqual(5, CmFolders[CmFolderTags.LocalPictures].Count, "The number of references to CmFiles is incorrect in this CmFolder.");
			Assert.AreEqual(2, CmFolders[CmFolderTags.LocalMedia].Count, "The number of references to CmFiles is incorrect in this CmFolder.");
		}
