...
namespace SIL.FieldWorks.FDO.FDOTests.DataMigrationTests
{
	...
	public sealed class DataMigrationBasicTests : DataMigrationTestsBase
	{
		...
		{
			m_dataMigrationManager.PerformMigration(null, Int32.MaxValue);
		}
		...
		public void DowngradeMigrationTest()
		{
			...
			IDomainObjectDTORepository dtoRepos = new DomainObjectDtoRepository(7100000, new HashSet<DomainObjectDTO>(),
																				mockMDC, null);
			m_dataMigrationManager.PerformMigration(dtoRepos, 7000000);
		}
