...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	public class StFootnoteTests : ScrInMemoryFdoTestBase
	{
		...
		protected override void CreateTestData()
		{
			...
			m_footnote.FootnoteMarker = StringUtils.MakeTss("a", m_vernWs);
			...
			m_footnotePara.Contents = StringUtils.MakeTss(string.Empty, m_vernWs);
		}
		...
		{
			m_footnotePara.Contents = StringUtils.MakeTss("Text in <brackets>", m_vernWs);
		...
		{
			m_footnotePara.Contents = StringUtils.MakeTss("Paragraph One", m_vernWs);
