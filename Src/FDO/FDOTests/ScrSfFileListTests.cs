...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	/// ----------------------------------------------------------------------------------------
	[TestFixture]
	public class ScrSfFileListTests: SIL.FieldWorks.Test.TestUtils.BaseTest
	{
		#region data members
		...
		public void Add_NonExistantFile()
		{
			...
			IScrImportFileInfo f1 = CreateStubFileInfo(factory, "file1",
				new ScrReference(40, 1, 1, Paratext.ScrVers.English), new ReferenceRange(40, 1,3));
		...
		public void TestCheckForOverlaps_KeepFile2()
		{
			...
			IScrImportFileInfo f2 = CreateStubFileInfo(factory, "file2",
				new ScrReference(40, 3, 1, Paratext.ScrVers.English), new ReferenceRange(40, 3, 5));

			IScrImportFileInfo f3 = CreateStubFileInfo(factory, "file3",
				new ScrReference(40, 6, 1, Paratext.ScrVers.English), new ReferenceRange(40, 6, 7));
		...
		public void TestCheckForOverlaps_MultipleOverlaps_KeepTwoFiles()
		{
			...
			IScrImportFileInfo f2 = CreateStubFileInfo(factory, "file2",
				new ScrReference(40, 3, 1, Paratext.ScrVers.English), new ReferenceRange(40, 3, 4));

			IScrImportFileInfo f3 = CreateStubFileInfo(factory, "file3",
				new ScrReference(40, 4, 1, Paratext.ScrVers.English), new ReferenceRange(40, 4, 6));
		...
		public void TestCheckForOverlaps_MultipleOverlaps_KeepOneFile_RemoveTwo()
		{
			...
			IScrImportFileInfo f3 = CreateStubFileInfo(factory, "file3",
				new ScrReference(40, 1, 1, Paratext.ScrVers.English), new ReferenceRange(40, 1, 6));
