...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	public class AnalysisAdjusterTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		public virtual void ReplaceFootnoteOrcWithAnotherFootnoteOrc()
		{
			...
			StringUtils.InsertOrcIntoPara(Guid.NewGuid(), FwObjDataTypes.kodtOwnNameGuidHot, bldr, bldr.Length, bldr.Length, Cache.DefaultVernWs);
			...
			StringUtils.InsertOrcIntoPara(Guid.NewGuid(), FwObjDataTypes.kodtOwnNameGuidHot, bldr, 5, 6, Cache.DefaultVernWs);
			adjuster.SetNewContents(bldr.GetString());
