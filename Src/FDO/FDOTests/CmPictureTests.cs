	...
	public class CmPictureTests: MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		public void CmFileFinder_OrigFileMissing()
		{
			...
			ICmFolder folder = DomainObjectServices.FindOrCreateFolder(Cache,
				LangProjectTags.kflidPictures, StringUtils.LocalPictures);
		...
		public void CmPictureConstructor_FullParamsMultipleDescriptionVariants()
		{
			...
			ICmPicture pictNew = m_pictureFactory.Create(StringUtils.LocalPictures, 0, null, descriptions,
		...
		{
			m_pictureFactory.Create("CmPicture||c:\\whatever.jpg||", StringUtils.LocalPictures);
		}
		...
		{
			m_pictureFactory.Create("CmFile||c:\\whatever.jpg||||This is a caption||", StringUtils.LocalPictures);
		}
		...
		public void CmPictureConstructor_FromTextRep_InvalidFilename()
		{
			...
			m_pictureFactory.Create(sTextRepOfPicture, StringUtils.LocalPictures);
		}
		...
		{
			m_pictureFactory.Create("CmPicture||whatever.jpg||||This is a caption||", StringUtils.LocalPictures);
		}
		...
		public void UpdateCmPicture()
		{
			...
			m_pict.UpdatePicture(sNewFile,
				...
				StringUtils.LocalPictures, Cache.DefaultVernWs);
