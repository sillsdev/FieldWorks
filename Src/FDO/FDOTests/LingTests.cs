...
namespace SIL.FieldWorks.FDO.FDOTests.LingTests
{
	...
	public class LingTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		public void HomographCollectionWorks()
		{
			...
			rgHomographs = Cache.ServiceLocator.GetInstance<ILexEntryRepository>().CollectHomographs(Cache, sLexForm, mmtStem);
			...
			rgHomographs = Cache.ServiceLocator.GetInstance<ILexEntryRepository>().CollectHomographs(Cache, sLexForm, mmtSuffix);
		...
		public void MoForm_GetFormWithMarkers()
		{
			...
			IMoForm m = MorphServices.MakeMorph(le, StringUtils.MakeTss("-is", Cache.DefaultVernWs));
