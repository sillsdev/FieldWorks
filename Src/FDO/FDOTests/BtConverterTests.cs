...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	public class BtConverterTests : ScrInMemoryFdoTestBase
	{
		...
		{
			ITsString firstTss = StringUtils.MakeTss("", m_wsEn, "Chapter");
			ITsString secondTss = StringUtils.MakeTss("", m_wsEn, "Verse");
			Assert.IsFalse(BtConverter.StringsEndWithSameWord(firstTss, secondTss));

			firstTss = StringUtils.MakeTss("a sd 1", m_wsEn, "Chapter");
			secondTss = StringUtils.MakeTss(" a  sd   1  ", m_wsEn, "Chapter");
			Assert.IsTrue(BtConverter.StringsEndWithSameWord(firstTss, secondTss));

			firstTss = StringUtils.MakeTss("a sd 1", m_wsEn, "Chapter");
			secondTss = StringUtils.MakeTss(" a  sd   1  ", m_wsEn, "Verse");
			Assert.IsFalse(BtConverter.StringsEndWithSameWord(firstTss, secondTss));
			...
			firstTss = bldr.GetString();
			secondTss = StringUtils.MakeTss("11", m_wsEn, "Chapter");
			Assert.IsFalse(BtConverter.StringsEndWithSameWord(firstTss, secondTss));

			secondTss = StringUtils.MakeTss("1", m_wsEn, "Verse");
			Assert.IsTrue(BtConverter.StringsEndWithSameWord(firstTss, secondTss));
