...
namespace SIL.FieldWorks.FDO.FDOTests.BackupRestore
{
	...
	public class ProjectBackupServiceTestsForLinkedFiles : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		private void SetupCacheToTestAgainst()
		{
			...
			ICmFolder picturesfolder = DomainObjectServices.FindOrCreateFolder(Cache, LangProjectTags.kflidPictures, StringUtils.LocalPictures);
			ICmFolder mediafolder = DomainObjectServices.FindOrCreateFolder(Cache, LangProjectTags.kflidMedia, StringUtils.LocalMedia);
			...
			tsStringsfolder.Name.AnalysisDefaultWritingSystem = Cache.TsStrFactory.MakeString(StringUtils.LocalFilePathsInTsStrings,
