...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	public class GetRefsAtPositionTests : ScrInMemoryFdoTestBase
	{
		...
		public void NewParaInExistingSection_Begin()
		{
			...
			newPara.Contents = StringUtils.MakeTss("Some text at beginning of section without previous verse",
				Cache.DefaultVernWs);
		...
		public void NewParaInExistingSection_End()
		{
			...
			newPara.Contents = StringUtils.MakeTss("Text at the end of the section.",
				Cache.DefaultVernWs);
	...
	public class ScrTxtParaTests_FootnoteRelated : ScrInMemoryFdoTestBase
	{
		...
		public void SetContainingPara_MultipleFootnoteAdded()
		{
			...
			StringUtils.InsertOrcIntoPara(footnote1.Guid, FwObjDataTypes.kodtOwnNameGuidHot, bldr, 0, 0, Cache.DefaultVernWs);
			StringUtils.InsertOrcIntoPara(footnote2.Guid, FwObjDataTypes.kodtOwnNameGuidHot, bldr, 5, 5, Cache.DefaultVernWs);
		...
		public void SetContainingPara_ReplaceFootnote()
		{
			...
			ITsStrBldr bldr = TsStrBldrClass.Create();
			bldr.Replace(0, 0, "Test data", StyleUtils.CharStyleTextProps(null, Cache.DefaultVernWs));
			StringUtils.InsertOrcIntoPara(newFootnote.Guid, FwObjDataTypes.kodtOwnNameGuidHot, bldr, 0, 0, Cache.DefaultVernWs);
			para.Contents = bldr.GetString();
