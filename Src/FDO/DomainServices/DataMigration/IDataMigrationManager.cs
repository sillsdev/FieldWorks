...
namespace SIL.FieldWorks.FDO.DomainServices.DataMigration
{
	...
	internal interface IDataMigrationManager
	{
		...
		/// </exception>
		/// ------------------------------------------------------------------------------------
		void PerformMigration(IDomainObjectDTORepository domainObjectDtoRepository, int updateToVersion);
	...
	#region FdoDataMigrationManager class
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	...
	internal class FdoDataMigrationManager : IDataMigrationManager
	{
		...
		/// </exception>
		/// ------------------------------------------------------------------------------------
		public void PerformMigration(IDomainObjectDTORepository domainObjectDtoRepository, int updateToVersion)
		{
			...
			// ENHANCE (TimS): We should pass in the owning form instead of relying on
		...
		private object MigrateTask(IProgress progressDlg, object[] parameters)
		{
