...
// Is this necessary:    entryRef.VariantEntryTypesRS != null && entryRef.VariantEntryTypesRS.Count > 0 &&
	...
	public static class ReversalIndexServices
	{
		...
		public static void CreateOrRemoveReversalIndexConfigurationFiles(IWritingSystemManager wsMgr, FdoCache cache, string defaultConfigDir,
		...
		internal static string GetConfigPathForWs(IWritingSystemManager wsMgr, string configDir, string ws)
		{
