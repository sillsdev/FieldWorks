...
namespace SIL.FieldWorks.FDO.DomainServices
{
	...
	public class FwStyleSheet : IVwStylesheet, IStylesheet
	{
		...
		{
			return GetFaceNameFromStyle(StyleServices.NormalStyleName, ws,
		...
		public string GetFaceNameFromStyle(string name, int iws, ILgWritingSystemFactory wsf)
		{
			...
			if (iws == WritingSystemServices.kwsAnal)
				iws = m_fdoCache.DefaultAnalWs;
			else if (iws == WritingSystemServices.kwsVern)
			...
			LgCharRenderProps chrps = m_fdoCache.ThreadHelper.Invoke(() => GetChrps(iws, ttp, wsf));
