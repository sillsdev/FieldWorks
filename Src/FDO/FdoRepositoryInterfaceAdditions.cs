...
namespace SIL.FieldWorks.FDO
{
	...
	public partial interface ILexEntryRepository
	{
		...
		/// </summary>
		List<ILexEntry> CollectHomographs(FdoCache cache, string sForm, IMoMorphType morphType);
	}
	...
	public partial interface ILexEntryRefRepository
	{
		...
		/// </summary>
		/// <returns></returns>
		IEnumerable<ILexEntryRef> GetComplexFormRefsWithPrimaryEntryOrSense(ICmObject mainEntryOrSense);
		/// <summary>
		/// Returns all the complex forms which have any of the indicated entries or senses as one of their
		/// PrimaryLexemes.
		/// </summary>
		IEnumerable<ILexEntryRef> GetComplexFormRefsWithPrimaryEntryOrSense(IEnumerable<ICmObject> targets);
	}
