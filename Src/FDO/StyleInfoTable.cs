...
namespace SIL.FieldWorks.FDO.Cellar
{
	...
	public class StyleInfoTable : SortedDictionary<string, BaseStyleInfo>
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:StyleInfoTable"/> class.
		/// </summary>
		...
		/// to real ones)</param>
		/// ------------------------------------------------------------------------------------
		public StyleInfoTable(string normalStyleName,
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the <see cref="T:BaseStyleInfo"/> with the specified key. Do NOT use the setter
		...
		public void ConnectStyles(/*bool fSetDefaultsForBaselessCharStyles*/)
		{
			...
			foreach (BaseStyleInfo entry in this.Values)
			{
		...
		/// ------------------------------------------------------------------------------------
		private void SetInheritedProps(BaseStyleInfo style)
		{
		...
		/// ------------------------------------------------------------------------------------
		private void SetFontInheritance(FontInfo dst, FontInfo basedOn)
		{
