		...
		private void LoadPossibilitiesFromXml(XmlReader xrdr, ICmPossibilityList owner, string sItemClassName)
		{
			if (xrdr.ReadToDescendant(sItemClassName))
			{
				...
				do
				{
					...
					{
						case "CmPossibility":
							poss = m_factPoss.Create(guid, owner);
							break;
						case "CmAnthroItem":
							poss = m_factAnthro.Create(guid, owner) as ICmPossibility;
							break;
						case "CmSemanticDomain":
							poss = m_factSemDom.Create(guid, owner) as ICmPossibility;
							break;
						case "PartOfSpeech":
				...
				do
				{
					...
					switch (sItemClassName)
					{
						...
						case "CmAnthroItem":
							...
							poss = m_factAnthro.Create(guid, owner as ICmAnthroItem) as ICmPossibility;
							break;
						case "CmSemanticDomain":
							Debug.Assert(owner is ICmSemanticDomain);
							poss = m_factSemDom.Create(guid, owner as ICmSemanticDomain) as ICmPossibility;
							break;
						case "PartOfSpeech":
