		...
		public override ICmObject ReferenceTargetOwner(int flid)
		{
			switch (flid)
			{
				case RnGenericRecTags.kflidAnthroCodes:
					return m_cache.LanguageProject.AnthroListOA;
				case RnGenericRecTags.kflidConfidence:
					return m_cache.LanguageProject.ConfidenceLevelsOA;
				case RnGenericRecTags.kflidLocations:
					return m_cache.LanguageProject.LocationsOA;
				...
				case RnGenericRecTags.kflidRestrictions:
					return m_cache.LanguageProject.RestrictionsOA;
				case RnGenericRecTags.kflidStatus:
					return m_cache.LanguageProject.StatusOA;
				case RnGenericRecTags.kflidTimeOfEvent:
					return m_cache.LanguageProject.TimeOfDayOA;
				case RnGenericRecTags.kflidType:
					return m_cache.LanguageProject.ResearchNotebookOA.RecTypesOA;
				default:
