...
namespace SIL.FieldWorks.FDO.DomainImpl
{
	...
	internal partial class ScrBook
	{
		...
		public string BestUIName
		{
			get
			{
				return ScrFdoResources.ResourceManager.GetString("kstidBookName" + CanonicalNum.ToString());
			}
		}
		...
		public int FindSectionForChapter(int chapterNum)
		{
			...
			// the loop.
			Paratext.ScrVers versification = m_cache.LangProject.TranslatedScriptureOA.Versification;
