...
namespace SIL.FieldWorks.FDO.DomainImpl
{
		...
		where T : class, ICmObject
	{
		...
		protected virtual void RemoveObject(ICmObjectInternal goner)
		{ /* Do nothing. */ }
		...
		public virtual bool Remove(T obj)
		{
			...
			RemoveObject((ICmObjectInternal)obj);
		...
		where T : class, ICmObject
	{
		...
		protected override void RemoveObject(ICmObjectInternal goner)
		{
			goner.DeleteObject();
		}
		...
		where T : class, ICmObject
	{
		...
		public virtual T this[int index]
		{
			...
			set
			{
				...
				RemoveObject((ICmObjectInternal)original);
		...
		public virtual void RemoveAt(int index)
		{
			...
			// undo/redo stack will be able to create/delete stuff in the correct order
			m_uowService.RegisterObjectAsModified(MainObject, m_flid, originalValue, ToGuidArray());
			RemoveObject((ICmObjectInternal)goner);
		}
