...
namespace SIL.FieldWorks.FDO
{
	...
	public class FontInfo
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:FontInfo"/> class.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public FontInfo()
		{
		...
		public void SetAllDefaults()
		{
			...
			m_fontName.SetDefaultValue(StStyle.DefaultFont);
		...
		public static string GetUIFontName(string fontName)
		{
			...
			if (fontName == StStyle.DefaultPubFont)
				return FdoResources.ResourceString("kstidDefaultPubFont");
			if (fontName == StStyle.DefaultHeadingFont)
		...
		{
			if (fontNameUI == FdoResources.ResourceString("kstidDefaultFont"))
				return StStyle.DefaultFont;
			if (fontNameUI == FdoResources.ResourceString("kstidDefaultPubFont"))
				return StStyle.DefaultPubFont;
			if (fontNameUI == FdoResources.ResourceString("kstidDefaultHeadingFont"))
				return StStyle.DefaultHeadingFont;
			return fontNameUI;
		}
