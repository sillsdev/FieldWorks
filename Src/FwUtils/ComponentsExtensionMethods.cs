...
namespace SIL.FieldWorks.Common.FwUtils
{
	...
	public static class ComponentsExtensionMethods
	{
		...
		/// items.
		/// </summary>
		public static ContextMenuStrip ContextMenuStrip(this IContainer components, string name, bool clear)
		{
		...
		/// </summary>
		public static ContextMenu ContextMenu(this IContainer components, string name, bool clear)
		{
