...
const int64 kmsecPerYear = 31536000000LL;
const int kmsecPerDay =  86400000;
const int kmsecPerHour = 3600000;
const int kmsecPerMin =  60000;
const int kmsecPerSec =  1000;
const int64 ksecPerYear = 31536000LL;
const int ksecPerDay =  86400;
const int ksecPerHour = 3600;
...
const int kfttPerSec = 10000000;

// declarations for win32-to-unix time conversions
const int64 SECSPERDAY= 86400;
/* 1601 to 1970 is 369 years plus 89 leap days */
const int64 SECS_1601_TO_1970 = 11644473600LL;
const int64 SECS_1601_TO_1900 = 9435484800LL;
const int64 SECS_1900_TO_1970 = 2208988800LL;
...
struct SilTime
{
	...
	*******************************************************************************************/
	...
	static SilTime CurTime(void)
	{
		...
		time_t seconds;
		seconds = time(NULL);
		ftt = (int64)((SECS_1601_TO_1970 + seconds) * kfttPerSec);
		return SilTime(ftt / kfttPerMsec);
#endif // WIN32
	}
