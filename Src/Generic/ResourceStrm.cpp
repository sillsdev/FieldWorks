...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP_(ULONG) ResourceStream::AddRef(void)
{
	Assert(m_cref > 0);
	return ++m_cref;
}
...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP_(ULONG) ResourceStream::Release(void)
{
	Assert(m_cref > 0);
	if (--m_cref > 0)
		return m_cref;
...
/*----------------------------------------------------------------------------------------------
	...
	pointer.
----------------------------------------------------------------------------------------------*/
STDMETHODIMP ResourceStream::Read(void * pv, ULONG cb, ULONG * pcbRead)
{
	BEGIN_COM_METHOD;
...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP ResourceStream::Write(const void * pv, ULONG cb, ULONG * pcbWritten)
{
	BEGIN_COM_METHOD;
