...
-------------------------------------------------------------------------------*//*:End Ignore*/
	...
	//__declspec(dllimport) Pfn_Assert APIENTRY SetAssertProc(Pfn_Assert pfnAssert);
...
#else
#define AssertPfn(pfn) Assert(!IsBadCodePtr((void*)(pfn)))
#define AssertPfnN(pfn) Assert(!(pfn) || !IsBadCodePtr((void*)(pfn)))
#endif
