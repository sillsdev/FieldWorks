...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP_(ULONG) StrAnsiStream::AddRef()
{
	Assert(m_cref > 0);
	return ++m_cref;
}
...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP_(ULONG) StrAnsiStream::Release()
{
	Assert(m_cref > 0);
	if (--m_cref > 0)
		return m_cref;
...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP StrAnsiStream::Read(void * pv, ULONG cb, ULONG * pcbRead)
{
	BEGIN_COM_METHOD;
...
/*----------------------------------------------------------------------------------------------
	...
	@return S_OK, STG_E_INVALIDPOINTER, or E_FAIL
----------------------------------------------------------------------------------------------*/
STDMETHODIMP StrAnsiStream::Write(const void * pv, ULONG cb, ULONG * pcbWritten)
{
	BEGIN_COM_METHOD;
	ChkComArrayArg((byte *)pv, cb);
