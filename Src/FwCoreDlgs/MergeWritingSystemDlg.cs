...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public class MergeWritingSystemDlg : Form
	{
		...
		public MergeWritingSystemDlg(IWritingSystem ws, IEnumerable<IWritingSystem> wss, IHelpTopicProvider helpTopicProvider)
		{
			m_ws = ws;
		...
		public IWritingSystem SelectedWritingSystem
		{
			get
			{
				return (IWritingSystem) m_wsListBox.SelectedItem;
			}
		}
