				...
				switch (((CnvtrTypeComboItem)cboConverter.SelectedItem).Type)
				{
					...
					case ConverterType.ktypeIcuConvert:
						...
						try
						{
							...
							foreach (IcuIdAndName idAndName in CoreImpl.Text.Icu.GetConverterIdsAndNames())
							{
					...
					case ConverterType.ktypeIcuTransduce:
						...
						cboSpec.BeginUpdate();
						cboSpec.Items.Clear();
						foreach (IcuIdAndName idAndName in CoreImpl.Text.Icu.GetTransliteratorIdsAndNames())
						{
							cboSpec.Items.Add(new CnvtrSpecComboItem(idAndName.Name, idAndName.Id));
						}
						cboSpec.EndUpdate();
