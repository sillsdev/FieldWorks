...
namespace SIL.FieldWorks.FwCoreDlgs.Controls
{
	...
	public class LocaleMenuButton : Button
	{
		...
		public bool IsCustomLocale(string localeId)
		{
			...
			if (LCModel.Core.Text.Icu.TryGetDisplayName(localeId, out displayNameIgnored))
				return false;
			return true;
		}
		...
		protected override void OnClick(EventArgs e)
		{
			...
			var localeDataByLanguage = LCModel.Core.Text.Icu.GetLocalesByLanguage(m_displayLocaleId);
