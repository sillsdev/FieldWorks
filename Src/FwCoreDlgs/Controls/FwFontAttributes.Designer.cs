...
namespace SIL.FieldWorks.FwCoreDlgs.Controls
{
	partial class FwFontAttributes
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_nudPositionAmount = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			...
			this.m_cboFontPosition = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
			...
			this.m_cboUnderlineStyle = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboFontPosition;
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboUnderlineStyle;
