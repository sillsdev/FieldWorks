...
namespace SIL.FieldWorks.FwCoreDlgs.Controls
{
	partial class FwBorderTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_cboWidth = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboWidth;
