...
namespace SIL.FieldWorks.FwCoreDlgs.Controls
{
	partial class FwParagraphTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_nudIndentBy = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_nudRightIndentation = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_nudLeftIndentation = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_cboSpecialIndentation = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
			this.lblRight = new System.Windows.Forms.Label();
			this.lblLeft = new System.Windows.Forms.Label();
			this.m_nudSpacingAt = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_nudAfter = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_nudBefore = new SIL.FieldWorks.FwCoreDlgs.Controls.UpDownMeasureControl();
			this.m_cboLineSpacing = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
			this.m_pnlPreview = new System.Windows.Forms.Panel();
			this.m_lblBackground = new System.Windows.Forms.Label();
			this.m_cboDirection = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
			this.m_cboAlignment = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboDirection;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboAlignment;
		private SIL.FieldWorks.Common.Controls.FwColorCombo m_cboBackground;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboSpecialIndentation;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboLineSpacing;
