...
namespace SIL.FieldWorks.FwCoreDlgs.Controls
{
	partial class FwFontTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_cboFontSize = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
			this.m_cboFontNames = new SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboFontSize;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwInheritablePropComboBox m_cboFontNames;
