...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public partial class FwStylesDlg : Form, IFWDisposable
	{
		...
		bool m_fShowTEStyleTypes = false;
		#endregion
		...
		public bool ShowTEStyleTypes
		{
			...
			set
			{
				...
				{
					if (m_cboTypes.Items.Count == 4)
						m_cboTypes.Items.RemoveAt(3);
					Debug.Assert(m_cboTypes.Items.Count == 3);
				}
				else
				{
					if (m_cboTypes.Items.Count == 3)
						m_cboTypes.Items.Add("Dictionary");
