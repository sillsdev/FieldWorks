...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public partial class ValidCharactersDlg : Form
	{
		...
		protected internal class ValidCharGridsManager : IDisposable
		{
			...
			{
				ErrorReporter.ReportException(e, m_app.SettingsKey, m_app.SupportEmailAddress, m_currGrid?.FindForm(), false);
			}
		...
		public ValidCharactersDlg(LcmCache cache, IWritingSystemContainer wsContainer, IHelpTopicProvider helpTopicProvider, IApp app, CoreWritingSystemDefinition ws, string wsName)
			: this()
		{
			m_ws = ws;
