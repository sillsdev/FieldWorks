...
{
	/// <summary>
	/// Summary description for PUACharacterDlg.
	/// </summary>
	public class PUACharacterDlg : Form, IFWDisposable
	{
		# region member variables

		private System.ComponentModel.IContainer components;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtUpperEquiv;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtTitleEquiv;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtLowerEquiv;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtNumericValue;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtCodepoint;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtName;
		/// <summary></summary>
		protected System.Windows.Forms.TextBox m_txtDecomposition;
		/// <summary></summary>
		...
		private System.Windows.Forms.Label m_lblUpperDisplay;
		private System.Windows.Forms.Label m_lblLowerDisplay;
		private System.Windows.Forms.Label m_lblTitleDisplay;
		private System.Windows.Forms.Label m_lblPUADisplay;
		private System.Windows.Forms.CheckBox m_chBidiMirrored;
		/// <summary></summary>
		protected FwOverrideComboBox m_cbCompatabilityDecomposition;
		private System.Windows.Forms.ToolTip m_toolTip;
		/// <summary></summary>
		protected FwOverrideComboBox m_cbNumericType;
		private System.Windows.Forms.Label m_lblMessageBottom;
		private System.Windows.Forms.Label m_lblMessageMiddle;
		private System.Windows.Forms.Label m_lblMessageTop;

		/// <summary>
		/// The resource manager used to access language dependant strings.
		/// </summary>
		private ResourceManager m_res =
			new System.Resources.ResourceManager("SIL.FieldWorks.FwCoreDlgs.FwCoreDlgs",
			Assembly.GetExecutingAssembly());

		/// <summary>
		/// Error handling scheme
		/// </summary>
		private ErrorMessageHandler m_errorMessageHandler = null;
		private System.Windows.Forms.Label m_lblDecompostionDisplay;

		private WritingSystemPropertiesDialog m_parentDialog = null;
		...
		private bool m_modifyMode = false;
		...
		public bool Modify
		{
			...
			set
			{
				...
				if( value )
				{
					...
					this.Text = m_res.GetString("kstidModifyPuaTitle");
				}
				else
					this.Text = m_res.GetString("kstidAddPuaTitle");
			}
		}
		...
		/// </summary>
		public WritingSystemPropertiesDialog ParentDialog
		{
			get
			{
				CheckDisposed();
		...
		public PUACharacterDlg()
		{
			...
			Dictionary<TextBox, Label> labelAssociations = new Dictionary<TextBox, Label>();
			labelAssociations.Add(m_txtCodepoint, m_lblMessageTop);
			labelAssociations.Add(m_txtName, m_lblMessageTop);
			labelAssociations.Add(m_txtUpperEquiv, m_lblMessageMiddle);
			labelAssociations.Add(m_txtLowerEquiv, m_lblMessageMiddle);
			labelAssociations.Add(m_txtTitleEquiv, m_lblMessageMiddle);
			labelAssociations.Add(m_txtNumericValue, m_lblMessageMiddle);
			labelAssociations.Add(m_txtDecomposition, m_lblMessageBottom);
		...
		public void SetDialogProperties(IHelpTopicProvider helpTopicProvider)
		{
			...
			if (Text == m_res.GetString("kstidAddPuaTitle"))
				s_helpTopic = "khtpWsAddPUAChar";
			else if (Text == m_res.GetString("kstidModifyPuaTitle"))
				s_helpTopic = "khtpWsModifyPUAChar";
			else
			...
			{
				this.helpProvider.HelpNamespace = Path.Combine(DirectoryFinder.FWCodeDirectory,
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PUACharacterDlg));
		...
		private void SetEnabledAll(Control baseControl, bool enabled)
		{
		...
		{
			UcdProperty ucdEnumSelected = (UcdProperty)m_cbGeneralCategory.SelectedItem;
		...
		private Set<ErrorMessageHandler.ErrorMessage> ParseDecomposition(string decompostion, out string parsedDecomposition)
		{
			Set<ErrorMessageHandler.ErrorMessage> errorMessages = new Set<ErrorMessageHandler.ErrorMessage>();
			string[] codepoints = decompostion.Split(new char[]{' '});
			parsedDecomposition = "";
		...
		{
			if(CodePointMatches(codePointTextBox))
				codePointTextBox.ForeColor = SystemColors.GrayText;
			else
				codePointTextBox.ForeColor = SystemColors.ControlText;
		}
		...
		{
			return codePointTextBox.Text.TrimEnd(new char[]{' '}) == m_puaChar.CodePoint ||
		...
		private void ForceCharacterSet(TextBox textBox, UnicodePropertyType unicodePropertyType)
		{
		...
		/// </summary>
		/// <param name="textBox"></param>
		private void ForceValidNumeric(TextBox textBox)
		{
			// Find and save the curret caret position
			int selectionStart = textBox.SelectionStart;
		...
		private void RemoveSingleChar(TextBox textBox, int incorrectCharIndex)
		{
		...
		/// <returns></returns>
		private bool IsValid(char character, UnicodePropertyType unicodePropertyType)
		{
		...
		/// <returns></returns>
		private ErrorMessageHandler.ErrorMessage ValidCodepoint(string codepoint, bool lessStrict)
		{
			...
			if( PUACharacter.IsSurrogate(codepoint) )
		...
		/// <returns></returns>
		private Set<ErrorMessageHandler.ErrorMessage> ValidNumeric(string numeric, bool isDigit)
		{
			Set<ErrorMessageHandler.ErrorMessage> errorMessages = new Set<ErrorMessageHandler.ErrorMessage>();
			if(isDigit)
			{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			m_lblMessageTop.Text = m_res.GetString("kstidMessageIntro");

			// Combo boxes - options
			ICollection enumerations;

			m_cbGeneralCategory.Items.Clear();
			enumerations =
				UcdProperty.GetUCDProperty(UcdProperty.UcdCategories.generalCategory);
		...
		private void m_cbBidiClass_Leave(object sender, System.EventArgs e)
		{
		...
		/// <param name="e"></param>
		private void m_txtDecomposition_TextChanged(object sender, System.EventArgs e)
		{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void m_txtDecomposition_Leave(object sender, System.EventArgs e)
		{
		...
		private void m_txtCodepoint_TextChanged(object sender, System.EventArgs e)
		{
			...
			if(errorMessage == ErrorMessageHandler.ErrorMessage.none)
			{
				...
				else if(cachedCharacter != null)
				{
					...
					if(!string.IsNullOrEmpty(m_puaChar.Name))
						m_lblWarning.Text = m_res.GetString("kstidOverwriteUnicode");
					Text = m_res.GetString("kstidAddPuaTitle");
				}
		...
		private void m_txtCodepoint_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.CodePoint = m_txtCodepoint.Text;
		}
		...
		private void m_txtUpperEquiv_TextChanged(object sender, System.EventArgs e)
		{
			UpperLowerTitleTextChanged(m_txtUpperEquiv, m_lblUpperDisplay);
		}

		private void m_txtUpperEquiv_Leave(object sender, System.EventArgs e)
		{
			UpperLowerTitleLeave(m_txtUpperEquiv);
			m_puaChar.Upper = m_txtUpperEquiv.Text;
		}

		private void m_txtLowerEquiv_TextChanged(object sender, System.EventArgs e)
		{
			UpperLowerTitleTextChanged(m_txtLowerEquiv, m_lblLowerDisplay);
		}
		private void m_txtLowerEquiv_Leave(object sender, System.EventArgs e)
		{
			UpperLowerTitleLeave(m_txtLowerEquiv);
			m_puaChar.Lower = m_txtLowerEquiv.Text;
		}

		private void m_txtTitleEquiv_TextChanged(object sender, System.EventArgs e)
		{
			UpperLowerTitleTextChanged(m_txtTitleEquiv, m_lblTitleDisplay);
		}

		private void m_txtTitleEquiv_Leave(object sender, System.EventArgs e)
		{
			UpperLowerTitleLeave(m_txtTitleEquiv);
			m_puaChar.Title = m_txtTitleEquiv.Text;
		}

		private void m_txtNumericValue_TextChanged(object sender, System.EventArgs e)
		{
		...
		private void m_txtNumericValue_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.NumericValue = m_txtNumericValue.Text;
			CheckNumericLeave();
		}

		private void m_cbGeneralCategory_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			m_puaChar.GeneralCategory = (UcdProperty)m_cbGeneralCategory.SelectedItem;
			SetEnableBasedOnGeneralCategory();
		}
		...
		/// disabled</param>
		private void DontDisplayHiddenData(TextBox textBox, string savedString,
			string disabledDisplayValue)
		{
			if(!textBox.Enabled)
				textBox.Text = disabledDisplayValue;
			else
				textBox.Text = savedString;
		}
		...
		/// is disabled</param>
		private void DontDisplayHiddenData(CheckBox checkBox, bool savedValue, bool disabledDisplayValue)
		{
			if(!checkBox.Enabled)
				checkBox.Checked = disabledDisplayValue;
			else
		...
		private void DontDisplayHiddenData(ComboBox comboBox, UcdProperty savedEnumeration,
			UcdProperty disabledDisplayEnumeration)
		{
			if(!comboBox.Enabled)
				comboBox.SelectedItem = disabledDisplayEnumeration;
			else
				comboBox.SelectedItem = savedEnumeration;
		}

		private void m_cbCanonicalCombClass_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.CanonicalCombiningClass = (UcdProperty)m_cbCanonicalCombClass.SelectedItem;
		}

		private void m_chBidiMirrored_CheckedChanged(object sender, System.EventArgs e)
		{
		}

		private void m_chBidiMirrored_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.BidiMirrored = m_chBidiMirrored.Checked;
		}

		private void m_cbNumericType_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			CheckNumericTextChanged();
		}
		private void m_cbNumericType_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.NumericType = (UcdProperty)m_cbNumericType.SelectedItem;
			CheckNumericLeave();
		}

		private void m_cbCompatabilityDecomposition_Leave(object sender, System.EventArgs e)
		{
			m_puaChar.CompatabilityDecomposition =
				(UcdProperty)m_cbCompatabilityDecomposition.SelectedItem;
			DecompostionControlsLeave();
		...
		private void m_cbCompatabilityDecomposition_SelectedIndexChanged(
