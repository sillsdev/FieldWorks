...
namespace SIL.FieldWorks.FwCoreDlgControls
{
	...
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	internal class BulletsPreviewVc : VwBaseVc
	{
		#region Data members
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Construct one. Must be part of an BulletsPreview.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		internal BulletsPreviewVc()
		{
		}
		...
		private void AddPreviewPara(IVwEnv vwenv, ITsTextProps props, bool fAddSpaceBefore)
		{
			...
			vwenv.OpenParagraph();
			vwenv.AddSimpleRect((uint)Color.LightGray.ToArgb(), -1, kdmpFakeHeight, 0);
