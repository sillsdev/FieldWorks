...
namespace SIL.FieldWorks.FwCoreDlgControls
{
	partial class FwParagraphTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_nudIndentBy.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_nudRightIndentation.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_nudLeftIndentation.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Inch;
			...
			this.m_nudSpacingAt.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Point;
			...
			this.m_nudAfter.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Point;
			...
			this.m_nudBefore.MeasureType = SIL.FieldWorks.Common.Utils.MsrSysType.Point;
