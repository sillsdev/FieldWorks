...
namespace SIL.FieldWorks.FwCoreDlgControls
{
	...
	public class StyleInfo : BaseStyleInfo
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:StyleInfo"/> class, representing an
		/// existing style.
		/// </summary>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:StyleInfo"/> class. This constructor
		/// is used to make a copy a style with a new name.
		/// </summary>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:StyleInfo"/> class. Creates a new
		...
		private void AddBorderInfo(StringBuilder text, bool useBiDiLabels)
		{
			...
			AppendItem(text, string.Format(FwCoreDlgControls.kstidBorder, sbBorders.ToString()), sDetails);
		}
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets or sets a value indicating whether this StyleInfo is dirty.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public bool Dirty
		{
		...
		{
			if (basedOnStyle == FDO.FdoResources.DefaultParaCharsStyleName || basedOnStyle == string.Empty)
				basedOnStyle = null;
		...
		{
			if (followingStyle == FDO.FdoResources.DefaultParaCharsStyleName || followingStyle == string.Empty)
				followingStyle = null;
