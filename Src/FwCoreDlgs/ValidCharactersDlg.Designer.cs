namespace SIL.FieldWorks.FwCoreDlgs
{
	partial class ValidCharactersDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtUnicodeValue = new System.Windows.Forms.TextBox();
			...
			this.txtManualCharEntry = new System.Windows.Forms.TextBox();
			...
			this.tabData.Controls.Add(this.chkSelectAll);
			...
			this.gridCharInventory.ColumnHeadersHeightChanged += new System.EventHandler(this.gridCharInventory_ColumnHeadersHeightChanged);
			...
			this.gridCharInventory.ColumnWidthChanged += new System.Windows.Forms.DataGridViewColumnEventHandler(this.gridCharInventory_ColumnWidthChanged);
			this.gridCharInventory.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.gridCharInventory_CellContentClick);
			//
			// colChar
			//
			...
			this.grpUnicodeValue.PerformLayout();
			this.grpCharRange.ResumeLayout(false);
			this.grpCharRange.PerformLayout();
		...
		private System.Windows.Forms.TextBox txtManualCharEntry;
		...
		private System.Windows.Forms.TextBox txtUnicodeValue;
