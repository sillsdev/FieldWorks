...
namespace SIL.FieldWorks.FwCoreDlgs
{
	partial class ValidCharactersDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtUnicodeValue = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			...
			this.txtLastChar = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.lblLastChar = new System.Windows.Forms.Label();
			this.txtFirstChar = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.grpSingle = new System.Windows.Forms.GroupBox();
			this.lblSingle = new System.Windows.Forms.Label();
			this.txtManualCharEntry = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox txtManualCharEntry;
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox txtLastChar;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox txtFirstChar;
