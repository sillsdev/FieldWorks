...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	{
		#region Properties for returning result of dialog operations.
		/// <summary>Project name (for local projects, this will be a file name)</summary>
		public string Project { get; private set; }
		/// <summary>Remote host name (or null if local)</summary>
		...
		#region Constructor
		/// ------------------------------------------------------------------------------------
		public ChooseLangProjectDialog() : this(null)
		{
		}

		/// ------------------------------------------------------------------------------------
		public ChooseLangProjectDialog(Rectangle bounds, int splitterPosition) : this()
		{
