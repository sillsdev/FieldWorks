...
namespace SIL.FieldWorks.Common.Controls
{
	...
	public class UtilityDlg : Form, IFWDisposable
	{
		...
		private void m_clbUtilities_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			System.Drawing.Font boldFont = new Font(currentFont.FontFamily, currentFont.Size, boldFontStyle);

			(m_clbUtilities.SelectedItem as IUtility).OnSelection();
			m_rtbDescription.Clear();
			// What
			m_rtbDescription.SelectionFont = boldFont;
			m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksWhatItDoes);
			m_rtbDescription.AppendText("\n");
			m_rtbDescription.SelectionFont = currentFont;
			if (m_whatDescription == null || m_whatDescription == String.Empty)
				m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksQuestions);
			else
			...
			// When
			m_rtbDescription.SelectionFont = boldFont;
			m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksWhenToUse);
			m_rtbDescription.AppendText("\n");
			m_rtbDescription.SelectionFont = currentFont;
			if (m_whenDescription == null || m_whenDescription == String.Empty)
				m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksQuestions);
			else
			...
			// Cautions
			m_rtbDescription.SelectionFont = boldFont;
			m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksCautions);
			m_rtbDescription.AppendText("\n");
			m_rtbDescription.SelectionFont = currentFont;
			if (m_redoDescription == null || m_redoDescription == String.Empty)
				m_rtbDescription.AppendText(FwCoreDlgs.FwCoreDlgs.ksQuestions);
			else
