...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	internal delegate void CharacterChangedHandler(CharacterGrid grid, string newCharacter);

	/// <summary />
	internal sealed class CharacterGrid : DataGridView
	{
		...
		public static string GetSpecialCharDisplayText(string chr)
		{
			...
			var displayText = Properties.Resources.ResourceManager.GetString($"kstidSpecialChar{(int)chr[0]:X4}");
