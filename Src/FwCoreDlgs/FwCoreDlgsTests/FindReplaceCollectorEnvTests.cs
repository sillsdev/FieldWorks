...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public class FindReplaceCollectorEnvTests: ScrInMemoryFdoTestBase
	{
		...
		protected override void CreateTestData()
		{
			...
			m_para1 = m_scrInMemoryCache.AddParaToMockedSectionContent(m_section.Hvo,
				ScrStyleNames.NormalParagraph);
			m_scrInMemoryCache.AddRunToMockedPara(m_para1,
				"This is some text so that we can test the find functionality.", null);
			m_para2 = m_scrInMemoryCache.AddParaToMockedSectionContent(m_section.Hvo,
				ScrStyleNames.NormalParagraph);
			m_scrInMemoryCache.AddRunToMockedPara(m_para2,
				"Some more text so that we can test the find and replace functionality.", null);
			m_para3 = m_scrInMemoryCache.AddParaToMockedSectionContent(
				m_section.Hvo, ScrStyleNames.NormalParagraph);
			m_scrInMemoryCache.AddRunToMockedPara(m_para3,
