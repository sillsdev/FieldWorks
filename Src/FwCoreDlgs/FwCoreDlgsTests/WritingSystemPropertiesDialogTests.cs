...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public class WritingSystemPropertiesDialogTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		{
			base.TestSetup();
			m_wsKalabaIpa = CreateWritingSystem("x-kal-fonipa", "Kalaba", true);
			m_wsKalaba = CreateWritingSystem("x-kal", "Kalaba", true);
			CreateWritingSystem("x-wsd", "WSDialog", true);
			CreateWritingSystem("x-wsd-fonipa", "WSDialog", true);
			IWritingSystem wsTest = CreateWritingSystem("x-tst", "TestOnly", false);
			m_wsTestIpa = CreateWritingSystem("x-tst-fonipa", "TestOnly", true);
		...
		public void General_AddNewWs_OK()
		{
			...
			VerifyNewlyAddedWritingSystems(new[] { "x-kal-fonipa-x-etic" });
			...
			VerifyWsNames(
				...
				new[] { "x-kal", "x-kal-fonipa", "x-kal-fonipa-x-etic" });
		}
