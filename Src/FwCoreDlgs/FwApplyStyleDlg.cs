...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public partial class FwApplyStyleDlg : Form, IFWDisposable
	{
			...
			IHelpTopicProvider helpTopicProvider)
		{
			...
			m_styleSheet.Init(cache, hvoStylesOwner, stylesTag, true);
		...
		protected override void OnHandleCreated(EventArgs e)
		{
			...
			else if (m_fCanApplyCharacterStyle)
			{
				if (m_charStyleName != null)
					...
					m_styleListHelper.SelectedStyleName = FdoResources.DefaultParaCharsStyleName;
			}
		}
		...
		private void m_btnOk_Click(object sender, EventArgs e)
		{
			...
			{
				using (new UndoTaskHelper(m_rootSite, "kstidUndoApplyStyle", false))
				{
