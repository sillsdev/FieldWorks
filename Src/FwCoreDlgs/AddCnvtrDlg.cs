...
namespace SIL.FieldWorks.FwCoreDlgs
{
	...
	public class AddCnvtrDlg : Form, IFWDisposable
	{
		...
		/// ------------------------------------------------------------------------------------
		public AddCnvtrDlg(IHelpTopicProvider helpTopicProvider, Set<string> wsInUse)
			: this(helpTopicProvider, null, wsInUse)
		{
		}
		...
		public bool InstallConverter()
		{
			...
			catch (System.Runtime.InteropServices.COMException comEx)
			{
				...
				MessageBox.Show(String.Format(AddConverterDlgStrings.kstidICUErrorText, System.Environment.NewLine, appName),
			...
			finally	// this code was put in by our intern, and I'm thinking this finally block was meant to be a catch block.
			{
				// Unknown Exception... does not seem to harm functionality
				// Debug.Assert(false, "Unknown Exception");
			}
