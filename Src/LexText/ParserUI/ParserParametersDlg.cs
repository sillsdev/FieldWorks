...
namespace SIL.FieldWorks.LexText.Controls
{
	...
	public class ParserParametersDlg : Form, IFWDisposable
	{
		...
		public ParserParametersDlg()
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
			m_sXmlErrorText = ParserUIStrings.ksXmlNotWellFormed;
			m_sXmlErrorCaption = ParserUIStrings.ksIllFormedXml;
			Init();
		}
		...
		/// </summary>
		/// <param name="sXmlErrorText"></param>
		/// <param name="sXmlErrorCaption"></param>
		...
		{
			System.IO.StringReader xmlSR = new System.IO.StringReader(XMLRep);
