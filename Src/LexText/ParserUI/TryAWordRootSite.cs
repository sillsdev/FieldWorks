...
namespace SIL.FieldWorks.LexText.Controls
{
	class TryAWordRootSite : RootSiteControl
	{
		...
		private bool m_fRootMade = false;
		...
		public override void MakeRoot()
		{
			...
			m_vc.ShowDefaultSense = true;
				m_vc.LineChoices = new EditableInterlinLineChoices(LangProject.kwsFirstVern, m_fdoCache.DefaultAnalWs);
		...
		private bool SetSandboxSizeForVc()
		{
			...
			Size newSize = new Size(width * 72000 / dpiX,
				m_tryAWordSandbox.RootBox.Height * 72000 / dpiY);
