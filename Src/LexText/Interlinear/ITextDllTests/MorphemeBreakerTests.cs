...
namespace SIL.FieldWorks.IText
{
	...
	public class MorphemeBreakerTest : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		public void Phrase_BreakIntoMorphs()
		{
			...
			Assert.That(morphs.Count, Is.EqualTo(1).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord1_morphs1, baseWord1)));
			...
			Assert.That(morphs.Count, Is.EqualTo(2).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord1_morphs2, baseWord1)));
			...
			Assert.That(morphs.Count, Is.EqualTo(3).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord1_morphs3, baseWord1)));
			...
			Assert.That(morphs.Count, Is.EqualTo(1).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord2_morphs1, baseWord2)));
			...
			Assert.That(morphs.Count, Is.EqualTo(2).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord2_morphs2, baseWord2)));
			...
			Assert.That(morphs.Count, Is.EqualTo(3).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord2_morphs3, baseWord2)));
			Assert.That(morphs[0], Is.EqualTo("xxxpus"));
			...
			Assert.That(morphs.Count, Is.EqualTo(1).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord3_morphs1, baseWord3)));
			...
			Assert.That(morphs.Count, Is.EqualTo(3).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord3_morphs2, baseWord3)));
			...
			Assert.That(morphs.Count, Is.EqualTo(1).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord4_morphs1, baseWord4)));
			...
			Assert.That(morphs.Count, Is.EqualTo(2).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord4_morphs2, baseWord4)));
			Assert.That(morphs[0], Is.EqualTo("xxxpus"));
			...
			Assert.That(morphs.Count, Is.EqualTo(2).Within(String.Format("Unexpected number of morphs in string '{0}' compared to baseWord '{1}'.", baseWord5_morphs2, baseWord5)));
