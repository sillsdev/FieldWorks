...
namespace SIL.FieldWorks.IText
{
	...
	public class InterlinearFwXWindowTestBase : InterlinearTestBase
	{
		...
		public override void FixtureSetup()
		{
			...
			ReflectionHelper.SetField(typeof(FwUtils), "s_fIsTEInstalled", true);
			SetupTexts();
		}
		...
		void SetupTexts()
		{
				...
				"ConcordanceControlTests - SetupTexts()", m_actionHandler, () =>
			{
				...
				int clsidForm;
				StringUtils.ReassignTss(ref tssLexEntryForm, TsStringUtils.MakeTss(formLexEntry, Cache.DefaultVernWs));
...
#pragma warning restore 219
				...
				int segDefn_literalTranslation = Cache.GetIdFromGuid(CmAnnotationDefnTags.kguidAnnLiteralTranslation);
				int segDefn_freeTranslation = Cache.GetIdFromGuid(CmAnnotationDefnTags.kguidAnnFreeTranslation);
...
#pragma warning restore 219
	...
	public class ConcordanceControlTests : InterlinearFwXWindowTestBase
	{
		...
		public void LT6741_ReloadListWhenSearchResultsInOneItem()
		{
			...
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - LT6741_ReloadListWhenSearchResultsInOneItem",
				"ConcordanceControlTests - LT6741_ReloadListWhenSearchResultsInOneItem", m_actionHandler, () =>
			{
		...
		public void ConvertDummyToReal_RecordListDependencies()
		{
			CheckDisposed();
			List<int> results;
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - ConvertDummyToReal_RecordListDependencies",
				"ConcordanceControlTests - ConvertDummyToReal_RecordListDependencies", m_actionHandler, () =>
			{
		...
		{
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - ClerkJumpToIndex_LT6712",
				"ConcordanceControlTests - ClerkJumpToIndex_LT6712", m_actionHandler, () =>
			{
		...
		{
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - MultipleRecordLists_PropChange",
				"ConcordanceControlTests - MultipleRecordLists_PropChange", m_actionHandler, () =>
			{
				// First verify that we expect the browse view to convert selected dummy annotations to real ones.
				// <dynamicloaderinfo assemblyPath="xWorks.dll" class="SIL.FieldWorks.XWorks.RecordBrowseView"/>
				// <parameters id="wordOccurrenceList" editable="false" clerk="OccurrencesOfSelectedUnit" convertDummiesSelected="true" filterBar="false" altTitleId="Concordance-Matches">
		...
		public void LT7202_CrashInWordsAfterEditingBaselineText()
		{
			...
			// Assert in new text.
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - LT7202", "ConcordanceControlTests - LT7202",
				m_actionHandler, () =>
			{
		...
		public void LT7777_EnsureAllSegmentsHaveFreeformAnnotation()
		{
			...
			Cache.GetIdFromGuid(CmAnnotationDefnTags.kguidAnnLiteralTranslation);
			Cache.GetIdFromGuid(CmAnnotationDefnTags.kguidAnnFreeTranslation);
			Cache.GetIdFromGuid(CmAnnotationDefnTags.kguidAnnNote);
...
#pragma warning restore 219
			using (InterlinMasterHelper imh = new InterlinMasterHelper(this))
			{
				...
				//IStTxtPara newPara;
				//UndoableUnitOfWorkHelper.Do("EnsureAllSegmentsHaveFreeformAnnotation",
				//	"EnsureAllSegmentsHaveFreeformAnnotation", m_actionHandler, () =>
				//{
		...
		public void LT6967_LimitingAutoSearch()
		{
			...
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - LT6967_LimitingAutoSearch.ModifyParagraph",
				"ConcordanceControlTests - LT6967_LimitingAutoSearch.ModifyParagraph", m_actionHandler, () =>
			{
			...
			UndoableUnitOfWorkHelper.Do("ConcordanceControlTests - LT6967_LimitingAutoSearch.MakeAndBreakPhrases",
				"ConcordanceControlTests - LT6967_LimitingAutoSearch.MakeAndBreakPhrases", m_actionHandler, () =>
			{
