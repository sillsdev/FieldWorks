...
namespace SIL.FieldWorks.IText
{
	...
	public class FocusBoxControllerTests : MemoryOnlyBackendProviderBasicTestBase
	{
		...
		private void DoSetupFixture()
		{
			...
			IWritingSystem wsXkal = Cache.ServiceLocator.WritingSystemManager.Set("x-kal");
			...
			m_para0_0.Contents = StringUtils.MakeTss("Xxxhope xxxthis xxxwill xxxdo. xxxI xxxhope.", wsXkal.Handle);
		...
		public void OnAddWordGlossesToFreeTrans_Simple()
		{
			...
			AssertEx.AreTsStringsEqual(StringUtils.MakeTss("hope this works.", Cache.DefaultAnalWs),
		...
		public void OnAddWordGlossesToFreeTrans_ORCs()
		{
			...
			StringUtils.InsertOrcIntoPara(footnoteGuid, FwObjDataTypes.kodtOwnNameGuidHot,
			...
			StringUtils.InsertOrcIntoPara(footnoteGuid, FwObjDataTypes.kodtNameGuidHot,
