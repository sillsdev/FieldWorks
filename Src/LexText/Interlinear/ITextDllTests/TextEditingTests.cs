...
namespace SIL.FieldWorks.IText
{
	...
	public class TextEditingTests : InterlinearTestBase
	{
		...
		public override void FixtureSetup()
		{
			...
			// Some of our tests depend upon the Clipboard contents.
		...
		internal protected class MockRawTextEditor : RawTextPane
		{
			...
			internal void CopyToClipboard(string s)
			{
				EditingHelper.CopyTssToClipboard(StringUtils.MakeTss(s, Cache.DefaultVernWs));
			}
			...
			internal void PasteFromClipboard(out TextSelInfo tsiBeforeEdit)
			{
				using (new StateTransitionHelper(this, m_expectedTextAnnotationsDefnsAfterUndo, m_expectedTextAnnotationsDefnsAfterEdits))
				{
					...
					EditingHelper.PasteClipboard(true);
				}
			}
		...
		// --- Edits that affect twfics

		// --- Edits that affect segments and twfics
		// Delete entire text
		// Replace entire text
		...
		/// <summary>
		/// Changing a space at the end of a paragraph shouldn't affect any twfic or segment offsets
		/// </summary>

		#region EditsThatAffectOffsetsForSegmentsAndSegmentForms
		//
		// These next tests test various whitespace edits that only affect offsets for segments, twfics,
		// and punctuations annotations, but not substantially in length or content.
		//
		...
		//
		// These tests test edits that affect Segments in number and content (but not twfics).
		//
		...
		/// </summary>
		[Test]
		public virtual void InsertAndDeleteSegmentBreakAfter1stTwfic()
		{
			m_rtp.SetRoot(m_text1.ContentsOAHvo);

			// Insert cursor after first twfic and insert a period (FT should be on first segment)
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			TextSelInfo tsiBeforeIns;
			InsertSegmentBreakAfter1stTwfic(para0, out tsiBeforeIns);

			// Delete new period (merge FT back)
			TextSelInfo tsiBeforeBackspace;
			TextSelInfo tsiAfterBackspace;
			DeleteSegmentBreakAfter1stTwfic(para0, out tsiBeforeBackspace, out tsiAfterBackspace);

			// Undo
			UndoDeleteSegmentBreakAfter1stTwfic(tsiBeforeBackspace);
			UndoInsertSegmentBreakAfter1stTwfic(tsiBeforeIns);

			// Redo
			RedoInsertSegmentBreakAfter1stTwfic(tsiBeforeBackspace);
			RedoDeleteSegmentBreakAfter1stTwfic(tsiAfterBackspace);
		}
		...
		virtual protected void UndoDeleteSegmentBreakAfter1stTwfic(TextSelInfo tsiBeforeBackspace)
		{
			m_rtp.OnUndo();
			m_rtp.ValidateUndoRedo(tsiBeforeBackspace);
		}

		virtual protected void UndoInsertSegmentBreakAfter1stTwfic(TextSelInfo tsiBeforeIns)
		{
			m_rtp.OnUndo();
			m_rtp.ValidateUndoRedo(tsiBeforeIns);
		}
		...
		#region EditsThatAffectTwfics
		//
		// These next tests test edits that substantially affect Twfics in length and number (but not segments)
		//
		...
		/// </summary>
		[Test]
		public virtual void InsertAndDeleteWordFormCharInside1stTwfic()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);

			// Insert cursor inside first twfic and insert a wordforming character
		...
		/// </summary>
		[Test]
		public virtual void InsertAndDeleteSpaceInside1stTwfic()
		{
			// This tests twfic split and merge
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);

			// Insert cursor inside first twfic and insert a space
			m_rtp.SetCursor(para0, 3);
			TextSelInfo tsiBeforeIns;
			m_rtp.OnInsert(Keys.Space, out tsiBeforeIns);
			m_rtp.ValidateInsertedState(" ", tsiBeforeIns);
		...
		///  0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
		///	 xxxpus xxxyalola xxxnihimbilira. xxxnihimbilira xxxpus xxxyalola. xxxhesyla xxxnihimbilira.
		///  xxxNewTwfic xxxpus xxxyalola xxxnihimbilira. xxxnihimbilira xxxpus xxxyalola. xxxhesyla xxxnihimbilira.
		/// </summary>
		[Test]
		public virtual void InsertNewTwficIn1stSentence()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
			...
			m_rtp.SetCursor(para0, 0);
			TextSelInfo tsiBeforeIns;
			m_rtp.OnInsert("xxxNewTwfic ", out tsiBeforeIns);
			TextSelInfo tsiAfterIns = m_rtp.CurrentSelectionInfo;
			m_rtp.ValidateInsertedState("xxxNewTwfic ", tsiBeforeIns);
			string sAfterIns = "xxxNewTwfic xxxpus xxxyalola xxxnihimbilira. xxxnihimbilira xxxpus xxxyalola. xxxhesyla xxxnihimbilira.";
		...
		/// </summary>
		[Test]
		public virtual void ReplaceTwficWithSameSizeTwfic()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
		...
		/// </summary>
		[Test]
		public virtual void ReplaceTwficWithSameTwfic()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
		...
		/// a selection with twfics that match twfics. So, let's just treat those as new annotations that need
		...
		/// </summary>
		[Test]
		public virtual void ReplaceTwficsWithStringContainingSameTwfics()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
			...
			TextSelInfo tsiBeforeIns;
			m_rtp.OnInsert("xxxNewTwfic xxxpus xxxyalola xxxnihimbilira", out tsiBeforeIns);
			TextSelInfo tsiAfterIns = m_rtp.CurrentSelectionInfo;
			m_rtp.ValidateReplacedState("xxxpus xxxyalola xxxnihimbilira", "xxxNewTwfic xxxpus xxxyalola xxxnihimbilira", tsiBeforeIns);
			string sAfterIns = "xxxNewTwfic xxxpus xxxyalola xxxnihimbilira. xxxnihimbilira xxxpus xxxyalola. xxxhesyla xxxnihimbilira.";
			m_rtp.ValidateParagraphContents(para0, sAfterIns);
		...
		/// </summary>
		[Test]
		public virtual void ReplaceTwficWithTwfics()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
		...
		/// </summary>
		[Test]
		public virtual void ReplaceTwficsWithTwfic()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
		...
		/// </summary>
		[Test]
		public virtual void DeleteLastTwficIn1stSentence()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);

			// Delete last twfic in first sentence
		...
		#endregion // EditingParagraphWithNoAnnotations_EditsThatAffectTwfics

		#region EditsThatAffectTwficsAndSegments
		// these tests substantially affect twfics and segments in number and content
		...
		/// </summary>
		[Test]
		public virtual void DeleteRangeSpanningSegmentBoundaryAndWholeTwfics()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.SetRoot(m_text1.ContentsOAHvo);
		...
		#endregion EditsThatAffectTwficsAndSegments
	...
	/// <summary>
	/// enable 	[TestFixture] for debuging basic problems in these tests.
	/// </summary>
	//[TestFixture]
	...
	public class TextEditingTestsWithAnnotations : TextEditingTests
	{
		...
		/// </summary>
		[Test]
		public override void ReplaceTwficWithSameSizeTwfic()
		{
			StTxtPara para0 = m_text1.ContentsOA.ParagraphsOS[0] as StTxtPara;
			m_rtp.TextBuilder.SelectNode(para0, 0);
			TextBuilder tb = new TextBuilder(m_rtp.TextBuilder);
			...
			base.ReplaceTwficWithSameSizeTwfic();
		}
		...
		//    pb0.InsertSegmentForm(0, 2, LangProject.kguidAnnWordformInContext, "xxxNew");
		...
		//    pbNew.InsertSegmentForm(0, 0, LangProject.kguidAnnWordformInContext, "xxxMoreNew");
		...
		#endregion EditsThatAffectTwfics
	...
	public class TextEditingTestsWithAnnotations_FullyAnalyzed : TextEditingTestsWithAnnotations
	{
		...
		protected override void RedoInsertSegmentBreakAfter1stTwfic(TextSelInfo tsiBeforeBackspace)
		{
			StTxtPara para0 = new StTxtPara(Cache, tsiBeforeBackspace.HvoAnchor);
			using (SegmentFreeFormAnnotationValidationHelper helper = new SegmentFreeFormAnnotationValidationHelper(para0))
			{
				base.RedoInsertSegmentBreakAfter1stTwfic(tsiBeforeBackspace);
				ValidateInsertSegmentBreakAfter1stTwfic(helper);
			}
		}
		...
		//protected override void ValidateInsertSentencesAfterFirstSentence(StTxtPara para0, TextSelInfo tsiBeforeIns)
		//{
		//    // Note: allow the parser to readjust the offsets (simulate switching to interlinear tab)
		//    // Note: this will effectively defeat subsequent undo/redo tests.
		//    ParagraphParser.ReconstructSegmentsAndXfics(para0, false);
		//    base.ValidateInsertSentencesAfterFirstSentence(para0, tsiBeforeIns);
		//}

		//protected override void UndoInsertSentences(TextSelInfo tsiBeforeIns)
		//{
		//    // In this case, the parser has altered our offsets, so we can't test undo/redo.
		//    //base.UndoInsertSentences(tsiBeforeIns);
		//}

		//protected override void RedoInsertSentences(TextSelInfo tsiAfterIns)
		//{
		//    // In this case, the parser has altered our offsets, so we can't test undo/redo.
		//    //base.RedoInsertSentences(tsiAfterIns);
		//}
	}
}
