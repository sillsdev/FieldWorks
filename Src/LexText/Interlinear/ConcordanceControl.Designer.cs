namespace SIL.FieldWorks.IText
{
	partial class ConcordanceControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_tbSearchText.AllowMultipleLines = false;
			...
			this.m_fwtbItem.AllowMultipleLines = false;
			...
			this.m_fwtbItem.SelectionLength = 16;
			this.m_fwtbItem.SelectionStart = 0;
			//
			// m_lnkSpecify
			//
