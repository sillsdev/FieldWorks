...
namespace SIL.FieldWorks.IText {
    ...
    internal class ITextStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This utility clears an internal flag that FLEx uses to track whether a text&apos;s analysis is up-to-date. The effect will be that each text is reparsed into words the next time this information is needed. Work you have done analyzing texts will not be affected, except possibly where word alignment is actually wrong. You may see a longer delay than usual the next time you want a concordance..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to This utility finds groups of analyses that have the same word category and morpological analysis. It merges such groups into a single analysis. It keeps all the glosses, except that if some glosses are duplicates (in all writing systems) such groups will also be merged. Analyzed texts which use any of the merged analyses will be made to use the merged one..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Use this when you discover (e.g., in Words/Analyses) that you have more than one copy of the same analysis of the same wordform. It is especially helpful when you have many instances of this, for example, as a result of merging work done in multiple places..
        /// </summary>
