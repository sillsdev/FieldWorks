...
namespace SIL.FieldWorks.IText {
    ...
    internal class ITextStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This utility is intended to be used for fixing incorrect word alignment. A bug in some releases of FLEx 7 could cause this to happen when the Respeller was used. This will clear the flag that FLEx uses to determine if a parse is current. It should not affect the work you have done in analyzing texts other than repairing broken tokenization but it may update unconfirmed parser analyses..
        /// </summary>
