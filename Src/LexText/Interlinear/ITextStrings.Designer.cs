...
namespace SIL.FieldWorks.IText {
	...
	internal class ITextStrings {
		...
		/// <summary>
		///   Looks up a localized string similar to Interlinear Import failed. Are you sure you are importing a file in FieldWorks interlinear format? Word and Open Office docs cannot yet be imported. The following messages from the import process may be helpful:.
		/// </summary>
		...
		/// <summary>
		///   Looks up a localized string similar to Select the mapping file to import.
		/// </summary>
