...
{
	partial class SfmInterlinearMappingDlg
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SfmInterlinearMappingDlg));
			...
			this.Name = "SfmInterlinearMappingDlg";
			this.ShowIcon = false;
