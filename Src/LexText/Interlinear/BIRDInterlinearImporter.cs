	...
	public partial class LinguaLinksImport
	{
		...
		private static void AddELANInfoToSegment(LcmCache cache, Phrase phrase, ISegment newSegment)
		{
			if (!String.IsNullOrEmpty(phrase.mediaFile))
			{
				...
				// TODO: newSegment.MediaURIRA is the media file that we want to play. Need to add play button to the interlinear display that can be pressed to play this file.
				// TODO: file path can accessed with the command "newSegment.MediaURIRA?.MediaURI"
			}
