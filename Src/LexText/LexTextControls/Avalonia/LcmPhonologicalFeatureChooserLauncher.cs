...
namespace SIL.FieldWorks.LexText.Controls
{
	...
	/// opens. It bridges LCModel <-> the LCModel-free <see
	/// cref="FeatureChooserDialogViewModel"/>: it builds the
	/// PHONOLOGICAL feature system (every closed feature in <c>PhFeatureSystemOA</c> + its
	/// values, the flat case --
		...
		: AvaloniaDialogLauncher<FeatureChooserDialogInput, FeatureChooserDialogViewModel, FeatureChooserPayload>
	{
		...
		/// <summary>
		/// Rebuilds the phonological <c>IFsFeatStruc</c> from the chosen assignment set in ONE
		/// undoable step -- the
