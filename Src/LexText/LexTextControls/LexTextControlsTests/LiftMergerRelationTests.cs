...
namespace LexTextControlsTests
{
	public partial class LiftMergerTests
	{
		...
		public void TestImportDoesNotDuplicateTreeRelations()
		{
			...
			CollectionAssert.That(legSense.LexSenseReferences.First(), Does.Contain(armSense.LexSenseReferences), "Arm LexReferences should include the single Leg LexReference");
		}
