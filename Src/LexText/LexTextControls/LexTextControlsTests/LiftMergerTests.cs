...
namespace LexTextControlsTests
{
	...
	public partial class LiftMergerTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		/// <summary>
		/// Test merging pronunciations when entry has formless pronunciation and LIFT has pronunciations with forms.
		...
		public void MergePronunciations_MatchingMediaFiles_MergesIntoExisting()
		{
			...
			var entry = CreateSimpleStemEntry("503d3478-3545-4213-9f6b-1f087464e140", "test");
			var misPronun = AddPronunciation(entry, "mispronunciation", wsEs);
		...
		public void MergePronunciations_DuplicateFormsWithDifferentMedia_MergesBestMatch()
		{
			...
			var entry = CreateSimpleStemEntry("503d3478-3545-4213-9f6b-1f087464e140", "test");
			var pronunWithMedia = AddPronunciation(entry, "mispronunciation", wsEs);
			var pronunWithoutMedia = AddPronunciation(entry, "mispronunciation", wsEs);
		...
		public void MergePronunciations_BothBlankForms_ShouldMatch()
		{
			...
			var entry = CreateSimpleStemEntry("66EE6430-D40E-4BBF-8E17-0793E1176CF0", "test");
			var blankPronun = AddPronunciation(entry, "", -1); // blank pronunciation
