...
namespace SIL.FieldWorks.LexText.Controls
{
	...
	public class AddNewSenseDlg : Form, IFWDisposable
	{
		...
		private System.Windows.Forms.CheckBox m_cbIsStem;
		...
		private void m_cbIsStem_CheckedChanged(object sender, System.EventArgs e)
		{
			if (m_skipCheck)
				return;

			if (m_cbIsStem.Checked)
				m_msaGroupBox.MSAType = MsaType.kStem;
			else
				m_msaGroupBox.MSAType = MsaType.kUnclassified;
		}
