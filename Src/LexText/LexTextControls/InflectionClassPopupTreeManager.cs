...
namespace SIL.FieldWorks.LexText.Controls
{
	...
	public class InflectionClassPopupTreeManager : PopupTreeManager
	{
		...
		/// Constructor.
		/// </summary>
		public InflectionClassPopupTreeManager(TreeCombo treeCombo, FdoCache cache, Mediator mediator, XCore.PropertyTable propertyTable, bool useAbbr, Form parent, int wsDisplay)
