...
namespace SIL.FieldWorks.LexText.Controls
{
	...
	{
		protected FdoOwningCollection<IFsFeatDefn> m_featureList;
		...
		protected LexText.Controls.MGA.GlossListTreeView m_tvMasterList;
		protected System.Windows.Forms.RichTextBox m_rtbDescription;
		protected System.Windows.Forms.Label label3;
		protected System.Windows.Forms.Button m_btnOK;
		protected System.Windows.Forms.Button m_btnCancel;
		protected System.Windows.Forms.Button m_bnHelp;
		protected System.Windows.Forms.PictureBox pictureBox1;
		protected System.Windows.Forms.LinkLabel linkLabel1;
		protected System.Windows.Forms.ImageList m_imageList;
		protected System.Windows.Forms.ImageList m_imageListPictures;
		...
		{
			ShowHelp.ShowHelpTopic(FwApp.App, "UserHelpFile", s_helpTopic);
		}

		protected void m_tvMasterList_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
		...
		protected virtual void DoFinalActions(MasterItem mi)
		{
			// default is to do nothing
		}
		...
		protected void ForceRecordClerkToReload(int fsysHvo, int flid, int featureHvo)
		{
			// Note: All of this will cause the RecordClerk to reload,
			// since it won't know anything about the new kid yet.
			int ihvo = 0;
			ISilDataAccess sda = m_cache.MainCacheAccessor;
			int chvo = sda.get_VecSize(fsysHvo, flid);
			for ( ; ihvo < chvo && sda.get_VecItem(fsysHvo, flid, ihvo) != featureHvo; ihvo++)
				;
