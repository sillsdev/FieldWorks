...
{
	[TestFixture]
	public class UpdateParserDataTests : InDatabaseFdoTestBase
	{
		...
		private string m_sFxtTemplatePath = Path.Combine(SIL.FieldWorks.Common.Utils.DirectoryFinder.FWCodeDirectory,
														 @"Language Explorer\Configuration\Grammar\FXTs");
