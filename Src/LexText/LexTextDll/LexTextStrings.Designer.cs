...
namespace SIL.FieldWorks.XWorks.LexText {
	...
	internal class LexTextStrings {
		...
		/// </summary>
		internal static string ksAreaXLostItsDefaultTool {
			get {
		...
		/// </summary>
		internal static string ksCharsWithinWords {
			get {
		...
		/// <summary>
		///   Looks up a localized string similar to This is an early version of a tool for doing discourse analysis text charting. Currently, the columns are preset for SVO languages. If you need to change that order, first edit the list called &quot;Text Constituent Chart Templates&quot;. (The columns are the 3rd level list items.) Then come back to this tool to start charting.
		///Warning: If you change the columns after you have done some charting, you may need to rework the charts you had already done. Also, changing the baseline after you have charted that text caus [rest of string was truncated]&quot;;.
		/// </summary>
		...
		/// <summary>
		///   Looks up a localized string similar to This is a trivial demonstration of using Python to generate the contents of a field. It is extremely limited.  It grabs the the default vernacular alternative of the citation form of every entry, runs it through a Python script that you supply, and then places the output in a different writing system alternative of the citation form. It is currently implemented in a very inefficient way; it actually runs for Python script once for every entry in the database. This utility will run the Python script found at [rest of string was truncated]&quot;;.
		/// </summary>
		...
		/// <summary>
		///   Looks up a localized string similar to FieldWorks Language Explorer.
		/// </summary>
		internal static string ksFieldWorksLanguageExplorer {
			get {
				return ResourceManager.GetString("ksFieldWorksLanguageExplorer", resourceCulture);
			}
		}
		...
		/// </summary>
		internal static string ksNewFeature {
			get {
		...
		/// </summary>
		internal static string ksUnderDevelopment {
			get {
		...
		/// </summary>
		internal static string ksUpgradeValidCharsWarning {
			get {
		...
		/// <summary>
		///   Looks up a localized string similar to This is can be used to convert citation forms into another writing system..
		/// </summary>
