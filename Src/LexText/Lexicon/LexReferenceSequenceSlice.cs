...
namespace SIL.FieldWorks.XWorks.LexEd
{
	/// <summary>
	/// </summary>
	public class LexReferenceSequenceSlice : ReferenceVectorSlice, ILexReferenceSlice
	{
		...
		/// Constructor.
		/// </summary>
		public LexReferenceSequenceSlice() : base()
		{
		}
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing)
			{
				...
				LexReferenceSequenceLauncher launcher = Control as LexReferenceSequenceLauncher;
		...
		public override void FinishInit()
		{
			...
			LexReferenceSequenceLauncher launcher = new LexReferenceSequenceLauncher();
		...
		{
			CheckDisposed();
			(Control as LexReferenceSequenceLauncher).LaunchChooser();
		}
