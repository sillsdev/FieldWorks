...
namespace SIL.FieldWorks.XWorks.LexEd
{
	...
	{
		private SIL.FieldWorks.XWorks.LexEd.MsaInflectionFeatureListDlgLauncherView m_msaInflectionFeatureListDlgLauncherView;
			...
			IPersistenceProvider persistProvider, Mediator mediator, string displayNameProperty, string displayWs)
		{
			...
			m_msaInflectionFeatureListDlgLauncherView.Init(mediator, obj as FsFeatStruc);
		}
		...
		{
			bool fValid = true;
			if (m_cache != null && this.Slice != null)
				fValid = m_cache.VerifyValidObject(this.Slice.Object);
			if (fValid)
				HandleChooser();
		}
