...
namespace SIL.FieldWorks.XWorks.LexEd
{
	...
	/// </summary>
	public class LexReferencePairSlice : AtomicReferenceSlice, ILexReferenceSlice
	{
		...
		/// Default Constructor.
		/// </summary>
		public LexReferencePairSlice() : base()
		{
		}
		...
		public override void FinishInit()
		{
			...
			LexReferencePairLauncher launcher = new LexReferencePairLauncher();
		...
		{
			CheckDisposed();
			(Control as LexReferencePairLauncher).LaunchChooser();
		}
