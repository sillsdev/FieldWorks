...
namespace SIL.FieldWorks.XWorks.LexEd
{
	...
	public class ReversalIndexEntryMenuHandler : DTMenuHandler
	{
		...
		{
			// PARITY: the reversal-entry GO/move dialog (ReversalEntryGoDlg : BaseGoDlg) is NOT migrated.
			// It rides the shared BaseGoDlg search/navigate infrastructure (the same path as the
