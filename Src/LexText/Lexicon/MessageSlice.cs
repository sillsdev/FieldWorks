...
namespace SIL.FieldWorks.XWorks.LexEd
{
	...
	public class MessageSlice : Slice
	{
		...
		public override void FinishInit()
		{
			...
			var labelWs = new ChorusWritingSystem(vernWs.LanguageName, vernWs.IetfLanguageTag, vernWs.DefaultFontName, 12);
			m_notesBar.LabelWritingSystem = labelWs;
			var analWs = Cache.ServiceLocator.WritingSystems.DefaultAnalysisWritingSystem;
			var msgWs = new ChorusWritingSystem(analWs.LanguageName, analWs.IetfLanguageTag, analWs.DefaultFontName, 12);
