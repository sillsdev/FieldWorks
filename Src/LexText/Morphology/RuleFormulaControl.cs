...
namespace SIL.FieldWorks.XWorks.MorphologyEditor
{
	...
	public class RuleFormulaControl : ButtonLauncher, IPatternControl
	{
		...
		/// Returns false if the natural class has no name or an auto-generated name, true otherwise.
		/// </summary>
		/// <comments>
		...
		/// </comments>
		/// <returns></returns>
		public bool IsNCNameUserDefined()
		{
			...
			string autoGeneratedNameStub = (MEStrings.ksRuleNCFeatsName).Split('"')[0];

			// If the natural class name is not null or auto generated, then it is a user defined class name.
			bool isAutoGeneratedOrNull = natClass.Name == null || natClass.Name.UserDefaultWritingSystem.Text.Contains(autoGeneratedNameStub);
