...
namespace SIL.FieldWorks.XWorks.MorphologyEditor
{
	...
	public class RuleFormulaControl : ButtonLauncher, IPatternControl
	{
		...
		public bool IsFeatureBasedNCNameUserDefined()
		{
			...
			// If a class has no name in any WS, it reads back from LCM as the placeholder "***" rather than as empty text,
			// so we need to manually check whether the name exists in any available WS to determine if the NC is named.
