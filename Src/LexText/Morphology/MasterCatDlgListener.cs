	...
	public class MasterCatDlgListener : MasterDlgListener
	{
		...
		public override bool OnDialogInsertItemInVector(object argument)
		{
			...
			using (MasterCategoryListDlg dlg = new MasterCategoryListDlg())
			{
				...
				CmObject owningObj = (CmObject)m_mediator.PropertyTable.GetValue("ActiveClerkOwningObject");
				dlg.SetDlginfo((owningObj is CmPossibilityList) ? owningObj as CmPossibilityList : cache.LangProject.PartsOfSpeechOA, m_mediator, true, null);
