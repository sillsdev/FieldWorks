...
namespace SIL.FieldWorks.LexText.Controls.MGA
{
	...
	/// </summary>
	[TestFixture]
	public class GlossListBoxTest
	{
		private GlossListBox m_LabelGlosses;
		private XmlDocument m_doc;
		public GlossListBoxTest()
		{
		}
		/// <summary>
		///
		...
		public void Init()
		{
			...
			GlossListBoxItem glbi = new GlossListBoxItem(node, ".", "", false);
		...
		public void GlossListItemConflicts()
		{
			...
			GlossListBoxItem glbiNew = new GlossListBoxItem(node, ".", "", false);
			...
			glbiNew = new GlossListBoxItem(node, ".", "", false);
	...
	{
		GlossListTreeView treeViewGlossList;
		string sXmlFile = Path.Combine(DirectoryFinder.FWCodeDirectory,
			@"Language Explorer\MGA\GlossLists\EticGlossList.xml");
