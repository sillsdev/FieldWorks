...
namespace SIL.FieldWorks.XWorks.MorphologyEditor
{
	...
	public class RespellingTests : InDatabaseFdoTestBase
	{
		...
		private void VerifyStartingState()
		{
			...
			Assert.That("Axx simplexx testxx withxx axx lotxx ofxx wordsxx endingxx inxx xx", Is.EqualTo(text), "para 1 changes should be undone");
			text = m_para2.Contents.Text;
			Assert.That("axx sentencexx axx havingxx axx lotxx ofxx axx", Is.EqualTo(text), "para 2 changes should be undone");
		...
		private void VerifyDoneStateApplyTwo()
		{
			...
			Assert.That("axx sentencexx ayyy havingxx ayyy lotxx ofxx axx", Is.EqualTo(text), "expected text changes should occur");
		...
		{
			string text = m_para1.Contents.Text;
			Assert.That("Ay simplexx testxx withxx ay lotxx ofxx wordsxx endingxx inxx xx", Is.EqualTo(text), "expected text changes para 1");
			text = m_para2.Contents.Text;
			Assert.That("ay sentencexx ay havingxx ay lotxx ofxx ay", Is.EqualTo(text), "expected text changes para 2");
		...
		{
			string text = m_para1.Contents.Text;
			Assert.That("byy simplexx testxx withxx byy lotxx ofxx wordsxx endingxx inxx xx", Is.EqualTo(text), "expected text changes para 1");
			text = m_para2.Contents.Text;
			Assert.That("byy sentencexx byy havingxx byy lotxx ofxx byy", Is.EqualTo(text), "expected text changes para 2");
