...
namespace SIL.FieldWorks.Discourse
{
	...
	public class DiscourseExportDialog : ExportDialog
	{
		...
		{
			get { return @"Language Explorer\Export Templates\Discourse"; }
		}
		...
		protected override void DoExport(string outPath)
		{
			...
			using (new SIL.FieldWorks.Common.Utils.WaitCursor(this))
			{
				try
				{
					...
					string sTransformPath = Path.Combine(rootDir, @"Language Explorer\Export Templates\Discourse");
					switch (mode)
					{
						case "doNothing":
							break;
		...
		private static void WriteFileToZipUncompressed(string zipName, string pathName, ZipOutputStream zipFile)
		{
			...
			// Try this again when we have a later version of the library.
