...
{
#if RANDYTODO
	// TODO: How odd. This FxtDllTests assembly has no need to the FxtDll assembly it purports to test.
	// TODO: Move (including two files in "ExpectedResults" folder) to: LanguageExplorerTests.Areas, including adding new  "ExpectedResults" folder
#endif
	/// <summary>
	/// Test SFM export
	/// </summary>
	[TestFixture]
	public class StandardFormat : MemoryOnlyBackendProviderTestBase
	{
		/// <summary>
		...
		{
			var expectedResultsPath = Path.Combine(FwDirectoryFinder.SourceDirectory, "FxtDllTests", "ExpectedResults");
