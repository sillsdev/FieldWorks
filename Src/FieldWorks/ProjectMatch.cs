...
namespace SIL.FieldWorks
{
	...
	{
		/// <summary>The remote client doesn't yet know the project that will be running</summary>
		DontKnowYet,
		/// <summary>The remote client knows the project that its running and the project requested is that same project</summary>
		ItsMyProject,
		/// <summary>The remote client knows the project that its running, but the project requested is not the same project</summary>
		ItsNotMyProject,
