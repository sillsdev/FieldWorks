...
namespace SIL.FieldWorks.Common.RootSites
{
	...
	public class IbusRootSiteEventHandlerTests_Simple : SimpleRootsiteTestsBase<UndoableRealDataCache>
	{
		...
		{
			var cParas = m_cache.get_VecSize(m_hvoRoot, SimpleRootsiteTestsConstants.kflidTextParas);
			var hvoPara = m_cache.MakeNewObject(SimpleRootsiteTestsConstants.kclsidStTxtPara, m_hvoRoot, SimpleRootsiteTestsConstants.kflidTextParas, cParas);
		...
		public void UpdatePreedit(string text, int selectionStart, int selectionEnd, string composition, int cursorPos, string expectedText, int expectedSelectionStart, int expectedSelectionEnd)
		{
			// Setup
		...
		public void UpdatePreedit_SecondUpdatePreedit(string text, int selectionStart, int selectionEnd, string firstComposition, int firstCursorPos, string composition, int cursorPos, string expectedText, int expectedSelectionStart, int expectedSelectionEnd)
		{
			// Setup
			var hvoPara = SetupInitialText(text);
			SetSelection(selectionStart, selectionEnd);
		...
		public void CommitOrReset(IBusAttrUnderline underline, bool expectedRetVal, string expectedText, int expectedSelStart, int expectedSelEnd)
		{
			// Setup
			var hvoPara = SetupInitialText("a");
			SetSelection(1, 1);
			Handler.OnUpdatePreeditText(new IBusText("b", new[] { new IBusUnderlineAttribute(underline, 0, 1) }), 1);
		...
		public void CommitText(string text, int selectionStart, int selectionEnd, string composition, int cursorPos, string commitText, string expectedText, int expectedSelectionStart, int expectedSelectionEnd)
		{
			// Setup
			var hvoPara = SetupInitialText(text);
			SetSelection(selectionStart, selectionEnd);
		...
		public void DeleteSurroundingText(int cursorPos, int offset, int nChars, string expectedText, int expectedCursorPos)
		{
			// Setup
