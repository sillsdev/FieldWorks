...
namespace SIL.FieldWorks.Common.Utils
{
	...
	/// <summary>
	/// This class encapsulates a pair of items that can be used as a key in IDictionary
	/// NOTE: KeyValuePair is VERY inefficient to use as a key in Dictionary, use this instead.
	/// </summary>
	/// <typeparam name="TValue1"></typeparam>
	/// <typeparam name="TValue2"></typeparam>
	public struct PairKey<TValue1, TValue2> : IEquatable<PairKey<TValue1, TValue2>>
	{
		TValue1 m_a;
		TValue2 m_b;
		...
		/// <param name="a"></param>
		/// <param name="b"></param>
		public PairKey(TValue1 a, TValue2 b)
		{
			m_a = a;
			m_b = b;
		}
		...
		{
			PairKey<TValue1, TValue2>? pair = obj as PairKey<TValue1, TValue2>?;
			return pair.HasValue && Equals(pair.Value);
		}

		#region IEquatable<PairKey<TValue1, TValue2>> Members
		...
		/// <returns></returns>
		public bool Equals(PairKey<TValue1, TValue2> other)
		{
			return other.m_a.Equals(this.m_a) &&
				other.m_b.Equals(this.m_b);
		}
