...
namespace SIL.Utils
{
	...
	public class InventoryTests
	{
		...
		/// </summary>
		protected string m_sTestPathBase = Path.Combine(SIL.FieldWorks.Common.Utils.DirectoryFinder.FwSourceDirectory,
			@"Utilities\XMLUtils\XMLUtilsTests\InventoryBaseTestFiles");
		protected string m_sTestPathLater = Path.Combine(SIL.FieldWorks.Common.Utils.DirectoryFinder.FwSourceDirectory,
			@"Utilities\XMLUtils\XMLUtilsTests\InventoryLaterTestFiles");
		...
		public void Setup()
		{
			...
			m_inventory = new Inventory(new string[] {m_sTestPathBase, m_sTestPathLater},
	...
	[TestFixture]
	public class CreateOverrideTests
	{
		XmlNode root;
		/// <summary>
		...
		public void Setup()
		{
			...
			string pathname = Path.Combine(SIL.FieldWorks.Common.Utils.DirectoryFinder.FwSourceDirectory,
			@"Utilities\XMLUtils\XMLUtilsTests\CreateOverrideTestData.xml");
			doc.Load(pathname);
