...
namespace SIL.FieldWorks.TE
{
	...
	public class TeKeyTermsTests : ScrInMemoryFdoTestBase
	{
		...
		{
			base.TestSetup();
			m_ktVwWrapper = new KeyTermsViewWrapper(null, Cache, null, null, 0, "Dummy Project");
		...
		{
			ITsString tss = StringUtils.MakeTss("angel", Cache.DefaultVernWs, "Emphasis");
			Assert.AreEqual("angel", StringUtils.GetCleanTextFromTsString(tss,
		...
		public void GetKeyTermFromTSS_EndsWithORC()
		{
			...
			Assert.AreEqual("angel", StringUtils.GetCleanTextFromTsString(tsb.GetString(),
				m_stylesToRemove, true, Cache.LanguageWritingSystemFactoryAccessor));
		}
