...
namespace SIL.FieldWorks.TE
{
	...
	public class BackTransLanguageDialog : Form, IFWDisposable
	{
		...
		/// <summary>Whether to change all back translation views to the selected writing system
		/// </summary>
		private RegistryBoolSetting m_changeAllBtWs;
		...
		public int SelectedWS
		{
			...
			{
				CheckDisposed();
				return ((LgWritingSystem)m_olbWritingSystems.SelectedItem).Hvo;
			}
		}
		...
		private void m_btnOK_Click(object sender, System.EventArgs e)
		{
			...
			m_changeAllBtWs.Value = m_chkBxApplyToAllBtWs.Checked;
			Close();
		}
		...
		{
			SIL.FieldWorks.Common.FwUtils.ShowHelp.ShowHelpTopic(
				m_helpProvider, "khtpBackTranslationWritingSystem");
		}
	}
}
