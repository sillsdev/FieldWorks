...
namespace SIL.FieldWorks.TE
{
	...
	public class FootnotePropertiesSelector : UserControl, IFWDisposable
	{
		...
		public void Initialize(FdoCache cache, IVwStylesheet styleSheet,
			...
			bool displayReference, bool displayCusSymbol)
		{
			CheckDisposed();
		...
		private void btnChooseSymbol_Click(object sender, System.EventArgs e)
		{
			...
			using (SymbolChooserDlg dlg = new SymbolChooserDlg(fnt, m_cache.UnicodeCharProps))
			{
		...
		{
			using (SequenceOptionsDlg dlg = new SequenceOptionsDlg(m_fRestartSequence))
			{
