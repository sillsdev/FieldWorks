...
namespace SIL.FieldWorks.TE
{
	...
	public class EmptyScripture : Form, IFWDisposable, IxCoreColleague
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public EmptyScripture(ITMAdapter adapter, FdoCache fdoCache)
		{
			InitializeComponent();
			...
			string projectName = fdoCache.LangProject.Name.UserDefaultWritingSystem;
...
//		}
		...
		{
			ShowHelp.ShowHelpTopic(FwApp.App, "khtpEmptyScripture");
		}
		#endregion
	}
}
