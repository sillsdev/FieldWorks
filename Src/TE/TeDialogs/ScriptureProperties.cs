...
//			LoadOneLanguage("kstidEthiopic", '\u1369');
		...
		protected void ConvertChapterVerseNumbers()
		{
			...
			using (ProgressDialogWithTask progressDlg = new ProgressDialogWithTask(this))
			{
				...
				progressDlg.RunTask(true, ConvertChapterVerseNumbers);
			}
		}
		...
		/// <returns></returns>
		/// ------------------------------------------------------------------------------------
		private object ConvertChapterVerseNumbers(IProgress progressDlg, params object[] parameters)
		{
		...
		private void UpdateVerseBridges(string oldBridge)
		{
			...
			using (ProgressDialogWithTask progressDlg = new ProgressDialogWithTask(this))
			{
				...
				progressDlg.RunTask(true, UpdateVerseBridges, oldBridge);
			}
		}
		...
		/// ------------------------------------------------------------------------------------
		private object UpdateVerseBridges(IProgress progressDlg, object[] parameters)
		{
