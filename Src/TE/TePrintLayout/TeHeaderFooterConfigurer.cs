...
namespace SIL.FieldWorks.TE
{
	...
	public class TeHeaderFooterConfigurer: HeaderFooterConfigurer
	{
		...
		/// <summary>Tag used for sections. This might refer to a virtual property.</summary>
		...
		/// <param name="sectionTag">The section tag.</param>
		/// ------------------------------------------------------------------------------------
		public TeHeaderFooterConfigurer(FdoCache cache, int hvoHFSet, int wsDefault,
			int filterInstance, DateTime printDateTime, int sectionTag):
