...
namespace SIL.FieldWorks.TE.ExportTests
{
	...
	public class ExportXmlTests : ScrInMemoryFdoTestBase
	{
		...
		public void ExportBookSection_BTIntroWithNotes()
		{
			...
			trans.Translation.set_String(wsAnal, StringUtils.MakeTss("Introduction text", wsAnal));
		...
		public void ExportBookSection_MultipleBT()
		{
			...
			ICmTranslation trans = AddBtToMockedParagraph(introPara, wsAnal);
			trans.Translation.set_String(wsAnal, StringUtils.MakeTss("Default BT", wsAnal));
			trans.Status.set_String(wsAnal, StringUtils.MakeTss("finished", wsAnal));

			// Add a back translation for Hebrew.
			trans.Translation.set_String(lgHbo.Handle, StringUtils.MakeTss("Hbo BT", lgHbo.Handle));
		...
		public void ExportParagraph_WithFootnotes()
		{
			...
			StringUtils.InsertOrcIntoPara(footnote2.Guid, FwObjDataTypes.kodtNameGuidHot, tssTransBldr,
				"11My brother told".Length, "11My brother told".Length, Cache.DefaultAnalWs);
			StringUtils.InsertOrcIntoPara(footnote1.Guid, FwObjDataTypes.kodtNameGuidHot, tssTransBldr,
