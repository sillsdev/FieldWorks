...
namespace SIL.FieldWorks.TE.ExportTests
{
	...
	public class ExportUsfmTests : ScrInMemoryFdoTestBase
	{
		...
		public void ExportBook_Toolbox()
		{
			...
			m_book.Name.set_String(Cache.DefaultVernWs, StringUtils.MakeTss("Genesis", Cache.DefaultVernWs));
			m_book.Abbrev.set_String(Cache.DefaultVernWs, StringUtils.MakeTss("Jenn.", Cache.DefaultVernWs));
		...
		public void ExportBook_WithTwoConsecutiveTitleSecondary()
		{
			...
			m_book.Name.VernacularDefaultWritingSystem = StringUtils.MakeTss("Genesis", Cache.DefaultVernWs);
			IScrTxtPara para = ExportHelper.AppendParagraph(this, m_book, section,
				@"\c1\v1\*won \v2\*too \v3\*treee", m_wsVern, ScrStyleNames.NormalParagraph);
		...
		public void ExportBook_Toolbox_Vern_OnlyChapterNoVerse1()
		{
			...
			m_Philemon.Name.VernacularDefaultWritingSystem = StringUtils.MakeTss("Philemon", Cache.DefaultVernWs);
		...
		public void ExportBook_Paratext_BtOnly()
		{
			...
			ExportHelper.AddBackTranslation(this, m_book, (IScrTxtPara)m_book.TitleOA.ParagraphsOS[0],
				@"\*El principio del mundo", m_wsSpanish);
			m_book.Name.VernacularDefaultWritingSystem = StringUtils.MakeTss("Genesis", Cache.DefaultVernWs);
			m_book.Name.set_String(m_wsSpanish, StringUtils.MakeTss("El principio", m_wsSpanish));
...
//  Should we output the "\rcrd GEN 1" at the start in this case?
		...
		public void Annotation_Toolbox_TLB()
		{
			...
			psalms.Name.VernacularDefaultWritingSystem = StringUtils.MakeTss("Psalms", Cache.DefaultVernWs);
		...
		public void Annotation_Toolbox_NoScripture()
		{
			...
			ExportHelper.SetTitle(this, m_book, "Gneesis");
			m_book.Name.VernacularDefaultWritingSystem = StringUtils.MakeTss("Genesis", Cache.DefaultVernWs);
			m_book.Name.set_String(m_wsEnglish, StringUtils.MakeTss("Genesis", m_wsEnglish));
...
// TODO (TE-7759)						"|ReferenceRange|100" +
		...
		public void ExportPara_Toolbox_PictureWithBT()
		{
			using (DummyFileMaker filemaker = new DummyFileMaker("junk.jpg", true))
			{
				...
				ICmPicture picture = para.GetPictures()[0];
				picture.Caption.set_String(m_wsEnglish, StringUtils.MakeTss("Cool", m_wsEnglish));
				picture.Caption.set_String(m_wsGerman, StringUtils.MakeTss("Mein favorite Martian caption", m_wsGerman));
				picture.Caption.set_String(m_wsSpanish, StringUtils.MakeTss("Mino favorita Martiana captionia", m_wsSpanish));
				string sInternalAbsPath = picture.PictureFileRA.AbsoluteInternalPath;
		...
		public void ExportParatext_StyFile()
		{
			...
			try
			{
				...
				chapterNumberStyle.Usage.UserDefaultWritingSystem =
					StringUtils.MakeTss("Chapter Number identifies the start of a chapter.", Cache.DefaultUserWs);
				...
				verseNumberStyle.Usage.UserDefaultWritingSystem =
					StringUtils.MakeTss("Verse Number identifies the start of a verse.", Cache.DefaultUserWs);
				...
				mainTitleStyle.Usage.UserDefaultWritingSystem =
					StringUtils.MakeTss("Main Title identifies a book title.", Cache.DefaultUserWs);
