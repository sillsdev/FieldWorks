...
namespace SIL.FieldWorks.TE.ImportTests
{
	...
	/// ---------------------------------------------------------------------------------------
	[TestFixture]
	public class ImportStyleProxyTests : BaseTest
	{
		...
		public void InitTest()
		{
			...
			Debug.Assert(m_cache == null, "m_cache is not null.");
			//if (m_cache != null)
			//	m_cache.Dispose();
			...
			m_styleSheet.Init(m_cache, scr.Hvo,
		...
		public void CreateProxyForDecomposedStyleWhenExistingStyleIsComposed()
		{
			...
			ImportStyleProxy proxy1 = new ImportStyleProxy("\u0041\u0304",
				StyleType.kstParagraph, m_cache.DefaultVernWs, ContextValues.Text, m_styleSheet);
