...
namespace SIL.FieldWorks.TE.ImportTests
{
	...
	public class DummyTeImporter : TeSfmImporter
	{
		...
		static public void SetUpMappings(IScrImportSet settings)
		{
			...
			settings.SetMapping(MappingSet.Main, new ImportMappingInfo(@"\vern", MarkerDomain.Note, "Default Paragraph Characters", "x-kal", null));
			...
			settings.SetMapping(MappingSet.Main, new ImportMappingInfo(@"\uw", @"\uw*", false,
				MappingTargetType.TEStyle, MarkerDomain.Default, "Untranslated Word", "x-kal"));
			...
			settings.SetMapping(MappingSet.Main, new ImportMappingInfo(@"\btvw", MarkerDomain.BackTrans, "Untranslated Word", "x-kal", null));
	...
	public class TeImportTestInMemory : TeImportTestsBase
	{
		...
		public void ProcessSegment_UseMappedLanguage()
		{
			...
			Assert.AreEqual(1, m_importer.NormalParaStrBldr.RunCount);
			int wsExpected = Cache.ServiceLocator.WritingSystemManager.GetWsFromStr("x-kal");
