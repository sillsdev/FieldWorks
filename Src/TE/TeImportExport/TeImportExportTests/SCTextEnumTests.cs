...
namespace SIL.FieldWorks.TE
{
	...
	public class SCTextEnumTests : ScrInMemoryFdoTestBase
	{
		...
		public void ConvertingTextSegments_MainImportDomain()
		{
			...
			ISCTextEnum textEnum = GetTextEnum(ImportDomain.Main,
				new ScrReference(40, 0, 0, Paratext.ScrVers.English),
				new ScrReference(40, 1, 2, Paratext.ScrVers.English));
		...
		public void ConvertAsciiToUnicode()
		{
			...
			try
			{
				...
				ISCTextEnum textEnum = GetTextEnum(ImportDomain.Main,
					new ScrReference(45, 0, 0, Paratext.ScrVers.English),
					new ScrReference(45, 1, 1, Paratext.ScrVers.English));
		...
		public void EnsureFilesAreClosed()
		{
			...
			textEnum = GetTextEnum(ImportDomain.Main,
				new ScrReference(2, 1, 1, Paratext.ScrVers.English), new ScrReference(2, 1, 1, Paratext.ScrVers.English));
			FileUtils.Delete(filename);
		}
