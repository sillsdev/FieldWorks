...
namespace SIL.FieldWorks.TE
{
	...
	public class ExportXmlDialog : Form, IFWDisposable
	{
		...
		private void m_btnOk_Click(object sender, System.EventArgs e)
		{
			...
			if (directoryName == m_txtOutputFile.Text)
				m_txtOutputFile.Text = Path.Combine(directoryName,
					m_scr.Cache.LangProject.Name.UserDefaultWritingSystem + m_fileDialog.DefaultExtension);
		}
		...
		private void m_btnHelp_Click(object sender, System.EventArgs e)
		{
			...
			{
				case FileType.OXES:
					ShowHelp.ShowHelpTopic(FwApp.App, "khtpExportXML");
					break;
				case FileType.XHTML:
					ShowHelp.ShowHelpTopic(FwApp.App, "khtpExportXHTML");
					break;
				case FileType.ODT:
					// TODO: Write ODT help
					ShowHelp.ShowHelpTopic(FwApp.App, "khtpExportODT");
					break;
				case FileType.PDF:
					// TODO: Write PDF help
					ShowHelp.ShowHelpTopic(FwApp.App, "khtpExportPDF");
					break;
				default:
					ShowHelp.ShowHelpTopic(FwApp.App, "khtpExportXML");
					break;
		...
		private void FillFilterListLabel(FilteredScrBooks filter)
		{
			...
			if (filter != null)
			{
				for (int i = 0; i < filter.BookCount; ++i)
				{
					...
					if (i > 0)
						sb.Append(", ");
					sb.Append(book.Name.UserDefaultWritingSystem);
				}
			}
	...
	internal class SectionCboItem
	{
		...
		/// --------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="SectionCboItem"/> class.
		/// </summary>
