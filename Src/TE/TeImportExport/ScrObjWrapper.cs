...
namespace SIL.FieldWorks.TE
{
	...
	public class ScrObjWrapper
	{
		...
		/// </summary>
		protected ScrImportSet m_settings = null;
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="ScrObjWrapper"/> class.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public ScrObjWrapper()
		{
		}
		...
		public virtual BCVRef SegmentFirstRef
		{
			...
			{
				if (TypeOfImport == TypeOfImport.Paratext6)
					return new BCVRef(m_scParatextTextSegment.FirstReference.BBCCCVVV);
				else if (TypeOfImport == TypeOfImport.Other || TypeOfImport == TypeOfImport.Paratext5)
		...
		public virtual BCVRef SegmentLastRef
		{
			...
			{
				if (TypeOfImport == TypeOfImport.Paratext6)
					return new BCVRef(m_scParatextTextSegment.LastReference.BBCCCVVV);
				else if (TypeOfImport == TypeOfImport.Other || TypeOfImport == TypeOfImport.Paratext5)
		...
		public virtual List<string> ExternalPictureFolders
		{
			get
			{
				...
				externalPaths.Add(m_settings.Cache.LangProject.ExternalLinkRootDir);
