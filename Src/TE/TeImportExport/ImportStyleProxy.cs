...
//				m_StyleType = StyleType.kstParagraph;
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the paragraph properties for this proxy, creating a real style on-the-fly if
		/// necessary.
		/// </summary>
		/// <remarks>REVIEW: This implementation is not efficient. If we decide this is the best
		/// way to do this, we should cache the return value instead of m_rgbParaProps and
		/// replace all calls to ParaProps with this property instead.
		/// </remarks>
		/// ------------------------------------------------------------------------------------
