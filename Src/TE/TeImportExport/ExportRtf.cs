...
namespace SIL.FieldWorks.TE
{
	...
	public class ExportRtf
	{
		...
		{
			using (var progressDlg = new ProgressDialogWithTask(Form.ActiveForm))
			{
				...
				progressDlg.RunTask(true, ExportKeyTerms);
			}
		}
		...
		/// ------------------------------------------------------------------------------------
		private object ExportKeyTerms(IProgress progressDlg, params object[] parameters)
		{
		...
		private void ExportTE()
		{
			...
			using (ProgressDialogWithTask progressDlg = new ProgressDialogWithTask(Form.ActiveForm))
			{
				...
				progressDlg.RunTask(true, ExportTE);
			}
		}
		...
		/// <returns></returns>
		/// ------------------------------------------------------------------------------------
		private object ExportTE(IProgress progressDialog, object[] parameters)
		{
