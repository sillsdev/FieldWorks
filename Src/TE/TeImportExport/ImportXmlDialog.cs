...
namespace SIL.FieldWorks.TE
{
	...
	public partial class ImportXmlDialog : Form, IFWDisposable
	{
		...
		private bool EnsureProperOxesFile()
		{
			...
			{
				DisplayImportError(SUE_ErrorCode.OxesMigrationFailed, m_tbFilename.Text,
					Validator.GetOxesVersion(m_tbFilename.Text), e.Message);
				return false;
			}
		}
		...
		{
			ShowHelp.ShowHelpTopic(m_helpTopicProvider, "khtpImportXML");
		}
		#endregion
