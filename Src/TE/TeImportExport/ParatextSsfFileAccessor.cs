...
namespace SIL.FieldWorks.TE
{
	...
	public class ParatextSsfFileAccessor
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="T:ParatextSsfFileAccessor"/> class.
		/// </summary>
			...
			string projPath, FileWriter writer, int ws)
		{
			...
			writer.WriteLine("<Encoding>65001</Encoding>"); // We always do Unicode!
			...
			writer.WriteLine("<FullName>" + m_cache.LangProject.Name.UserDefaultWritingSystem + "</FullName>");
