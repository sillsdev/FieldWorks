...
namespace SIL.FieldWorks.TE
{
	...
	public class TeImportExportFileDialog : IDisposable
	{
		...
		/// ------------------------------------------------------------------------------------
		public TeImportExportFileDialog(FdoCache cache, FileType fileType)
		{
			m_cache = cache;
			m_fileType = fileType;
		}
		...
		public string DefaultFileName
		{
			get
			{
				string fileName = m_cache.LangProject.Name.UserDefaultWritingSystem;
				if (fileName == null || fileName == string.Empty)
					fileName = m_cache.DatabaseName;
