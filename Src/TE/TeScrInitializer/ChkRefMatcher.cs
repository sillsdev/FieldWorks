...
namespace SIL.FieldWorks.TE
{
	...
	public class ChkRefMatcher
	{
		...
		static ChkRefMatcher()
		{
			...
			s_table[913] = s_table[7944] = s_table[7946] = s_table[7948] = s_table[7950] =
				s_table[8120] = s_table[8121] = s_table[8122] = s_table[8123] = "A";

			s_table[7945] = s_table[7947] = s_table[7949] = s_table[7951] = "Ha";

			s_table[945] = s_table[7936] = s_table[7938] = s_table[7940] = s_table[7942] =
			...
			s_table[917] = s_table[7960] = s_table[7962] = s_table[7964] = s_table[8136] =
				s_table[8137] = "E";

			s_table[7961] = s_table[7963] = s_table[7965] = "He";

			s_table[949] = s_table[7952] = s_table[7954] = s_table[7956] = s_table[8050] =
				s_table[8051] = "e";
			...
			s_table[919] = s_table[7976] = s_table[7978] = s_table[7980] = s_table[7982] =
				s_table[8138] = s_table[8139] = "J";

			s_table[7977] = s_table[7979] = s_table[7981] = s_table[7983] = "Hj";

			s_table[951] = s_table[7968] = s_table[7970] = s_table[7972] = s_table[7974] =
			...
			s_table[921] = s_table[7992] = s_table[7994] = s_table[7996] = s_table[7998] =
				s_table[8152] = s_table[8153] = s_table[8154] = s_table[8155] = "I";

			s_table[7993] = s_table[7995] = s_table[7997] = s_table[7999] = "Hi";

			s_table[953] = s_table[970] = s_table[7984] = s_table[7986] = s_table[7988] =
			...
			s_table[927] = s_table[8008] = s_table[8010] = s_table[8012] = s_table[8184] =
				s_table[8185] = "O";

			s_table[8009] = s_table[8011] = s_table[8013] = "Ho";

			s_table[959] = s_table[8000] = s_table[8002] = s_table[8004] = s_table[8056] =
				s_table[8057] = "o";
			...
			s_table[933] = s_table[8168] = s_table[8169] = s_table[8170] = s_table[8171] = "U";

			s_table[8025] = s_table[8027] = s_table[8029] = s_table[8031] = "Hu";

			s_table[965] = s_table[971] = s_table[8016] = s_table[8018] = s_table[8020] =
			...
			s_table[937] = s_table[8040] = s_table[8042] = s_table[8044] = s_table[8046] =
				s_table[8186] = s_table[8187] = "W";

			s_table[8041] = s_table[8043] = s_table[8045] = s_table[8047] = "Hw";

			s_table[969] = s_table[8032] = s_table[8034] = s_table[8036] = s_table[8038] =
		...
		/// <returns>A (lossy) romanized translieteration</returns>
		/// ------------------------------------------------------------------------------------
			...
			IChkRef chkRefOld)
		{
			...
			string sTargetWord = chkRefOld.KeyWord.Text;
			foreach (IChkTerm term in possibilty.SubPossibilitiesOS)
			{
				foreach (ChkRef chkRef in term.OccurrencesOS)
				{
					if (chkRef.Ref == chkRefOld.Ref &&
						Transliterate(chkRef.KeyWord.Text) == sTargetWord)
					{
						list.Add(chkRef);
					}
				}
