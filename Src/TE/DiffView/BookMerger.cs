...
namespace SIL.FieldWorks.TE
{
	...
	public class BookMerger: IDisposable
	{
		...
		/// ------------------------------------------------------------------------------------
		public object DetectDifferences(IProgress progressDlg, object[] parameters)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public void DetectDifferences(IProgress progressDlg)
		{
			...
			if (m_progressDlg != null)
			{
				...
				m_progressDlg.Maximum = m_bookRev.SectionsOS.Count;
...
//			return bldr.GetString();
		...
		{
			Guid objGuid = StringUtils.GetUsefulGuidFromProps(ttp);
			ICmObject obj;
		...
		/// on a background thread.</remarks>
		/// ------------------------------------------------------------------------------------
		public object DoPartialOverwrite(IProgress progressDlg, object[] parameters)
		{
		...
		private void DoPartialOverwriteInternal(List<IScrSection> sectionsToRemove)
		{
			...
			if (m_bookCurr.TitleOA != null && m_bookRev.TitleOA != null &&
				...
				((IScrTxtPara)m_bookRev.TitleOA[0]).Contents.Length > 0)
			{
				OverwriteTitle();
			}
...
//	as their position in the Current
...
#else
				// TODO-Linux: work around mono bug in DiffViewTest producing 419 error even though it private
				progressDlg.RunTask(DisplayUi, RecalculateDifferences_);
#endif
			}
		}
		...
		/// ------------------------------------------------------------------------------------
#if !__MonoCS__
		private object RecalculateDifferences(IProgress progressDlg, params object[] parameters)
#else
		// TODO-Linux: work around mono bug in DiffViewTest producing 419 error even though it private
		private object RecalculateDifferences_(IProgress progressDlg, params object[] parameters)
#endif
		{
