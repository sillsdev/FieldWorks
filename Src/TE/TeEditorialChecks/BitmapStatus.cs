...
namespace SIL.FieldWorks.TE.TeEditorialChecks
{
	...
	public abstract class BitmapStatus : IConvertible, IComparable
	{
		...
		/// --------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="BitmapStatus"/> struct.
		/// </summary>
		...
		/// <see cref="SIL.FieldWorks.TE.TeEditorialChecks.BitmapStatus"/> to <see cref="System.Int32"/>.
		/// </summary>
		/// <param name="status">The status.</param>
		...
		/// <summary>
		/// Performs an implicit conversion from
		/// <see cref="SIL.FieldWorks.TE.TeEditorialChecks.BitmapStatus"/> to <see cref="Image"/>.
		/// </summary>
		/// <param name="status">The status.</param>
		/// <returns>The result of the conversion.</returns>
		/// --------------------------------------------------------------------------------
