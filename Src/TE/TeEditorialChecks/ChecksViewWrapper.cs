...
namespace SIL.FieldWorks.TE.TeEditorialChecks
{
		...
		IxCoreColleague
	{
		...
		/// <summary></summary>
		protected bool m_fShownBefore = false;
		/// <summary></summary>
		...
		/// <summary></summary>
		protected IControlCreator m_ControlCreator;
		/// <summary>
		...
		public bool OnUpdateEnableSendSyncMessage(object args)
		{
			...
			if (itemProps != null && m_draftView.EditingHelper != null)
			{
				...
				itemProps.Checked = EditingHelper.SendSyncMessages;
		...
		/// ------------------------------------------------------------------------------------
		protected IControlCreator ControlCreator
		{
			get
			{
