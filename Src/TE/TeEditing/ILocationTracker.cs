...
// <copyright from='2007' to='2012' company='SIL International'>
...
namespace SIL.FieldWorks.TE
{
	...
	public interface ILocationTracker
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the current book at the anchor of the selection, or null if there is
		...
		/// ------------------------------------------------------------------------------------
		IScrBook GetBook(SelectionHelper selHelper, SelectionHelper.SelLimitType selLimitType);
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the current section at the anchor of the selection, or null if we're
		...
		/// ------------------------------------------------------------------------------------
		IScrSection GetSection(SelectionHelper selHelper, SelectionHelper.SelLimitType selLimitType);
