...
namespace SIL.FieldWorks.TE
{
	...
	{
		#region Data members
		FwRootSite m_draftView = null;
		TeEditingHelper m_draftViewEditingHelper = null;
		#endregion
		...
		/// <returns></returns>
		/// ------------------------------------------------------------------------------------
		public override ScrFootnote GoToNextFootnote()
		{
			CheckDisposed();
		...
		/// ------------------------------------------------------------------------------------
		public override ScrFootnote InsertFootnote(SelectionHelper helper, string styleName, out int insertPos)
		{
			CheckDisposed();
		...
		/// <returns>true if the contents of the clipboard could be pasted; otherwise false
		/// </returns>
		/// ------------------------------------------------------------------------------------
		public override void PasteClipboard(bool pasteOneParagraph)
		{
			...
			// With footnotes, we want to ignore the value of pasteOneParagraph and to only
			// paste the first paragraph.
			base.PasteClipboard(true);
		}
		#endregion
