...
namespace SIL.FieldWorks.FDO.Scripture
{
	...
	public class ParaNodeMap : IComparable
	{
		...
		/// ------------------------------------------------------------------------------------
		public ParaNodeMap(StTxtPara para)
		{
		...
		public int BookFlid
		{
			get
			{
				if (m_location[kBookFlidIndex] == kTitle)
					return (int)ScrBook.ScrBookTags.kflidTitle;
				else
		...
		public int SectionFlid
		{
			get
			{
				if (m_location[kSectionFlidIndex] == kHeading)
					return (int)ScrSection.ScrSectionTags.kflidHeading;
				else
					return (int)ScrSection.ScrSectionTags.kflidContent;
			}
		}
