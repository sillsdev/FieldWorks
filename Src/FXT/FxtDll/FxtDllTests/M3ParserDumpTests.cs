...
namespace SIL.FieldWorks.Common.FXT
{
	...
	/// </summary>
		...
		public class M3ParserDumpTests : FxtTestBase
		{
			...
			/// </summary>
			protected string m_sFxtParserPath = Path.Combine(SIL.FieldWorks.Common.Utils.DirectoryFinder.GetFWCodeSubDirectory(@"Language Explorer\Configuration\Grammar\FXTs"),
				"M3Parser.fxt");
