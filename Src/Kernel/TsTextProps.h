...
/*----------------------------------------------------------------------------------------------
	Implementation of ITsTextProps.
	Hungarian: zttp
----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------
	TsPropsHolder is a hash table containing all TsTextProps active on this thread.
...
{
public:
	static TsPropsHolder * GetPropsHolder(bool fCreate = true);
...
/*----------------------------------------------------------------------------------------------
	Used to hold common strings such as style names. There is one of these per thread.
	Hungarian: tsh.
----------------------------------------------------------------------------------------------*/
class TsStrHolder
{
