...
public:
	...
	STDMETHOD(CollapseToMark)(int hMark, BSTR bstrUndo, BSTR bstrRedo);
...
protected:
	...
	HRESULT CallUndo(UndoResult * pures, bool & fRedoable, bool fForDataChange, bool fNeedsRefresh);
	HRESULT CallRedo(UndoResult * pures, bool fForDataChange, bool fNeedsRefresh, int iSeqToRedo,
		int iLastRedoAct);
