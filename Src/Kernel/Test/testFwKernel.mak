...
UI=$(UNITPP_INC);$(FWKERNELTEST_SRC);$(FWKERNEL_SRC);$(GENERIC_SRC);$(APPCORE_SRC)
...
OBJ_KERNELTESTSUITE=\
	...
	$(BUILD_ROOT)\Obj\$(BUILD_CONFIG)\FwKernel\autopch\ModuleEntry.obj\
...
$(FWKERNELTEST_SRC)\Collection.cpp: $(FWKERNELTEST_SRC)\testFwKernel.h\
 $(FWKERNELTEST_SRC)\TestTsStreamWrapper.h\
