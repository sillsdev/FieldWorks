...
public:
	...
	STDMETHOD(VwEnv::AddProp)(int tag, IVwViewConstructor * pvwvc, int frag);
	...
	STDMETHOD(AddGenDateProp)(int tag);
	...
	STDMETHOD(AddSimpleRect)(COLORREF rgb, int dmpWidth, int dmpHeight, int dmpBaselineOffset);
	...
	static void GenDateToTsString(int gdat, ISilDataAccess * psda, ITsString ** pptss);
