...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP VwBaseVc::DisplayVariant(IVwEnv * pvwenv, int tag, VARIANT v, int frag,
	ITsString ** pptss)
{
	Assert(false);
	return E_NOTIMPL;
...
----------------------------------------------------------------------------------------------*/
STDMETHODIMP VwBaseVc::DoHotLinkAction(BSTR bstrData, HVO hvoOwner, PropTag tag,
