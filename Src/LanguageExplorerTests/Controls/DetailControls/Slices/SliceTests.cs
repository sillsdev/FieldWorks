	...
	public class SliceTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		private static ArrayList GeneratePath()
		{
			...
			var path = new ArrayList(7)
			{
				...
				TestUtilities.CreateXmlElementFromOuterXmlOf("<slice field=\"Form\" label=\"Form\" editor=\"multistring\" ws=\"all vernacular\" weight=\"light\" menu=\"mnuDataTree-LexemeForm\" contextMenu=\"mnuDataTree-LexemeFormContext\" spell=\"no\"><properties><bold value=\"on\" /><fontsize value=\"120%\" /></properties></slice>")
			};
			return path;
		}
		...
		public void CreateIndentedNodes_basic()
		{
			...
			// Data taken from a running Sena 3
			var node = TestUtilities.CreateXmlElementFromOuterXmlOf("<slice field=\"Form\" label=\"Form\" editor=\"multistring\" ws=\"all vernacular\" weight=\"light\" menu=\"mnuDataTree-LexemeForm\" contextMenu=\"mnuDataTree-LexemeFormContext\" spell=\"no\"><properties><bold value=\"on\" /><fontsize value=\"120%\" /></properties></slice>");
