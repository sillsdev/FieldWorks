...
namespace LanguageExplorerTests.Controls.DetailControls
{
	...
	public class InterlinearExporterTestsBase : InterlinearTestBase
	{
		...
		{
			return LoadTestText(Path.Combine(FwDirectoryFinder.SourceDirectory, TestUtilities.LanguageExplorerTests, "Controls", "DetailControls", "InterlinearExporterTests.xml"), 1, new XmlDocument());
		}
