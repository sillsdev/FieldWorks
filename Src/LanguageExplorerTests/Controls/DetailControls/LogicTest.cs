...
namespace LanguageExplorerTests.Controls.DetailControls
{
	...
	/// </summary>
	[TestFixture]
	internal class LogicTest : InMemoryDiscourseTestBase
	{
		...
		/// </summary>
		private sealed class NotifyChangeSpy : IVwNotifyChange, IDisposable
		{
			private ISilDataAccess m_sda;
			private List<NotifyChangeInfo> m_calls = new List<NotifyChangeInfo>();

			internal NotifyChangeSpy(ISilDataAccess sda)
			{
				m_sda = sda;
			}
