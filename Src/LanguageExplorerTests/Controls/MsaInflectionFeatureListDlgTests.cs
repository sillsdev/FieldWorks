...
namespace LanguageExplorerTests.Controls
{
	...
	public class MsaInflectionFeatureListDlgTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		private ILangProject CreateFeatureSystem(out IFsFeatStruc featStruct)
		{
			...
			string sFile = Path.Combine(FwDirectoryFinder.SourceDirectory, "LanguageExplorerTests", "Controls", "FeatureSystem2.xml");
		...
		public void PopulateTreeFromFeatureSystem()
		{
			...
			string dir = Path.Combine(FwDirectoryFinder.SourceDirectory, "LanguageExplorerTests", "Controls");
			// Set up the xml fs description
			XmlDocument doc = new XmlDocument();
