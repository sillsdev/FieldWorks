...
namespace LanguageExplorerTests.Interlinear
{
	class BIRDFormatImportTests : MemoryOnlyBackendProviderTestBase
	{
		...
		private static string FlexTextPathname
		{
			get
			{
				return Path.Combine(FwDirectoryFinder.SourceDirectory, @"LanguageExplorerTests", @"Interlinear", @"FlexTextImport", @"FlexTextExportOutput.flextext");
			}
		}
		...
		public void ImportParatextExportBasic()
		{
			...
			using (var fileStream = new FileStream(file, FileMode.Open, FileAccess.Read))
			{
				...
				SIL.FieldWorks.FDO.IText text = null;
		...
		public void TestImportTwiceWithoutMerge()
		{
			...
			SIL.FieldWorks.FDO.IText firstText = null;
			SIL.FieldWorks.FDO.IText secondText = null;
		...
		private static void VerifyMediaLink(SIL.FieldWorks.FDO.IText imported)
		{
