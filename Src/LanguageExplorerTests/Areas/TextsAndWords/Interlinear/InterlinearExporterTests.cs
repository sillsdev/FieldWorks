...
namespace LanguageExplorerTests.Areas.TextsAndWords.Interlinear
{
	...
	public class InterlinearExporterTestsBase : InterlinearTestBase
	{
		...
		{
			return LoadTestText(Path.Combine(FwDirectoryFinder.SourceDirectory, "LanguageExplorerTests", "Areas", "TextsAndWords", "Interlinear", "InterlinearExporterTests.xml"), 1, m_textsDefn);
		}
