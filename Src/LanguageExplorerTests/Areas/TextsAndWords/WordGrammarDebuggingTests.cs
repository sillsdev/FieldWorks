...
namespace LanguageExplorerTests.Areas.TextsAndWords
{
	...
	public class WordGrammarDebuggingTests
	{
		...
		/// <summary />
		private string m_sResultTransform;
		/// <summary />
		private string m_sResultTransformNoCompoundRules;
		/// <summary />
		...
		private void SetUpUnificationViaXsltTransform()
		{
			...
			var sUnificationViaXsltTransform = Path.Combine(_baseTestPath, "TestUnificationViaXSLT.xsl");
		...
		{
			var sSameSlotTwiceTransform = Path.Combine(m_sTestPath, @"TLPSameSlotTwiceWordGrammarDebugger.xsl");
		...
		private void CreateResultTransform(string fxtDumpFile, out string resultTransform)
		{
			...
			var fxtDump = Path.Combine(m_sTestPath, fxtDumpFile);
		...
		{
			var sInput = Path.Combine(m_sTestPath, sInputFile);
			m_doc = new XPathDocument(sInput);
			var sOutput = FileUtils.GetTempFile("xml");
		...
		/// <summary>
		/// Verifies that the result XML file is identical to the expected XML file.
		/// </summary>
		...
		private static void CheckXmlEquals(string sExpectedResultFile, string sActualResultFile)
		{
			...
			var xeActual = XElement.Parse(sActual, LoadOptions.None);
			var xeExpected = XElement.Parse(sExpected, LoadOptions.None);
			var ok = XmlHelper.EqualXml(xeExpected, xeActual, sb);
		...
		public void StemEqualsDerivPfxStem()
		{
			...
			ApplyTransform("nixobiliraStep01BadFromInflClass.xml", "nixobiliraStep02BadFromInflClass.xml");
			ApplyTransform("nixobiliraStep01BadFromCatBadFromInflClass.xml", "nixobiliraStep02BadFromCatBadFromInflClass.xml");
			...
			ApplyTransform("niyuxobilitikoStep02aBadFromCat.xml", "niyuxobilitikoStep03aBadFromCat.xml");
			ApplyTransform("niyuxobilitikoStep02aBadFromInflClass.xml", "niyuxobilitikoStep03aBadFromInflClass.xml");
			ApplyTransform("niyuxobilitikoStep02aBadFromCatBadFromInflClass.xml", "niyuxobilitikoStep03aBadFromCatBadFromInflClass.xml");
		}
		...
		public void StemEqualsStemDerivSfx()
		{
			...
			ApplyTransform("nihimbilitikoStep01BadFromCat.xml", "nihimbilitikoStep02BadFromCat.xml");
			ApplyTransform("nihimbilitikoStep01BadFromInflClass.xml", "nihimbilitikoStep02BadFromInflClass.xml");
			ApplyTransform("nihimbilitikoStep01BadFromCatBadFromInflClass.xml", "nihimbilitikoStep02BadFromCatBadFromInflClass.xml");
			// niyuxobilitiko (one derivational prefix, one derivational suffix)
			// N.B. the stem = stem derivSfx applies first
			ApplyTransform("niyuxobilitikoStep01.xml", "niyuxobilitikoStep02.xml");
			ApplyTransform("niyuxobilitikoStep01BadFromCat.xml", "niyuxobilitikoStep02BadFromCat.xml");
			ApplyTransform("niyuxobilitikoStep01BadFromInflClass.xml", "niyuxobilitikoStep02BadFromInflClass.xml");
			ApplyTransform("niyuxobilitikoStep01BadFromCatBadFromInflClass.xml", "niyuxobilitikoStep02BadFromCatBadFromInflClass.xml");
		}
		...
		public void FullEqualsStem()
		{
			...
			ApplyTransform("nihimbiliguStep01BadInflectionClass.xml", "nihimbiliguStep02BadInflectionClass.xml");
			...
			ApplyTransform("nihimbiliraBadInflectionClassInTenseStep01.xml", "nihimbiliraBadInflectionClassInTenseStep02.xml");
			ApplyTransform("nihimbiliraBadInflectionClassesInTenseStep01.xml", "nihimbiliraBadInflectionClassesInTenseStep02.xml");
		...
		public void PartialEqualsFull()
		{
			...
			ApplyTransform("kasakesPartialCatUnclassCatStep02.xml", "kasakesPartialCatUnclassCatStep03.xml");
		...
		{
			ApplyTransform("nihinlikximuraNoCompoundRulesStep00.xml", "nihinlikximuraNoCompoundRulesStep01.xml", m_resultTransformNoCompoundRules);
			ApplyTransform("nihinxolikximukestiraNoCompoundRulesStep00.xml", "nihinxolikximukestiraNoCompoundRulesStep01.xml", m_resultTransformNoCompoundRules);
		}
		...
		{
			ApplyTransform("TestFeatureStructureUnification.xml", "TestFeatureStructureUnification.xml", m_UnificationViaXsltTransform);
		}
	}
}