...
namespace LanguageExplorerTests.XMLViews
{
	...
	public class LayoutMergerTests
	{
		...
		public void Setup()
		{
			...
			m_testPathMerge = Path.Combine(FwDirectoryFinder.SourceDirectory, "LanguageExplorerTests", "XMLViews", "LayoutMergerTestData");
		...
		public void TestMergeCustomCopy()
		{
			...
			{
				Path.Combine(FwDirectoryFinder.SourceDirectory, "LanguageExplorerTests", "XMLViews", "LayoutMergerTestData", "My_Stem-based_LexEntry_Layouts.xml")
			};
