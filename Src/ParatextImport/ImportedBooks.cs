...
namespace ParatextImport
{
	...
	public class ImportedBooks
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		internal static void SaveImportedBooks(LcmCache cache, IScrDraft importedVersion, IScrDraft backupSavedVersion,
			Dictionary<int, bool>.KeyCollection booksImported, Form wnd)
		{
			...
			IWin32Window owner, string sDetails)
		{
			...
			MessageBox.Show(owner, sMsg, Resources.kstidDataLossCaption, MessageBoxButtons.OK, MessageBoxIcon.None,
		...
		internal static string GetBookInfo(IScrBook book)
		{
			...
			if (verseMin != null) return ReferenceRangeStr(verseMin, verseMax);
