...
namespace SIL.FieldWorks.Common.FwUtils
{
	...
	public class MeasurementUtilsTests
	{
		...
		{
			Assert.AreEqual(2000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("2 pt", MsrSysType.Mm, -1)));
		}
		...
		{
			Assert.AreEqual(255118, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("9 cm", MsrSysType.Point, -1)));
		}
		...
		{
			Assert.AreEqual(230400, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("3.2\"", MsrSysType.Point, -1)));
			Assert.AreEqual(3600, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("0.05 in", MsrSysType.Point, -1)));
		}
		...
		{
			Assert.AreEqual(288000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("101.6 mm", MsrSysType.Point, -1)));
		}
		...
		{
			Assert.AreEqual(-28346, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("-28.346 pt", MsrSysType.Inch, -1)));
		}
		...
		{
			Assert.AreEqual(-230400, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("-3.2\"", MsrSysType.Point, -1)));
			Assert.AreEqual(-230400, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("-3.2 in", MsrSysType.Point, -1)));
		}
		...
		{
			Assert.AreEqual(288000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("101.6mm", MsrSysType.Point, -1)));
			Assert.AreEqual(255118, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints(" 9 cm", MsrSysType.Point, -1)));
			Assert.AreEqual(144000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("2 in ", MsrSysType.Point, -1)));
		}
		...
		{
			Assert.AreEqual(2000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("2", MsrSysType.Point, -1)));
			Assert.AreEqual(288000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("101.6", MsrSysType.Mm, -1)));
			Assert.AreEqual(255118, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("9", MsrSysType.Cm, -1)));
			Assert.AreEqual(144000, (int)Math.Round(MeasurementUtils.ExtractMeasurementInMillipoints("2", MsrSysType.Inch, -1)));
		}
		...
		{
			// double negative
			Assert.AreEqual(999, MeasurementUtils.ExtractMeasurementInMillipoints("--4\"", MsrSysType.Point, 999));
		}
		...
		{
			// bogus units
			Assert.AreEqual(999, MeasurementUtils.ExtractMeasurementInMillipoints("4.5 mc", MsrSysType.Point, 999));
		}
		...
		public void ExtractMeasurement_Bogus_WrongDecimalPointSymbol()
		{
			...
			Assert.AreEqual(999, MeasurementUtils.ExtractMeasurementInMillipoints("4>4", MsrSysType.Point, 999));
		}
		...
		public void ExtractMeasurement_Bogus_TooManyDecimalPointSymbols()
		{
			...
			Assert.AreEqual(999, MeasurementUtils.ExtractMeasurementInMillipoints("4.0.1", MsrSysType.Point, 999));
		}
		...
		{
			// internal space
			Assert.AreEqual(999, MeasurementUtils.ExtractMeasurementInMillipoints("4 1", MsrSysType.Point, 999));
		}
		#endregion
	}
}