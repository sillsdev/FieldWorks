...
UI=$(LANG_SRC);$(GENERIC_SRC);$(APPCORE_SRC);$(TEXT_SRC)

KERNEL_SRC=$(BUILD_ROOT)\src\Kernel
DBACCESS_SRC=$(BUILD_ROOT)\src\DbAccess
UI=$(UI);$(KERNEL_SRC);$(DBACCESS_SRC)
...
OBJ_LANGSERV=\
	$(INT_DIR)\autopch\LgWritingSystem.obj\
	$(INT_DIR)\autopch\LgCollation.obj\
...
OBJ_LANMODEL=\
	...
	$(INT_DIR)\autopch\TsStringPlus.obj\
	$(INT_DIR)\autopch\LangDef.obj\
	$(INT_DIR)\usepch\TextProps1.obj\
	$(INT_DIR)\autopch\FwXml.obj\

OBJ_LANG=\
	$(INT_DIR)\autopch\RegexMatcherWrapper.obj\
	$(INT_DIR)\genpch\LgIcuLocking.obj\
	...
	$(INT_DIR)\autopch\LgWritingSystemFactory.obj\
	...
	$(INT_DIR)\autopch\FwStyledText.obj\
	$(INT_DIR)\autopch\WriteXml.obj\
	$(INT_DIR)\autopch\LgTsDataObject.obj\
	$(INT_DIR)\autopch\LgTsStringPlus.obj\
	$(INT_DIR)\autopch\LangDef.obj\
	$(INT_DIR)\usepch\TextProps1.obj\
	$(INT_DIR)\autopch\FwXml.obj\
...
OBJ_ALL= $(OBJ_LANG) $(OBJ_LANGSERV) $(OBJ_GRUTIL)
