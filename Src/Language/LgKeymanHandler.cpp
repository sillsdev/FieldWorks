...
static GenericFactory g_fact(
	L"SIL.Language.LgKeymanHandler",
	&CLSID_LgKeymanHandler,
	L"SIL simple numeric converter engine",
	L"Apartment",
...
STDMETHODIMP LgKeymanHandler::Init(ComBool fForce)
{
	...
	if (!pGetActiveKeymanID)
	{
		...
		// This correctly handles keyman 5,6, and 7. Probably something different again for Keyman 8....
...
template Vector<KEYBOARDINFO>;
template Vector<KbdInfo>; // VecKbdInfo;
