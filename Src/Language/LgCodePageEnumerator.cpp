...
static GenericFactory g_fact(
	_T("SIL.Language1.LgCodePageEnumerator"),
...
#else
	// TODO-Linux FWNX-114: implement windows code page support on Linux
#endif
...
static GenericFactory g_factLang(
	_T("SIL.Language1.LgLanguageEnumerator"),
...
STDMETHODIMP LgLanguageEnumerator::Init()
{
	...
	m_iLangId = 0;
	// GetLanguageList might return 0 languages, e.g. when run from Hudson CI machine where
	// the tests are run with Local System account.
	return qProfiles->GetLanguageList(&m_prgLangIds, &m_ulCount);
#else
	// TODO-Linux: need to be able to port this. to some Linux equivelent
#endif
