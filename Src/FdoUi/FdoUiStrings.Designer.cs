...
namespace SIL.FieldWorks.FdoUi {
	...
	internal class FdoUiStrings {
		...
		/// <summary>
		///   Looks up a localized string similar to Don&apos;t know how to move this object to a new copy of its owner..
		/// </summary>
		...
		/// <summary>
		///   Looks up a localized string similar to Sorry, no semantic domains are listed for the any of senses of that entry, and no lexical relations (or cross references) include that entry or any of its senses.
