...
namespace SIL.FieldWorks.FdoUi
{
	...
	public class SummaryDialogForm : Form, IFWDisposable
	{
		...
		private int m_flidDummy = 0;
		private int m_hvoSelected = 0;		// object selected in the view.
		...
		private const string s_helpTopicKey = "khtpDictionaryEntry";
		...
		public SummaryDialogForm(List<int> rghvo, ITsString tssForm, IHelpTopicProvider helpProvider,
			string helpFileKey, IVwStylesheet styleSheet, FdoCache cache, XCore.Mediator mediator)
		{
			InitializeComponent();
			...
			IVwStylesheet styleSheet)
		{
			...
			else
			{
				...
				this.helpProvider.HelpNamespace = DirectoryFinder.FWCodeDirectory + m_helpProvider.GetHelpString("UserHelpFile", 0);
				this.helpProvider.SetHelpKeyword(this, m_helpProvider.GetHelpString(s_helpTopicKey, 0));
			...
			m_xv.VwSelectionChanged += new EventHandler<VwSelectionArgs>(m_xv_VwSelectionChanged);
		}
