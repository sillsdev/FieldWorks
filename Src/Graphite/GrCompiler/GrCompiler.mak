...
# Need a custom target for main.cpp, otherwise $(GENERIC_SRC)\main.cpp gets picked up
$(INT_DIR)\autopch\main.obj: $(GRC_SRC)\main.cpp
	$(DISPLAY) Compiling $(GRC_SRC)\main.cpp
	$(CL) /c /Fo"$(INT_DIR)\autopch/" /Fp"$(INT_DIR)\$(PCHNAME).pch" $(CL_OPTS) $(DEFS) $(GRC_SRC)\main.cpp
