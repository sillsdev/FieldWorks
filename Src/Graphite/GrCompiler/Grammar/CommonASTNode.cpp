...
void CommonASTNode::initialize(int t,const std::string& txt)
{ setType(t); setText(txt); }

void CommonASTNode::initialize(const AST* t)
{
...
ASTNode* CommonASTNode::factory()
{ return new CommonASTNode; }
