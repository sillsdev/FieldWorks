...
static const wchar_t szSpace[5] = L" \t\r\n"; // whitespace characters
...
template <> StrBase<utf16>::StrBuffer StrBase<utf16>::s_bufEmpty = StrBase<utf16>::StrBuffer(); // Instantiation of empty utf16 buffer.

//:Associate with StrBase<schar>.
template <> StrBase<schar>::StrBuffer StrBase<schar>::s_bufEmpty = StrBase<schar>::StrBuffer(); // Instantiation of empty schar buffer.
...
static const utf16 kchMinUpper1 = 0x0061;
static const utf16 kchLimUpper1 = 0x0293;

static const utf16 g_mpchchUpper1[kchLimUpper1 - kchMinUpper1] =
{
...
static const utf16 kchMinUpper2 = 0x03ac;
static const utf16 kchLimUpper2 = 0x0587;

static const utf16 g_mpchchUpper2[kchLimUpper2 - kchMinUpper2] =
{
...
static const utf16 kchMinUpper3 = 0x1e01;
static const utf16 kchLimUpper3 = 0x1ff4;

static const utf16 g_mpchchUpper3[kchLimUpper3 - kchMinUpper3] =
{
...
static const utf16 kchMinUpper4 = 0x2170;
static const utf16 kchLimUpper4 = 0x2180;
static const utf16 kdchUpper4 = (utf16)-16;


static const utf16 kchMinUpper5 = 0x24d0;
static const utf16 kchLimUpper5 = 0x24ea;
static const utf16 kdchUpper5 = (utf16)-26;


static const utf16 kchMinUpper6 = 0xff41;
static const utf16 kchLimUpper6 = 0xff5b;
static const utf16 kdchUpper6 = (utf16)-32;
...
utf16 ToUpper(utf16 ch)
{
	...
	else if (ch < kchMinUpper6)
	{
		...
		{
			if (ch >= kchMinUpper5)
				return (utf16)(ch + kdchUpper5);
		}
	}
	else if (ch < kchLimUpper6)
		return (utf16)(ch + kdchUpper6);
...
static const utf16 kchMinLower1 = 0x0041;
static const utf16 kchLimLower1 = 0x0217;

static const utf16 g_mpchchLower1[kchLimLower1 - kchMinLower1] =
{
...
static const utf16 kchMinLower2 = 0x0386;
static const utf16 kchLimLower2 = 0x0557;

static const utf16 g_mpchchLower2[kchLimLower2 - kchMinLower2] =
{
...
static const utf16 kchMinLower3 = 0x10a0;
static const utf16 kchLimLower3 = 0x10c6;
static const utf16 kdchLower3 = 48;


static const utf16 kchMinLower4 = 0x1e00;
static const utf16 kchLimLower4 = 0x1ffd;

static const utf16 g_mpchchLower4[kchLimLower4 - kchMinLower4] =
{
...
static const utf16 kchMinLower5 = 0x2160;
static const utf16 kchLimLower5 = 0x2170;
static const utf16 kdchLower5 = 16;


static const utf16 kchMinLower6 = 0x24b6;
static const utf16 kchLimLower6 = 0x24d0;
static const utf16 kdchLower6 = 26;


static const utf16 kchMinLower7 = 0xff21;
static const utf16 kchLimLower7 = 0xff3b;
static const utf16 kdchLower7 = 32;
...
utf16 ToLower(utf16 ch)
{
	...
	else if (ch < kchLimLower6)
	{
		...
		{
			if (ch >= kchMinLower5)
				return (utf16)(ch + kdchLower5);
		}
		else if (ch >= kchMinLower6)
			return (utf16)(ch + kdchLower6);
	}
	else if (ch < kchLimLower7)
	{
		if (ch >= kchMinLower7)
			return (utf16)(ch + kdchLower7);
	}
...
{
	for(int i = 0; cszResourceString[i].id; i++)
	{
		if(cszResourceString[i].id == stid)
		{
			*pprgch = cszResourceString[i].pszText;
			*pcch = wcslen(cszResourceString[i].pszText);
			return;
		}
	}
	*pprgch = L"";
