...
namespace LanguageExplorer.DictionaryConfiguration
{
	partial class HeadwordNumbersDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_digitNine = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitEight = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitSeven = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitSix = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitFive = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitFour = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitThree = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitTwo = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitOne = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
			this.m_digitZero = new SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox();
		...
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitNine;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitEight;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitSeven;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitSix;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitFive;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitFour;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitThree;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitTwo;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitOne;
		private SIL.FieldWorks.FwCoreDlgs.Controls.FwTextBox m_digitZero;
	}
}
