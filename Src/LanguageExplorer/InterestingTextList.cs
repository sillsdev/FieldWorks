...
namespace LanguageExplorer
{
	...
	/// </summary>
	/// <remarks>It should be sealed, but cannot be, because sealed classes cannot be Mocked in tests.</remarks>
	public class InterestingTextList : IVwNotifyChange
	{
		...
		internal const string PersistPropertyName = "InterestingScriptureTexts";
		internal const string ExcludeCoreTextPropertyName = "ExcludedCoreTexts";
		/// <summary>
		...
		{
			LanguageExplorerConstants.InterlinearTexts,
			LanguageExplorerConstants.ConcordanceWords,
			LanguageExplorerConstants.OccurrencesOfSelectedUnit,
			LanguageExplorerConstants.ComplexConcOccurrencesOfSelectedUnit
		};
		...
		/// <summary />
		/// <remarks>Must be public, in order for the class to be mocked in tests.</remarks>
		public InterestingTextList(IPropertyTable propertyTable, ITextRepository repo, IStTextRepository stTextRepo, bool includeScripture = true)
		{
		...
		internal bool IncludeScripture { get; private set; }
		...
		/// </summary>
		internal bool AllCoreTextsAreIncluded => ExcludedCoreTextIdList().Count == 0;
		...
		/// </summary>
		internal IEnumerable<IStText> AllCoreTexts => m_textRepository.AllInstances().Where(text => text.ContentsOA != null).Select(text => text.ContentsOA);
		...
		/// Virtual for testing
		/// </summary>
		/// <remarks>Must be public and virtual, in order for the class to be mocked in tests.</remarks>
		...
		/// </summary>
		internal IEnumerable<IStText> ScriptureTexts => m_scriptureTexts.ToArray();

		internal event EventHandler<InterestingTextsChangedArgs> InterestingTextsChanged;
		...
		/// </summary>
		internal static string MakeIdList(IEnumerable<ICmObject> objects)
		{
		...
		/// </summary>
		internal static string MakeIdList(IEnumerable<Guid> objects)
		{
		...
		/// </summary>
		internal void SetInterestingTexts(IEnumerable<IStText> stTexts)
		{
		...
		/// </summary>
		internal static void SetScriptureTextsInPropertyTable(IPropertyTable propertyTable, IEnumerable<IStText> texts)
		{
		...
		/// </summary>
		internal bool AddChapterToInterestingTexts(IStText newText)
		{
