...
namespace LanguageExplorer.UtilityTools
{
	...
	internal sealed class DuplicateAnalysisFixer : IUtility
	{
		...
		/// <summary />
		public string Label => LanguageExplorerResources.ksMergeDuplicateAnalyses;
		...
		{
			m_dlg.WhenDescription = LanguageExplorerResources.ksUseMergeAnalysesWhen;
			m_dlg.WhatDescription = LanguageExplorerResources.ksMergeAnalysesAttemptsTo;
			m_dlg.RedoDescription = LanguageExplorerResources.ksMergeAnalysesWarning;
		}
