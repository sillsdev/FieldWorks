...
namespace LanguageExplorer
{
	...
	/// </summary>
	internal sealed class MeasurementUtils
	{
		...
		/// string
		/// </returns>
		internal static double ExtractMeasurementInMillipoints(string str, MsrSysType defaultUnits, double defaultValue)
		{
			try
			{
				int ichMsr;
		...
		internal static double GetMpPerUnitFactor(MsrSysType msrType)
		{
			switch (msrType)
			{
		...
		private static string GetMeasurementUnitsAbbrev(MsrSysType msrType)
		{
			switch (msrType)
			{
		...
		internal static string FormatMeasurement(double mptValue, MsrSysType msrType)
		{
		...
		/// <returns>A formatted (localized) string representing the given number of millipoints
		/// in the requested units</returns>
		internal static string FormatMeasurement(double mptValue, MsrSysType msrType, bool fUseVariablePrecision)
		{
			var sFormat = "##########0.##";
		...
		/// <returns>A formatted (localized) string representing the given number of millipoints
		/// in the requested units</returns>
		private static string FormatMeasurement(double mptValue, MsrSysType msrType, string sFormat)
		{
