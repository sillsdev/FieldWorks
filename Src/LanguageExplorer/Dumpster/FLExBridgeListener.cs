...
namespace LanguageExplorer.Dumpster
{
	...
	internal sealed class FLExBridgeListener : IFlexComponent, IFWDisposable
	{
		...
		public bool OnObtainLiftProject(object commandObject)
		{
			...
			{
				MessageBox.Show(PropertyTable.GetValue<IFlexApp>("App").ActiveMainWindow, LanguageExplorerResources.kProjectAlreadyHasLiftRepo, LanguageExplorerResources.kCannotDoGetAndMergeAgain, MessageBoxButtons.OK);
				return true;
			}
		...
		public bool OnFLExBridge(object commandObject)
		{
			...
			{
				using (var dlg = new WarningNotUsingDefaultLinkedFilesLocation(PropertyTable.GetValue<IHelpTopicProvider>("HelpTopicProvider")))
				{
			...
			{
				if (ThreadHelper.ShowMessageBox(null, LanguageExplorerResources.ksSendReceiveNotPermittedMultipleAppsText,
					LanguageExplorerResources.ksSendReceiveNotPermittedMultipleAppsCaption, MessageBoxButtons.RetryCancel, MessageBoxIcon.Warning) == DialogResult.Cancel)
				{
					return true;
				}
			}
		...
		public bool OnLiftBridge(object argument)
		{
			...
			{
				MessageBox.Show(_parentForm, LanguageExplorerResources.FLExBridgeListener_UndoExport_Error_exporting_LIFT, LanguageExplorerResources.FLExBridgeListener_UndoExport_LIFT_Export_failed_Title,
