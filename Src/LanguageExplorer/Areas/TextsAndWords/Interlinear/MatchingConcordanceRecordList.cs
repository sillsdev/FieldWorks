...
namespace LanguageExplorer.Areas.TextsAndWords.Interlinear
{
	...
	internal class MatchingConcordanceRecordList : InterlinearTextsRecordList
	{
		...
		public MatchingConcordanceRecordList(string id, StatusBar statusBar, ConcDecorator decorator)
			: base(id, statusBar, decorator, false, new VectorPropertyParameterObject(decorator.PropertyTable.GetValue<LcmCache>(FwUtilsConstants.cache).LanguageProject, TextAndWordsArea.ConcOccurrences, decorator.MetaDataCache.GetFieldId2(LangProjectTags.kClassId, TextAndWordsArea.ConcOccurrences, false)))
		{
		}
