...
namespace LanguageExplorer.Areas.TextsAndWords.Tools
{
	...
	{
		private const string s_helpTopic = "khtpComplexConcMorphDlg";
		...
		public void SetDlgInfo(LcmCache cache, FlexComponentParameters flexComponentParameters, ComplexConcMorphNode node)
		{
			m_cache = cache;
			m_node = node;
			...
			m_catPopupTreeManager = new PossibilityComboController(m_categoryComboBox, m_cache, m_cache.LanguageProject.PartsOfSpeechOA, m_cache.ServiceLocator.WritingSystems.DefaultAnalysisWritingSystem.Handle,
									false, flexComponentParameters, propertyTable.GetValue<Form>(FwUtilsConstants.window));
		...
		private static void UpdateTextBoxWs(ComboBox wsComboBox, FwTextBox textBox)
		{
