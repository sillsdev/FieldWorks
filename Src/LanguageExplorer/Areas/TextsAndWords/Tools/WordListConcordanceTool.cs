...
namespace LanguageExplorer.Areas.TextsAndWords.Tools
{
	...
	internal sealed class WordListConcordanceTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			root.Element("wordOccurrenceListUpper").Element("parameters").Element("includeColumns").ReplaceWith(XElement.Parse(AreaResources.ConcordanceColumns).Element("columns"));
		...
		private sealed class SubservientConcordanceRecordList : SubservientRecordList
		{
