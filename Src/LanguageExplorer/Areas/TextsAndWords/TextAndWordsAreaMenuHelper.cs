...
DONE:					<item command="CmdImportWordSet" defaultVisible="false"/>
		...
		{
			using (var dlg = new ImportWordSetDlg(_majorFlexComponentParameters.LcmCache, _majorFlexComponentParameters.FlexApp, RecordClerk.ActiveRecordClerkRepository.ActiveRecordClerk, _majorFlexComponentParameters.ParserMenuManager))
			{
