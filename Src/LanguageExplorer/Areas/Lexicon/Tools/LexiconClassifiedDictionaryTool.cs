...
namespace LanguageExplorer.Areas.Lexicon.Tools
{
	...
	internal sealed class LexiconClassifiedDictionaryTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			var xmlDocView = new XmlDocView(XDocument.Parse(LanguageExplorerResources.LexiconClassifiedDictionaryParameters).Root, majorFlexComponentParameters.LcmCache, _recordList, majorFlexComponentParameters.UiWidgetController, LanguageExplorerResources.Classified_Dictionary);
		...
		public string MachineName => LanguageExplorerConstants.LexiconClassifiedDictionaryMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.LexiconClassifiedDictionaryUiName);
