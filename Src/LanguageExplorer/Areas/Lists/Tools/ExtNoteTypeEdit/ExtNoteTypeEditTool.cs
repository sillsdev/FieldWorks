...
namespace LanguageExplorer.Areas.Lists.Tools.ExtNoteTypeEdit
{
	...
	internal sealed class ExtNoteTypeEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new ExtNoteTypeMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.LexDbOA.ExtendedNoteTypesOA;
		#endregion
		...
		{
			Require.That(recordListId == ExtendedNoteTypes, $"I don't know how to create a record list with an ID of '{recordListId}', as I can only create one with an id of '{ExtendedNoteTypes}'.");
			/*
