...
namespace LanguageExplorer.Areas.Lists.Tools.ExtNoteTypeEdit
{
	...
	internal sealed class ExtNoteTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			if (_recordList == null)
			{
				_recordList = majorFlexComponentParameters.FlexComponentParameters.PropertyTable.GetValue<IRecordListRepositoryForTools>("RecordListRepository").GetRecordList(ExtendedNoteTypes, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
