...
namespace LanguageExplorer.Areas.Lists.Tools.RoleEdit
{
	...
	internal sealed class RoleEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(RoleList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == RoleList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{RoleList}'.");
