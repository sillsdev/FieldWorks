...
namespace LanguageExplorer.Areas.Lists.Tools.RoleEdit
{
	...
	internal sealed class RoleEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(RoleList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
		...
		public string MachineName => "roleEdit";
		...
		{
			Require.That(clerkId == RoleList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{RoleList}'.");

			return new RecordClerk(clerkId,
				statusBar,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.RolesOA),
