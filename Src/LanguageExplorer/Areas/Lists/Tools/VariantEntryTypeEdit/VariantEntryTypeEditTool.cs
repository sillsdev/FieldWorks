...
namespace LanguageExplorer.Areas.Lists.Tools.VariantEntryTypeEdit
{
	...
	internal sealed class VariantEntryTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(VariantEntryTypeList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == VariantEntryTypeList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{VariantEntryTypeList}'.");
