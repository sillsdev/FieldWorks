	...
	internal sealed class RestrictionsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				MachineName,
				new PossibilityListClerkParameters("RestrictionsList", majorFlexComponentParameters.LcmCache.LanguageProject.RestrictionsOA, false, true, false, "best analysis"),
