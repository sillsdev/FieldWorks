...
namespace LanguageExplorer.Areas.Lists.Tools.RestrictionsEdit
{
	...
	internal sealed class RestrictionsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(RestrictionsList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
#if RANDYTODO
		...
		public string MachineName => "restrictionsEdit";
		...
		{
			Require.That(clerkId == RestrictionsList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{RestrictionsList}'.");

			return new RecordClerk(clerkId,
				statusBar,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.RestrictionsOA),
