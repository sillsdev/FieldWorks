...
namespace LanguageExplorer.Areas.Lists.Tools.RestrictionsEdit
{
	...
	internal sealed class RestrictionsEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new RestrictionsMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.RestrictionsOA;
		#endregion
		...
		{
			Require.That(recordListId == RestrictionsList, $"I don't know how to create a record list with an ID of '{recordListId}', as I can only create one with an id of '{RestrictionsList}'.");
			/*
