...
namespace LanguageExplorer.Areas.Lists.Tools.RestrictionsEdit
{
	...
	internal sealed class RestrictionsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(RestrictionsList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == RestrictionsList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{RestrictionsList}'.");
