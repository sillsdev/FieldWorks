	...
	internal sealed class LexRefEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				MachineName,
				new PossibilityListClerkParameters("LexRefTypeList", majorFlexComponentParameters.LcmCache.LanguageProject.LexDbOA.ReferencesOA, false, true, true, "best analysis"),
