...
namespace LanguageExplorer.Areas.Lists.Tools.LexRefEdit
{
	...
	internal sealed class LexRefEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(LexRefTypeList, FactoryMethod);
			}
		...
		public string MachineName => "lexRefEdit";

		/// <summary>
		/// User-visible localizable component name.
		/// </summary>
		public string UiName => "Lexical Relations";
		#endregion
		...
		{
			Guard.AssertThat(clerkId == LexRefTypeList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{LexRefTypeList}'.");

			return new RecordClerk(clerkId,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.LexDbOA.ReferencesOA),
