...
namespace LanguageExplorer.Areas.Lists.Tools.LexRefEdit
{
	/// <summary>
	...
	internal sealed class LexRefEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			if (_recordList == null)
			{
				_recordList = majorFlexComponentParameters.FlexComponentParameters.PropertyTable.GetValue<IRecordListRepositoryForTools>(LanguageExplorerConstants.RecordListRepository).GetRecordList(LexRefTypeList, majorFlexComponentParameters.StatusBar, FactoryMethod);
			}
			...
			_toolMenuHelper = new LexRefEditMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.LexDbOA.ReferencesOA;
		#endregion
		...
		private sealed class LexRefEditMenuHelper : IDisposable
		{
			...
			private void SetupToolUiWidgets(ITool tool)
			{
				...
				toolUiWidgetParameterObject.MenuItemsForTool[MainMenu.Insert].Add(Command.CmdInsertPossibility, new Tuple<EventHandler, Func<Tuple<bool, bool>>>(CmdInsertLexRefType_click, ()=> UiWidgetServices.CanSeeAndDo));
				toolUiWidgetParameterObject.ToolBarItemsForTool[ToolBar.Insert].Add(Command.CmdInsertPossibility, new Tuple<EventHandler, Func<Tuple<bool, bool>>>(CmdInsertLexRefType_click, () => UiWidgetServices.CanSeeAndDo));
				AreaServices.ResetMainPossibilityInsertUiWidgetsText(_majorFlexComponentParameters.UiWidgetController, ListResources.Lexical_Relation);
