...
namespace LanguageExplorer.Areas.Lists.Tools.LocationsEdit
{
	...
	internal sealed class LocationsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(LocationList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
		...
		public string MachineName => "locationsEdit";
		...
		{
			Require.That(clerkId == LocationList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{LocationList}'.");
