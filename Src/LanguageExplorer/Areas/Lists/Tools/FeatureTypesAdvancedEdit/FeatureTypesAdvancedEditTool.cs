...
namespace LanguageExplorer.Areas.Lists.Tools.FeatureTypesAdvancedEdit
{
	...
	internal sealed class FeatureTypesAdvancedEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(FeatureTypes, FactoryMethod);
			}
		...
		public string MachineName => "featureTypesAdvancedEdit";
		...
		{
			Guard.AssertThat(clerkId == FeatureTypes, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{FeatureTypes}'.");

			return new RecordClerk(clerkId,
				new RecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), true, FsFeatureSystemTags.kflidFeatures, cache.LanguageProject.MsFeatureSystemOA, "FeatureTypes"),
