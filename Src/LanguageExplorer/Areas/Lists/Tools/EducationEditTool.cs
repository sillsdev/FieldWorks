...
namespace LanguageExplorer.Areas.Lists.Tools
{
	...
	internal sealed class EducationEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new EducationMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		public string MachineName => LanguageExplorerConstants.EducationEditMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.EducationEditUiName);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.EducationOA;
		#endregion
