...
namespace LanguageExplorer.Areas.Lists.Tools
{
	...
	internal sealed class ComplexEntryTypeEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new ComplexEntryTypeEditMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		public string MachineName => LanguageExplorerConstants.ComplexEntryTypeEditMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.ComplexEntryTypeEditUiName);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.LexDbOA.ComplexEntryTypesOA;
		#endregion
		...
		private sealed class ComplexEntryTypeEditMenuHelper : IDisposable
		{
			...
			private void SetupToolUiWidgets(ITool tool, DataTree dataTree)
			{
				...
				AreaServices.ResetMainPossibilityInsertUiWidgetsText(_majorFlexComponentParameters.UiWidgetController, ListResources.Complex_Form_Type);
			...
			private Tuple<ContextMenuStrip, List<Tuple<ToolStripMenuItem, EventHandler>>> Create_mnuDataTree_SubComplexEntryType(ISlice slice, ContextMenuName contextMenuId)
			{
				Require.That(contextMenuId == ContextMenuName.mnuDataTree_SubComplexEntryType, $"Expected argument value of '{ContextMenuName.mnuDataTree_SubComplexEntryType}', but got '{contextMenuId}' instead.");

				// Start: <menu id="mnuDataTree_SubComplexEntryType">
				var contextMenuStrip = new ContextMenuStrip
				{
					Name = ContextMenuName.mnuDataTree_SubComplexEntryType
				};
