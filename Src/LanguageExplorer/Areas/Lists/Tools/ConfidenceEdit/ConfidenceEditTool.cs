	...
	internal sealed class ConfidenceEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				MachineName,
				new PossibilityListClerkParameters("ConfidenceList", PropertyTable.GetValue<LcmCache>("cache").LanguageProject.ConfidenceLevelsOA, false, true, false, "best analysis"),
				out _recordClerk);
