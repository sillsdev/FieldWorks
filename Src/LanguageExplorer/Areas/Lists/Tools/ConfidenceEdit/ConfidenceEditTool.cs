...
namespace LanguageExplorer.Areas.Lists.Tools.ConfidenceEdit
{
	...
	internal sealed class ConfidenceEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(ConfidenceList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == ConfidenceList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{ConfidenceList}'.");
