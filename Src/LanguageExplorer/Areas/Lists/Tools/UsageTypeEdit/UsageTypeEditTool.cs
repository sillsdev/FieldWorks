	...
	internal sealed class UsageTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				MachineName,
				new PossibilityListClerkParameters("UsageTypeList", majorFlexComponentParameters.LcmCache.LanguageProject.LexDbOA.UsageTypesOA, true, true, false, "best analysis"),
