...
namespace LanguageExplorer.Areas.Lists.Tools.UsageTypeEdit
{
	...
	internal sealed class UsageTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(UsageTypeList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == UsageTypeList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{UsageTypeList}'.");
