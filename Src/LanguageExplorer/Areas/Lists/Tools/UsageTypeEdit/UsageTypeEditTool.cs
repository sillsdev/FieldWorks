...
namespace LanguageExplorer.Areas.Lists.Tools.UsageTypeEdit
{
	...
	internal sealed class UsageTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(UsageTypeList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
		...
		public string MachineName => "usageTypeEdit";
		...
		{
			Require.That(clerkId == UsageTypeList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{UsageTypeList}'.");

			return new RecordClerk(clerkId,
				statusBar,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.LexDbOA.UsageTypesOA),
