...
namespace LanguageExplorer.Areas.Lists.Tools.PositionsEdit
{
	...
	internal sealed class PositionsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(PositionList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == PositionList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{PositionList}'.");
