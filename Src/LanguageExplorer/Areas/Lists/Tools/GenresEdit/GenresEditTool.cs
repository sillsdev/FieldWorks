...
namespace LanguageExplorer.Areas.Lists.Tools.GenresEdit
{
	...
	internal sealed class GenresEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new GenresMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		public string MachineName => LanguageExplorerConstants.GenresEditMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.GenresEditUiName);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.GenreListOA;
		#endregion
