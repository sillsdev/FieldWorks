...
namespace LanguageExplorer.Areas.Lists.Tools.GenresEdit
{
	...
	internal sealed class GenresEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(GenreList, FactoryMethod);
			}
		...
		public string MachineName => "genresEdit";
		...
		{
			Guard.AssertThat(clerkId == GenreList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{GenreList}'.");

			return new RecordClerk(clerkId,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.GenreListOA),
