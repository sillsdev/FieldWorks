...
namespace LanguageExplorer.Areas.Lists.Tools.PeopleEdit
{
	...
	internal sealed class PeopleEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(PeopleList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
		...
		public string MachineName => "peopleEdit";
		...
		{
			Require.That(clerkId == PeopleList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{PeopleList}'.");

			return new RecordClerk(clerkId,
				statusBar,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.PeopleOA),
