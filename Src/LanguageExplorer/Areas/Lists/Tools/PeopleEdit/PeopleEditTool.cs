...
namespace LanguageExplorer.Areas.Lists.Tools.PeopleEdit
{
	...
	internal sealed class PeopleEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(PeopleList, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == PeopleList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{PeopleList}'.");
