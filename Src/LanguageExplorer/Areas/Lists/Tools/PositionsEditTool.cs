...
namespace LanguageExplorer.Areas.Lists.Tools
{
	...
	internal sealed class PositionsEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new PositionsMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.PositionsOA;
		#endregion
		...
		{
			Require.That(recordListId == PositionList, $"I don't know how to create a record list with an ID of '{recordListId}', as I can only create one with an id of '{PositionList}'.");
			/*
