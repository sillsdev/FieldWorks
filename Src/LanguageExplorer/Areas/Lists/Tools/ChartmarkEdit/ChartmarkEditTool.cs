...
namespace LanguageExplorer.Areas.Lists.Tools.ChartmarkEdit
{
	...
	internal sealed class ChartmarkEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new ChartmarkMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.DiscourseDataOA.ChartMarkersOA;
		#endregion
		...
		{
			Require.That(recordListId == DiscChartMarkerList, $"I don't know how to create a record list with an ID of '{recordListId}', as I can only create one with an id of '{DiscChartMarkerList}'.");
			/*
