	...
	internal sealed class TextMarkupTagsEditTool : ITool
	{
			...
			StatusBar statusbar)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(new FlexComponentParameterObject(PropertyTable, Publisher, Subscriber), mainCollapsingSplitContainer, true,
				...
				MachineName,
				new PossibilityListClerkParameterObject("TextMarkupTagsList", PropertyTable.GetValue<FdoCache>("cache").LanguageProject.TextMarkupTagsOA, false, true, false, "best analysis"));
		}
