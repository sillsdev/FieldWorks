...
namespace LanguageExplorer.Areas.Lists.Tools.SenseTypeEdit
{
	...
	internal sealed class SenseTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			if (_recordList == null)
			{
				_recordList = majorFlexComponentParameters.FlexComponentParameters.PropertyTable.GetValue<IRecordListRepositoryForTools>("RecordListRepository").GetRecordList(SenseTypeList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
