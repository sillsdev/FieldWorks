...
namespace LanguageExplorer.Areas.Lists.Tools.MorphTypeEdit
{
	...
	internal sealed class MorphTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			if (_recordList == null)
			{
				_recordList = majorFlexComponentParameters.FlexComponentParameters.PropertyTable.GetValue<IRecordListRepositoryForTools>("RecordListRepository").GetRecordList(MorphTypeList, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
