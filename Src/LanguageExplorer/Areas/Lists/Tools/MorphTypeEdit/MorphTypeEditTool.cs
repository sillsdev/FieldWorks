	...
	internal sealed class MorphTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				MachineName,
				new PossibilityListClerkParameters("MorphTypeList", majorFlexComponentParameters.LcmCache.LanguageProject.LexDbOA.MorphTypesOA, false, false, false, "best analysis"),
