...
namespace LanguageExplorer.Areas.Lists.Tools.MorphTypeEdit
{
	...
	internal sealed class MorphTypeEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(MorphTypeList, FactoryMethod);
			}
		...
		public string MachineName => "morphTypeEdit";
		...
		{
			Guard.AssertThat(clerkId == MorphTypeList, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{MorphTypeList}'.");
