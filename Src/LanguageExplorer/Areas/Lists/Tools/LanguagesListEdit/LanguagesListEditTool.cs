...
namespace LanguageExplorer.Areas.Lists.Tools.LanguagesListEdit
{
	...
	internal sealed class LanguagesListEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new LanguagesListMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		public string MachineName => LanguageExplorerConstants.LanguagesListEditMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.LanguagesListEditUiName);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.LexDbOA.LanguagesOA;
		#endregion
		...
		{
			Require.That(recordListId == LanguagesList, $"I don't know how to create a record list with an ID of '{recordListId}', as I can only create one with an id of '{LanguagesList}'.");
			/*
