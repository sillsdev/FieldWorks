	...
	internal sealed class LanguagesListEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(
				...
				true,
				XDocument.Parse(ListResources.LanguagesListEditParameters).Root, XDocument.Parse(ListResources.ListToolsSliceFilters),
				MachineName,
		...
		private static IRecordList FactoryMethod(LcmCache cache, FlexComponentParameters flexComponentParameters, string recordListId, StatusBar statusBar)
		{
			...
			*/
			return new TreeBarHandlerAwarePossibilityRecordList(recordListId, statusBar,
				...
				cache.LanguageProject.LexDbOA.LanguagesOA,
