...
namespace LanguageExplorer.Areas.Lists.Tools.DialectsListEdit
{
	...
	internal sealed class DialectsListEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new DialectsListMenuHelper(majorFlexComponentParameters, this, majorFlexComponentParameters.LcmCache.LanguageProject.LexDbOA.DialectLabelsOA, _recordList, dataTree);
