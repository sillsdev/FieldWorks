	...
	internal sealed class SemanticDomainEditTool : ITool
	{
			...
			StatusBar statusbar)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(new FlexComponentParameterObject(PropertyTable, Publisher, Subscriber), mainCollapsingSplitContainer, true,
				...
				MachineName,
				new PossibilityListClerkParameterObject("SemanticDomainList", PropertyTable.GetValue<FdoCache>("cache").LanguageProject.SemanticDomainListOA, false, true, true, "best analysis"));
		}
