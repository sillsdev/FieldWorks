...
namespace LanguageExplorer.Areas.Lists.Tools.TimeOfDayEdit
{
	...
	internal sealed class TimeOfDayEditTool : IListTool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			_toolMenuHelper = new TimeOfDayMenuHelper(majorFlexComponentParameters, this, MyList, _recordList, dataTree);
		...
		/// <inheritdoc />
		public ICmPossibilityList MyList => _cache.LanguageProject.TimeOfDayOA;
		#endregion
