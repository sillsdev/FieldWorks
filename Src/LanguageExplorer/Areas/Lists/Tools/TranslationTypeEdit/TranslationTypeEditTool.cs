	...
	internal sealed class TranslationTypeEditTool : ITool
	{
			...
			StatusBar statusbar)
		{
			_collapsingSplitContainer = CollapsingSplitContainerFactory.Create(new FlexComponentParameterObject(PropertyTable, Publisher, Subscriber), mainCollapsingSplitContainer, true,
				...
				MachineName,
				new PossibilityListClerkParameterObject("TranslationTypeList", PropertyTable.GetValue<FdoCache>("cache").LanguageProject.TranslationTagsOA, false, false, false, "best analysis"));
		}
		...
		{
			get { return "translationTypeEdit"; }
		}
