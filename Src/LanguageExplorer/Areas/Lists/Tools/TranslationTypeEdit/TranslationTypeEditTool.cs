...
namespace LanguageExplorer.Areas.Lists.Tools.TranslationTypeEdit
{
	...
	internal sealed class TranslationTypeEditTool : IListTool
	{
		...
		private TranslationTypeMenuHelper _toolMenuHelper;
		...
		private sealed class TranslationTypeMenuHelper : IDisposable
		{
			...
			internal TranslationTypeMenuHelper(MajorFlexComponentParameters majorFlexComponentParameters, ITool tool, ICmPossibilityList list, IRecordList recordList, DataTree dataTree)
			{
