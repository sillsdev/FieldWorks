...
namespace LanguageExplorer.Areas.Lists.Tools.PublicationsEdit
{
	...
	internal sealed class PublicationsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(PublicationsEditParameters, FactoryMethod);
			}
		...
		{
			Guard.AssertThat(clerkId == PublicationsEditParameters, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{PublicationsEditParameters}'.");
