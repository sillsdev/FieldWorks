...
namespace LanguageExplorer.Areas.Lists.Tools.PublicationsEdit
{
	...
	internal sealed class PublicationsEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(PublicationsEditParameters, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
#if RANDYTODO
		...
		public string MachineName => "publicationsEdit";
		...
		{
			Require.That(clerkId == PublicationsEditParameters, $"I don't know how to create a clerk with an ID of '{clerkId}', as I can only create on with an id of '{PublicationsEditParameters}'.");

			return new RecordClerk(clerkId,
				statusBar,
				new PossibilityRecordList(cache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), cache.LanguageProject.LexDbOA.PublicationTypesOA),
