...
namespace LanguageExplorer.Areas.Notebook.Tools
{
	...
	internal sealed class NotebookDocumentTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			var docView = new XmlDocView(XDocument.Parse(LanguageExplorerResources.NotebookDocumentParameters).Root, majorFlexComponentParameters.LcmCache, _recordList, majorFlexComponentParameters.UiWidgetController);
