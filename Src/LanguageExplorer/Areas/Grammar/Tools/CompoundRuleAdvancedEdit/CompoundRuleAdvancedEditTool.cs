...
namespace LanguageExplorer.Areas.Grammar.Tools.CompoundRuleAdvancedEdit
{
	...
	internal sealed class CompoundRuleAdvancedEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = majorFlexComponentParameters.RecordClerkRepositoryForTools.GetRecordClerk(CompoundRules, majorFlexComponentParameters.Statusbar, FactoryMethod);
			}
...
#endif
			var recordEditView = new RecordEditView(root.Element("recordview").Element("parameters"), XDocument.Parse(AreaResources.HideAdvancedListItemFields), majorFlexComponentParameters.LcmCache, _recordClerk, dataTreeMenuHandler);
		...
		public string MachineName => "compoundRuleAdvancedEdit";
