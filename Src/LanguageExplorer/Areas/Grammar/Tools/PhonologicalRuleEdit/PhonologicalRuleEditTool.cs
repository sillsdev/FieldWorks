...
namespace LanguageExplorer.Areas.Grammar.Tools.PhonologicalRuleEdit
{
	...
	internal sealed class PhonologicalRuleEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = new RecordClerk("phonemes", new RecordList(majorFlexComponentParameters.LcmCache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), true, PhPhonDataTags.kflidPhonRules, majorFlexComponentParameters.LcmCache.LanguageProject.PhonologicalDataOA, "PhonologicalRules"), new PropertyRecordSorter("ShortName"), "Default", null, false, false);
