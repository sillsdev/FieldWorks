...
namespace LanguageExplorer.Areas.Grammar.Tools.FeaturesAdvancedEdit
{
	...
	internal sealed class FeaturesAdvancedEditTool : ITool
	{
		...
		public void Activate(MajorFlexComponentParameters majorFlexComponentParameters)
		{
			...
			{
				_recordClerk = new RecordClerk("features", new RecordList(majorFlexComponentParameters.LcmCache.ServiceLocator.GetInstance<ISilDataAccessManaged>(), true, FsFeatureSystemTags.kflidFeatures, majorFlexComponentParameters.LcmCache.LanguageProject.MsFeatureSystemOA, "Features"), new PropertyRecordSorter("ShortName"), "Default", null, false, false);
