...
namespace LanguageExplorer.Areas.Grammar.Tools.FeaturesAdvancedEdit
{
	...
	internal sealed class FeaturesAdvancedEditTool : ITool
	{
		...
		public string MachineName => LanguageExplorerConstants.FeaturesAdvancedEditMachineName;

		/// <summary>
		/// User-visible localized component name.
		/// </summary>
		public string UiName => StringTable.Table.LocalizeLiteralValue(LanguageExplorerConstants.FeaturesAdvancedEditUiName);
		...
		private sealed class FeaturesAdvancedEditToolMenuHelper : IDisposable
		{
			...
			private void CreateBrowseViewContextMenu()
			{
				...
				_menu = ToolStripMenuItemFactory.CreateToolStripMenuItemForContextMenuStrip(menuItems, contextMenuStrip, CmdDeleteSelectedObject_Clicked, string.Format(LanguageExplorerResources.Delete_selected_0, "FsFeatDefn"));
