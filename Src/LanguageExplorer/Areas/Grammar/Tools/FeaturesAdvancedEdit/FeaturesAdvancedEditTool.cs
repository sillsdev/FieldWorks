		...
		private sealed class FeaturesAdvancedEditToolMenuHelper : IDisposable
		{
			...
			private void SetupUiWidgets(ITool tool)
			{
				...
				AreaServices.InsertPair(insertToolBarDictionary, insertMenuDictionary,
					Command.CmdInsertClosedFeature, new Tuple<EventHandler, Func<Tuple<bool, bool>>>(InsertClosedFeature_Clicked, () => AreaServices.CanSeeAndDo));
				AreaServices.InsertPair(insertToolBarDictionary, insertMenuDictionary,
					Command.CmdInsertComplexFeature, new Tuple<EventHandler, Func<Tuple<bool, bool>>>(InsertComplexFeature_Clicked, () => AreaServices.CanSeeAndDo));
