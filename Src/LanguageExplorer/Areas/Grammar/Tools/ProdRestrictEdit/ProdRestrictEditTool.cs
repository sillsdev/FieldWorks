...
#endif
			var recordEditView = new RecordEditView(doc.Root.Element("recordview").Element("parameters"), XDocument.Parse(AreaResources.HideAdvancedListItemFields), _recordClerk);
