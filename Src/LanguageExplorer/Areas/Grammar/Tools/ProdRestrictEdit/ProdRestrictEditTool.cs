	...
	internal sealed class ProdRestrictEditTool : ITool
	{
		...
		private sealed class ProdRestrictEditToolMenuHelper : IDisposable
		{
			...
			private void CreateBrowseViewContextMenu()
			{
				...
				ToolStripMenuItemFactory.CreateToolStripMenuItemForContextMenuStrip(menuItems, contextMenuStrip, CmdDeleteSelectedObject_Clicked, string.Format(AreaResources.Delete_selected_0, StringTable.Table.GetString("ProdRestrict", "PossibilityListItemTypeNames")));
