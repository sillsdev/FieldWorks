...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// to insert an item.
	/// </summary>
	internal sealed class InsertionControl : UserControl
	{
		internal event EventHandler<InsertEventArgs> Insert;
		...
		internal Func<string> NoOptionsMessage { get; set; }
		...
		/// </summary>
		internal void AddOption(object option, Func<object, bool> shouldDisplay)
		{
		...
		/// </summary>
		internal void UpdateOptionsDisplay()
		{
