...
{
	internal sealed class InsertRecordDlg : Form, IFlexComponent
	{
		...
		internal IRnGenericRec NewRecord { get; private set; }
		...
		internal void SetDlgInfo(LcmCache cache, ICmObject owner, ITsString tssTitle = null)
		{
			m_cache = cache;
			m_owner = owner;
