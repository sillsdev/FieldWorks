...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class CachePair : IDisposable
	{
		...
		/// </summary>/returns>
		internal int RealHvo(int secHvo)
		{
		...
		/// </summary>
		internal ICmObject RealObject(int secHvo)
		{
		...
		/// </summary>
		internal void Map(int secHvo, int realHvo)
		{
		...
		/// </summary>
		internal bool RemoveSec(int secHvo)
		{
		...
		/// Removes a two-way mapping.
		/// </summary>
		internal bool RemoveReal(int realHvo)
		{
		...
		/// </summary>
		internal int SecHvo(int realHvo)
		{
		...
		/// </summary>
		internal int FindOrCreateSec(int hvoReal, int clid, int hvoOwner, int flidOwn)
		{
			var hvoSec = 0;
			if (hvoReal != 0)
			{
		...
		/// </summary>
		internal int FindOrCreateSec(int hvoReal, int clid, int hvoOwner, int flidOwn, int flidName, ITsString tss)
		{
		...
		/// Set its flidName property to a string name in writing system ws.
		/// </summary>
		internal int FindOrCreateSec(int hvoReal, int clid, int hvoOwner, int flidOwn, string name, int flidName, int ws)
		{
		...
		/// </summary>
		internal int FindOrCreateSecAnalysis(int hvoReal, int clid, int hvoOwner, int flidOwn, string name, int flidName)
		{
