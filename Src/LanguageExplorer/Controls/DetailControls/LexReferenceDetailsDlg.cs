...
{
	/// <summary />
	internal sealed class LexReferenceDetailsDlg : Form
	{
		...
		/// <summary />
		internal LexReferenceDetailsDlg(IHelpTopicProvider helpTopicProvider) : this()
		{
		...
		internal string ReferenceComment
		{
