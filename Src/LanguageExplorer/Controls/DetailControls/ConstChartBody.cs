...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class ConstChartBody : RootSite
	{
		...
		/// </summary>
		internal void SetRoot(int hvoChart, ICmPossibility[] allColumns, bool fRightToLeft)
		{
		...
		/// Change the root chart.
		/// </summary>
		internal void SetRoot(int hvoChart, ICmPossibility[] allColumns)
		{
			if (m_hvoChart == hvoChart && AllColumns == allColumns)
			{
				return;
		...
		/// </summary>
		internal void SetRoot(IDsConstChart chart, ICmPossibility[] allColumns)
		{
		...
		/// </summary>
		internal ICmPossibility[] AllColumns { get; private set; }
		...
		internal ConstituentChart Chart { get; }
	}
}