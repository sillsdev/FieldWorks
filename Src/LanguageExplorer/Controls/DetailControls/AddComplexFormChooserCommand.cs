...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class AddComplexFormChooserCommand : ChooserCommand
	{
		...
		/// <summary />
		internal AddComplexFormChooserCommand(LcmCache cache, bool fCloseBeforeExecuting, string sLabel, IPropertyTable propertyTable, IPublisher publisher, ISubscriber subscriber, ICmObject lexEntry, Form parentWindow)
		...
		public override ObjectLabel Execute()
		{
			...
			using (var dlg = new EntryGoDlg())
			{
				...
				{
					LanguageExplorerServices.ReportLexEntryCircularReference(dlg.SelectedObject, m_lexEntry, false);
				}
			}
			return null;
		}
