		...
		private void PrintMenu_Click(object sender, EventArgs e)
		{
			...
			switch (area)
			{
				case LanguageExplorerConstants.NotebookAreaMachineName:
					xmlParametersData = LanguageExplorerResources.NotebookDocumentParameters;
					break;
				case LanguageExplorerConstants.LexiconAreaMachineName:
					xmlParametersData = LanguageExplorerResources.LexiconClassifiedDictionaryParameters;
					configureText = LanguageExplorerResources.Classified_Dictionary;
					break;
				default:
					return;
			}
