...
namespace LanguageExplorer.Controls.DetailControls
{
	internal sealed partial class OneAnalysisSandbox : SandboxBase
	{
		...
		/// Create a new one.
		/// </summary>
		internal OneAnalysisSandbox(LcmCache cache, IVwStylesheet ss, InterlinLineChoices choices, int hvoAnalysis)
		...
		internal bool UpdateAnalysis(IWfiAnalysis anal)
		{
		...
		private sealed class UpdateRealAnalysisMethod : GetRealAnalysisMethod
		{
			...
			internal bool UpdateRealAnalysis()
			{
				var isDirty = false;
				BuildMorphLists();
				m_sdaMain.BeginUndoTask(LanguageExplorerResources.ksUndoEditAnalysis, LanguageExplorerResources.ksRedoEditAnalysis);
				try
				{
