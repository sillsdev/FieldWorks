...
{
	internal sealed class AdvancedMTDialogLogic : IDisposable
	{
		private IConstChartWordGroup m_wordGroup;

		internal AdvancedMTDialogLogic(LcmCache cache, bool fPrepose, CChartSentenceElements ccSentElem)
		{
			Cache = cache;
			Prepose = fPrepose;
			SentElem = ccSentElem;
		...
		///// </summary>
		internal DialogInterlinRibbon DlgRibbon { get; }
