...
{
	/// <summary />
	internal sealed class EntrySequenceReferenceLauncher : VectorReferenceLauncher
	{
		private System.ComponentModel.IContainer components;

		/// <summary />
		internal EntrySequenceReferenceLauncher()
		{
			InitializeComponent();
		}
						...
						case "ComplexFormEntries":
							using (var dlg = new EntryGoDlg())
							{
								...
								if (dlg.ShowDialog(FindForm()) == DialogResult.OK)
								{
									...
									{
										LanguageExplorerServices.ReportLexEntryCircularReference(dlg.SelectedObject, m_obj, false);
									}
								}
							}
							break;
		...
		public override void AddItem(ICmObject obj)
		{
			...
			{
				LanguageExplorerServices.ReportLexEntryCircularReference(m_obj.Owner, obj, true);
			}
		}
