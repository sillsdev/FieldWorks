...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	public class CheckboxSlice : FieldSlice, IVwNotifyChange
	{
		...
		//// stack frames below:
		////    LanguageExplorer.dll!LanguageExplorer.Controls.DetailControls.CheckboxSlice.OnGotFocus(System.EventArgs e = {System.EventArgs}) Line 238 + 0xd bytes	C#
		////    [External Code]
		//// 	LanguageExplorer.dll!LanguageExplorer.Controls.DetailControls.Slice.Dispose(bool disposing = true) Line 977 + 0xb bytes	C#
		////    LanguageExplorer.dll!LanguageExplorer.Controls.DetailControls.FieldSlice.Dispose(bool disposing = true) Line 110 + 0xf bytes	C#
		////    LanguageExplorer.dll!LanguageExplorer.Controls.DetailControls.CheckboxSlice.Dispose(bool disposing = true) Line 150 + 0xb bytes	C#
		////    ....
