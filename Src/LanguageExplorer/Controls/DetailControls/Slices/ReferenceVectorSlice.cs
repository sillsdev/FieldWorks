...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal class ReferenceVectorSlice : ReferenceSlice, IReferenceVectorSlice
	{
		...
		/// <summary />
		internal ReferenceVectorSlice(LcmCache cache, ICmObject obj, int flid)
		...
		public Tuple<ContextMenuStrip, List<Tuple<ToolStripMenuItem, EventHandler>>> Create_mnuReorderVector(ContextMenuName contextMenuId)
		{
			...
			if (visible)
			{
				...
				menu = ToolStripMenuItemFactory.CreateToolStripMenuItemForContextMenuStrip(menuItems, contextMenuStrip, MoveReferencedTargetDownInSequence_Clicked, LanguageExplorerControls.Move_Left);
			...
			if (visible)
			{
				...
				menu = ToolStripMenuItemFactory.CreateToolStripMenuItemForContextMenuStrip(menuItems, contextMenuStrip, MoveReferencedTargetUpInSequence_Clicked, LanguageExplorerControls.Move_Right);
				menu.Enabled = enabled;
			}
			if (CanAlphabetize)
			{
				// <command id="CmdAlphabeticalOrder" label="Alphabetical Order" message="AlphabeticalOrder"/>
				ToolStripMenuItemFactory.CreateToolStripMenuItemForContextMenuStrip(menuItems, contextMenuStrip, Referenced_AlphabeticalOrder_Clicked, LanguageExplorerControls.Alphabetical_Order);
			}
