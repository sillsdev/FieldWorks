...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal sealed class StTextSlice : ViewPropertySlice, IStTextSlice
	{
		...
		{
			LanguageExplorerServices.LexiconLookup(Cache, new FlexComponentParameters(PropertyTable, Publisher, Subscriber), RootSite);
		}

		internal void AddToLexicon()
		{
			LanguageExplorerServices.AddToLexicon(Cache, new FlexComponentParameters(PropertyTable, Publisher, Subscriber), RootSite);
		}
	}
}