...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	internal class MsaInflectionFeatureListDlgLauncherSlice : Slice
	{
		...
		/// <summary />
		internal MsaInflectionFeatureListDlgLauncherSlice()
		{
			InitializeComponent();
		}
		...
		public override void Install(DataTree parentDataTree)
		{
			...
			ctrl.Initialize(PropertyTable.GetValue<LcmCache>(FwUtilsConstants.cache), m_fs, m_flid, "Name", ContainingDataTree.PersistenceProvder,
