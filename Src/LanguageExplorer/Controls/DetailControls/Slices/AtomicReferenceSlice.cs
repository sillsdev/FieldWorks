...
{
	/// <summary />
	internal class AtomicReferenceSlice : ReferenceSlice, IAtomicReferenceSlice, IVwNotifyChange
	{
		...
		/// <summary />
		internal AtomicReferenceSlice(LcmCache cache, ICmObject obj, int flid)
		...
		private void RefreshTree(object sender, EventArgs args)
		{
