...
{
	/// <summary />
	internal sealed class InflAffixTemplateSlice : ViewSlice
	{
		/// <summary>
		...
		private sealed class InflAffixTemplateControl : XmlView
		{
			...
			{
				LinkHandler.PublishFollowLinkMessage(Publisher, new FwLinkArgs(LanguageExplorerConstants.LexiconEditMachineName, ((IMoInflAffMsa)_clickedCmObject).Owner.Guid));
			}
