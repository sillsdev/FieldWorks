...
{
	internal sealed class DummyObjectSlice : Slice, IDummyObjectSlice
	{
		...
		/// </summary>
		internal DummyObjectSlice(int indent, XElement node, ArrayList path, ICmObject obj, int flid, int ihvoMin, string layoutName, string layoutChoiceField, XElement caller)
		{
			Indent = indent;
			m_node = node;
			m_path = path;
		...
		/// </summary>
		public override void BecomeReal(int index)
		{
