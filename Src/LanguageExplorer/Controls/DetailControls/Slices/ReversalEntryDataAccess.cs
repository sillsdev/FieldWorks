...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// entry (forms).
	/// </summary>
	internal sealed class ReversalEntryDataAccess : DomainDataByFlidDecoratorBase, IVwCacheDa
	{
		internal const int kflidWsAbbr = 89999123;
		...
		/// <summary />
		internal ReversalEntryDataAccess(ISilDataAccessManaged sda)
			: base(sda)
		{
		}
