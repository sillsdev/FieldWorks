...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal sealed class AudioVisualSlice : ViewSlice
	{
		private System.ComponentModel.IContainer components = null;

		/// <summary />
		internal AudioVisualSlice()
		{
			InitializeComponent();
		}
		...
		private ICmMedia Media => (ICmMedia)MyCmObject;
		...
		public override void Install(DataTree parentDataTree)
		{
			...
			ctrl.Initialize(PropertyTable.GetValue<LcmCache>(FwUtilsConstants.cache), Media.MediaFileRA, CmFileTags.kflidInternalPath, "InternalPath",
		...
		/// </summary>
		protected override int LabelHeight => Math.Max(20, Convert.ToInt32(m_fontLabel.GetHeight()));
	}
}