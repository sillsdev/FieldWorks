...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal class ViewSlice : Slice, IViewSlice
	{
		/// <summary />
		internal ViewSlice()
		{
		...
		/// <summary />
		internal ViewSlice(SimpleRootSite ctrlT) : base(ctrlT)
		{
			InternalInitialize();
		}
		...
		/// <summary />
		protected void HandleLayoutSizeChanged(object sender, EventArgs ea)
		{
			SetHeightFromRootBox(RootSite);
		...
		public override void SetWidthForDataTreeLayout(int width)
		{
			if (Width == width)
			{
