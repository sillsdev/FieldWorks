...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	internal sealed class MSADlgLauncherSlice : ViewSlice
	{
		...
		public override void Install(DataTree parentDataTree)
		{
			...
			ctrl.Initialize(PropertyTable.GetValue<LcmCache>(FwUtilsConstants.cache), MyCmObject, 1, "InterlinearName", ContainingDataTree.PersistenceProvder,
		...
		/// <summary />
		public override RootSite RootSite => (RootSite)((MSADlgLauncher)Control).MainControl;
