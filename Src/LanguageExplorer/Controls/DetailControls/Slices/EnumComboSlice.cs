...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal sealed class EnumComboSlice : FieldSlice, IVwNotifyChange
	{
		private ComboBox m_combo;
		private int m_comboWidth;       // computed width of m_combo

		/// <summary />
		internal EnumComboSlice(LcmCache cache, ICmObject obj, int flid, XElement parameters)
		...
		private void PopulateCombo(XElement parameters)
		{
			m_combo.Items.Clear();
