...
namespace LanguageExplorer.Controls.DetailControls.Slices
{
	...
	/// </summary>
	internal sealed class SummarySlice : ViewSlice, ISummarySlice
	{
		...
		private ISummarySlice AsISummarySlice => this;

		#region Overrides of Slice
		/// <inheritdoc />
		public override ContextMenuName HotlinksMenuId
		{
			get
			{
		...
		private void m_view_LayoutSizeChanged(object sender, EventArgs e)
		{
			...
			AsISummarySlice.AdjustMainViewWidth();
		}
		...
		/// </summary>
		void ISummarySlice.AdjustMainViewWidth()
		{
