...
namespace LanguageExplorer.Controls.DetailControls
{
	internal class LiteralLabelVc : FwBaseVc
	{
		...
		{
			vwenv.set_IntProperty((int)FwTextPropType.ktptForeColor, (int)FwTextPropVar.ktpvDefault, (int)ColorUtil.ConvertColorToBGR(Color.FromKnownColor(KnownColor.ControlDarkDark)));
