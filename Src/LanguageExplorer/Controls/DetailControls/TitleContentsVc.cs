...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class TitleContentsVc : FwBaseVc
	{
		internal const int kfragRoot = 6789;
		...
		internal TitleContentsVc(LcmCache cache)
		{
			var wsUser = cache.DefaultUserWs;
			m_tssTitle = TsStringUtils.MakeString(LanguageExplorerResources.ksTitle, wsUser);
