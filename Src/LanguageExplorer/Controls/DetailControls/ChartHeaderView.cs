...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class ChartHeaderView : Control
	{
		...
		/// </summary>
		internal ChartHeaderView(ConstituentChart chart)
		{
			m_chart = chart;
		}
		...
		internal event ColumnWidthChangedEventHandler ColumnWidthChanged;

		/// <summary>
		/// Resizes the identified column to the default width
		/// </summary>
		internal void AutoResizeColumn(int iColumnChanged)
		{
