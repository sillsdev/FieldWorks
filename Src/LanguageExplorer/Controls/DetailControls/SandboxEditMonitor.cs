...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class SandboxEditMonitor : DisposableBase, IVwNotifyChange
	{
		...
		internal void DoPendingMorphemeUpdates()
		{
		...
		/// </summary>
		internal bool IsPropMorphBreak(int hvo, int tag, int ws)
		{
			switch (tag)
			{
