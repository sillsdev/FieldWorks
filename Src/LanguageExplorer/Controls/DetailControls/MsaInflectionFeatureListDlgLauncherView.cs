...
{
	/// <summary />
	internal sealed class MsaInflectionFeatureListDlgLauncherView : RootSiteControl
	{
		...
		/// <summary />
		internal MsaInflectionFeatureListDlgLauncherView()
		{
			InitializeComponent();
		}

		/// <summary />
		internal void Init(LcmCache cache, IFsFeatStruc fs)
		{
			m_fs = fs;
			m_cache = cache;
