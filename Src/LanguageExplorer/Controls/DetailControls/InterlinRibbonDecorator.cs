...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// (see AdvMTDlg)
	/// </summary>
	internal sealed class InterlinRibbonDecorator : DomainDataByFlidDecoratorBase, IAnalysisOccurrenceFromHvo
	{
		#region Member Data
		...
		/// </summary>
		private Dictionary<int, LocatedAnalysisOccurrence> m_cachedRibbonWords;

		#endregion

		internal InterlinRibbonDecorator(LcmCache cache, int flid)
		...
		/// </summary>
		internal int[] CacheRibbonItems(IParaFragment[] wordFormArray)
		{
