...
namespace LanguageExplorer.Controls.DetailControls
{
	internal class TwoLevelConcVc : FwBaseVc
	{
		...
		private int m_index; // slice number
		private bool m_fExpanded;
		private INodeInfo m_ni;
		...
		public bool Expanded
		{
			...
			set
			{
				...
				m_fExpanded = value;
				// Review JohnT: should we refresh this even if already obtained when expanding?
