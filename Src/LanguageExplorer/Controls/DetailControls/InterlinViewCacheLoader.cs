...
{
	internal class InterlinViewCacheLoader : IParaDataLoader
	{
		internal InterlinViewCacheLoader(AnalysisGuessServices guessServices, InterlinViewDataCache sdaDecorator)
		{
