...
{
	/// <summary />
	internal sealed class LexReferenceUnidirectionalLauncher : VectorReferenceLauncher
	{
		internal LexReferenceUnidirectionalLauncher()
		{
			InitializeComponent();
		}
		...
		protected override void HandleChooser()
		{
			...
			try
			{
				...
				{
					m_title = string.Format(LanguageExplorerControls.ksIdentifyXEntry, lrt.Name.BestAnalysisAlternative.Text), m_btnText = LanguageExplorerResources.ks_Add
				};
