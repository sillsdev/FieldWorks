...
namespace LanguageExplorer.Controls.DetailControls
{
	...
	/// </summary>
	internal sealed class ShowSpaceDecorator : DomainDataByFlidDecoratorBase
	{
		internal static readonly int KzwsBackColor = (int)ColorUtil.ConvertColorToBGR(Color.LightGray);

		internal ShowSpaceDecorator(ISilDataAccessManaged sda) : base(sda)
		{}
