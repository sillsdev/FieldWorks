...
namespace LanguageExplorer.Controls
{
	...
	/// </summary>
	internal sealed partial class ConfigSenseLayout : UserControl
	{
		///<summary>delegate for passing on the clicked event</summary>
		internal delegate void SensesBtnClickedHandler(object sender, EventArgs e);
		///<summary>
		/// Event handler for clicking the "Senses" button.
		///</summary>
		internal event SensesBtnClickedHandler SensesBtnClicked;
		...
		/// </summary>
		internal delegate void DisplaySenseInParaCheckedHandler(object sender, EventArgs e);

		/// <summary>
		/// event handler for the checking of the "Display each sense in a paragraph" checkbox.
		/// </summary>
		internal event DisplaySenseInParaCheckedHandler DisplaySenseInParaChecked;

		/// <summary />
		internal ConfigSenseLayout()
		{
			InitializeComponent();
		...
		{
			m_cbNumberStyle.Items.Add(new NumberingStyleComboItem(LanguageExplorerResources.ksNone, string.Empty));
		...
		{
			m_cbNumberFont.Items.Add(LanguageExplorerResources.kstidUnspecified);
		...
		/// </summary>
		internal bool DisplaySenseInPara
		{
		...
		/// </summary>
		internal ComboBox NumberStyleCombo => m_cbNumberStyle;

		/// <summary>
		/// Get the number font combobox.
		/// </summary>
		internal ComboBox NumberFontCombo => m_cbNumberFont;

		/// <summary>
		/// Get the sense (paragraph) style combobox.
		/// </summary>
		internal ComboBox SenseStyleCombo => m_cbSenseParaStyle;

		/// <summary>
		/// Initialize the list of styles in the styles combo boxes.
		/// </summary>
		internal void FillStylesCombo(List<StyleComboItem> styles)
		{
		...
		/// </summary>
		internal string SenseParaStyle
		{
		...
		/// </summary>
		internal CheckState BoldSenseNumber
		{
		...
		/// </summary>
		internal CheckState ItalicSenseNumber
		{
		...
		/// </summary>
		internal void HideSenseNumberConfiguration()
		{
		...
		/// </summary>
		internal void ShowSenseNumberConfiguration()
		{
		...
		private static void m_tb_TextChanged(object sender, EventArgs e)
		{
			...
			if (Regex.IsMatch(tb.Text, illegalChars))
			{
				...
				MessageBox.Show(LanguageExplorerResources.ksIllegalXmlChars, LanguageExplorerResources.ksWarning, MessageBoxButtons.OK, MessageBoxIcon.Warning);
			}
		}
