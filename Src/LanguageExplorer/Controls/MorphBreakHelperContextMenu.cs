...
namespace LanguageExplorer.Controls
{
	...
	/// </summary>
	internal sealed class MorphBreakHelperContextMenu : HelperContextMenu
	{
		...
		internal MorphBreakHelperContextMenu(FwTextBox textbox, IHelpTopicProvider helpTopicProvider, LcmCache cache)
