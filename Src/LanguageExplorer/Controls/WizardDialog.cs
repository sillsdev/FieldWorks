...
namespace LanguageExplorer.Controls
{
	...
	public class WizardDialog : Form, IWizardPaintPanSteps
	{
		...
		public WizardDialog()
		{
			...
			var resources = new ResourceManager("LanguageExplorer.Controls.LanguageExplorerControls", System.Reflection.Assembly.GetExecutingAssembly());
		...
		public int StepPageCount
		{
			...
			set
			{
				...
				if (value > tabSteps.TabCount)
				{
					...
					{
						var newPage = new TabPage(string.Format(LanguageExplorerControls.kstidWizTabPage, i + 1));
