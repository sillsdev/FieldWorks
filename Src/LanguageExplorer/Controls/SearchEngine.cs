...
namespace LanguageExplorer.Controls
{
	...
	internal abstract class SearchEngine : DisposableBase, IVwNotifyChange
	{
		...
		/// </summary>
		internal static SearchEngine Get(IPropertyTable propertyTable, string propName, Func<SearchEngine> searchEngineFactory)
		{
		...
		/// </summary>
		internal event EventHandler<SearchCompletedEventArgs> SearchCompleted;
		...
		/// </summary>
		internal IEnumerable<int> Search(IEnumerable<SearchField> fields)
		{
		...
		/// </summary>
		internal bool IsBusy => !m_thread.IsIdle;
