...
namespace LanguageExplorer.Controls
{
	...
	internal class TriStateTreeView : TreeView
	{
		...
		/// </summary>
		internal TriStateTreeViewCheckState GetChecked(TreeNode node)
		{
		...
		/// </summary>
		internal void SetChecked(TreeNode node, TriStateTreeViewCheckState state)
		{
		...
		/// </summary>
		internal void CheckNodeByTag(object tag, TriStateTreeViewCheckState state)
		{
			if (tag == null)
			{
				return;
		...
		/// </summary>
		internal ArrayList GetCheckedTagData()
		{
		...
		/// is a Flags enum).
		/// </summary>
		internal TreeNode[] GetNodesWithState(TriStateTreeViewCheckState state)
		{
		...
		/// Build a list of all of the checked nodes.
		/// </summary>
		internal List<TreeNode> GetCheckedNodeList()
		{
			var list = new List<TreeNode>();
			foreach (TreeNode node in Nodes)
			{
		...
		/// is a Flags enum).
		/// </summary>
		internal TreeNode[] GetNodesOfTypeWithState(Type nodeType, TriStateTreeViewCheckState state)
		{
