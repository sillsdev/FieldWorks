...
namespace LanguageExplorer.Controls
{
	...
	/// </summary>
	internal class TextsTriStateTreeView : TriStateTreeView
	{
		...
		/// <summary />
		internal TextsTriStateTreeView()
		{
		...
		/// </summary>
		internal IApp App { private get; set; }
		...
		private void LoadScriptureTexts()
		{
			...
			var bibleNode = new TreeNode(LanguageExplorerResources.kstidBibleNode)
			{
				Name = "Bible"
			};
			if (otBooks.Any())
			{
				var testamentNode = new TreeNode(LanguageExplorerResources.kstidOtNode, otBooks.ToArray())
				{
					Name = "Testament"
				};
			...
			if (ntBooks.Any())
			{
				var testamentNode = new TreeNode(LanguageExplorerResources.kstidNtNode, ntBooks.ToArray())
				{
					Name = "Testament"
				};
				// help us query for Testaments
