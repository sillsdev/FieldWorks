...
namespace LanguageExplorer.Controls
{
	...
	public abstract class BaseGoDlg : Form, IFlexComponent
	{
		...
		protected BaseGoDlg()
		{
			...
			m_btnClose.Text = LanguageExplorerControls.ksCancel;
			m_btnHelp.Text = LanguageExplorerControls.ks_Help_;
			m_btnInsert.Text = LanguageExplorerControls.ks_Create_;
			m_wsLabel.Text = LanguageExplorerControls.ks_WritingSystem_;
