...
namespace LanguageExplorer.Controls.Styles
{
	partial class FwFontTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_FontAttributes = new FwFontAttributes();
			this.m_cboFontSize = new FwInheritablePropComboBox();
			this.m_cboFontNames = new FwInheritablePropComboBox();
		...
		private FwInheritablePropComboBox m_cboFontSize;
		private FwInheritablePropComboBox m_cboFontNames;
