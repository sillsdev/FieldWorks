...
namespace LanguageExplorer.Controls.Styles
{
	partial class FwFontAttributes
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btnFontFeatures = new SIL.FieldWorks.FwCoreDlgs.Controls.FontFeaturesButton();
			this.m_nudPositionAmount = new UpDownMeasureControl();
			this.m_cboUnderlineColor = new FwColorCombo();
			this.m_cboBackgroundColor = new FwColorCombo();
			this.m_cboFontColor = new FwColorCombo();
			this.m_cboFontPosition = new FwInheritablePropComboBox();
			...
			this.m_cboUnderlineStyle = new FwInheritablePropComboBox();
		...
		private FwColorCombo m_cboUnderlineColor;
		private FwColorCombo m_cboBackgroundColor;
		private FwColorCombo m_cboFontColor;
		private FwInheritablePropComboBox m_cboFontPosition;
		...
		private FwInheritablePropComboBox m_cboUnderlineStyle;
