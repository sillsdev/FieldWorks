...
namespace LanguageExplorer.Controls.Styles
{
	partial class FwStylesDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_bulletsTab.FontDialog += new FwBulletsTab.FontDialogHandler(this.OnBulletsFontDialog);
		...
		private FwBulletsTab m_bulletsTab;
		private FwParagraphTab m_paragraphTab;
		private FwBorderTab m_borderTab;
		private FwFontTab m_fontTab;
		...
		/// <summary></summary>
		protected FwGeneralTab m_generalTab;
