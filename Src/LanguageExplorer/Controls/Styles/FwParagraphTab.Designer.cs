...
namespace LanguageExplorer.Controls.Styles
{
	partial class FwParagraphTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_nudIndentBy = new UpDownMeasureControl();
			this.m_nudRightIndentation = new UpDownMeasureControl();
			this.m_nudLeftIndentation = new UpDownMeasureControl();
			this.m_cboSpecialIndentation = new FwInheritablePropComboBox();
			this.lblRight = new System.Windows.Forms.Label();
			this.lblLeft = new System.Windows.Forms.Label();
			this.m_nudSpacingAt = new UpDownMeasureControl();
			this.m_nudAfter = new UpDownMeasureControl();
			this.m_nudBefore = new UpDownMeasureControl();
			this.m_cboLineSpacing = new FwInheritablePropComboBox();
			this.m_pnlPreview = new System.Windows.Forms.Panel();
			this.m_lblBackground = new System.Windows.Forms.Label();
			this.m_cboDirection = new FwInheritablePropComboBox();
			this.m_cboAlignment = new FwInheritablePropComboBox();
			this.m_cboBackground = new FwColorCombo();
		...
		private FwInheritablePropComboBox m_cboDirection;
		private FwInheritablePropComboBox m_cboAlignment;
		private FwColorCombo m_cboBackground;
		private FwInheritablePropComboBox m_cboSpecialIndentation;
		private FwInheritablePropComboBox m_cboLineSpacing;
