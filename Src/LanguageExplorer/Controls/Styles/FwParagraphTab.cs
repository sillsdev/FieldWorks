...
{
	/// <summary />
	internal partial class FwParagraphTab : UserControl, IStylesTab
	{
		#region Member Data
		/// <summary>
		...
		private void ChangeDirectionLabels(bool fShowLeadingTrailing)
		{
			...
			{
				lblLeft.Text = Strings.kstidLeadingCheck;
				lblRight.Text = Strings.kstidTrailingCheck;
			}
			else
			{
				lblLeft.Text = Strings.kstidLeftCheck;
				lblRight.Text = Strings.kstidRightCheck;
			}
		}
