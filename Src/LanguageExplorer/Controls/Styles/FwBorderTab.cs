...
namespace LanguageExplorer.Controls.Styles
{
	...
	/// </summary>
	internal partial class FwBorderTab : UserControl, IStylesTab
	{
		#region Data Members
		/// <summary>
		...
		private void ChangeDirectionLabels(bool fShowLeadingTrailing)
		{
			...
			{
				m_chkLeft.Text = Strings.kstidLeadingCheck;
				m_chkRight.Text = Strings.kstidTrailingCheck;
			}
			else
			{
				m_chkLeft.Text = Strings.kstidLeftCheck;
				m_chkRight.Text = Strings.kstidRightCheck;
			}
		}
