...
namespace LanguageExplorer.Controls.Styles
{
	partial class FwBorderTab
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_cboWidth = new FwInheritablePropComboBox();
			...
			this.m_cboColor = new FwColorCombo();
		...
		private FwColorCombo m_cboColor;
		private FwInheritablePropComboBox m_cboWidth;
