...
namespace LanguageExplorer.Controls
{
	...
	public partial class AddWritingSystemButton : Button
	{
		...
		protected override void OnClick(EventArgs e)
		{
			...
			xmlWsV[xmlWs.Count + 1] = new MenuItem(LanguageExplorerControls.ks_DefineNew_, mnuAddWS_Vern);
			xmlWsA[xmlWs.Count] = new MenuItem("-");
			xmlWsA[xmlWs.Count + 1] = new MenuItem(LanguageExplorerControls.ks_DefineNew_, mnuAddWS_Anal);
