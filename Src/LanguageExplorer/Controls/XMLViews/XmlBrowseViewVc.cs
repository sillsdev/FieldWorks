...
{
	/// <summary />
	internal class XmlBrowseViewVc : XmlVc
	{
		#region Constants
		...
		/// </summary>
		internal XmlBrowseViewVc() // We don't have a string table.
		{
		...
		/// </summary>
		internal XmlBrowseViewVc(XmlBrowseViewBase xbv)
		{
		...
		/// </summary>
		internal XmlBrowseViewVc(LcmCache cache)
		{
		...
		/// </summary>
		internal XmlBrowseViewVc(LcmCache cache, ISilDataAccess sda)
		{
