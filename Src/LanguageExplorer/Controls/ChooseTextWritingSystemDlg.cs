...
{
	internal sealed partial class ChooseTextWritingSystemDlg : Form
	{
		private HelpProvider helpProvider;
		private const string s_helpTopic = "khtpBaselineTextWs";
		private IHelpTopicProvider m_helpTopicProvider;

		internal ChooseTextWritingSystemDlg()
		{
			InitializeComponent();
		...
		/// </summary>
		internal void Initialize(LcmCache cache, IHelpTopicProvider helpTopicProvider, int wsCurrent)
		{
		...
		internal int TextWs { get; private set; }
	}
}