...
namespace LanguageExplorer.Controls
{
	...
	/// </summary>
	internal sealed class LayoutMerger : IOldVersionMerger
	{
		...
		/// </summary>
		XElement IOldVersionMerger.Merge(XElement newMaster, XElement oldConfigured, XDocument dest, string oldLayoutSuffix)
		{
