...
namespace LanguageExplorer.Controls
{
	...
	internal static class CollapsingSplitContainerFactory
	{
		...
		/// <param name="paneBarControls">Controls to be added to the IPaneBar instance.</param>
		...
		internal static CollapsingSplitContainer Create(IPropertyTable propertyTable, IPublisher publisher, ISubscriber subscriber,
			...
			IList<Control> paneBarControls)
		{
			var parentSplitterPanelControl = mainCollapsingSplitContainer.Panel2;
			...
			paneBar.AddControls(paneBarControls);
			...
			parentSplitterPanelControl.Parent.ResumeLayout();
		...
		internal static void RemoveFromParentAndDispose(CollapsingSplitContainer collapsingSplitContainer)
		{
