...
{
	/// <summary />
	internal sealed class AddNewSenseDlg : Form
	{
		...
		internal AddNewSenseDlg(IHelpTopicProvider helpTopicProvider)
		{
			BasicInit();
		...
		/// </summary>
		internal void SetDlgInfo(ITsString tssCitationForm, ILexEntry le, FlexComponentParameters flexComponentParameters)
		{
		...
		/// </summary>
		internal void GetDlgInfo(out int newSenseID)
		{
				...
				case DialogResult.OK:
					{
						...
						{
							e.Cancel = true;
							MessageBox.Show(this, LanguageExplorerControls.ksFillInGloss, LanguageExplorerControls.ksMissingInformation, MessageBoxButtons.OK, MessageBoxIcon.Information);
							return;
						}
						using (new WaitCursor(this))
						{
							m_cache.DomainDataByFlid.BeginUndoTask(LanguageExplorerControls.ksUndoCreateNewSense, LanguageExplorerControls.ksRedoCreateNewSense);
