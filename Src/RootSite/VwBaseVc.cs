...
namespace SIL.FieldWorks.Common.RootSites
{
	...
	internal abstract class VwBaseVc : IVwViewConstructor
	{
		...
		public virtual void DoHotLinkAction(string strData, ISilDataAccess sda)
		{
			...
			if (Publisher != null)
			{
				Publisher.Publish(new PublisherParameterObject(FwUtils.FwUtilsConstants.HandleLocalHotlink, args));
			...
			{
				MessageBox.Show(null, string.Format(RootSiteStrings.ksMissingLinkTarget, url, e.Message), RootSiteStrings.ksCannotFollowLink);
			}
		}
