...
{
	/// <summary />
	internal delegate void FwPasteFixTssEventHandler(EditingHelper sender, FwPasteFixTssEventArgs e);
	...
	/// </summary>
	internal sealed class FwPasteFixTssEventArgs
	{
		/// <summary />
		...
		internal FwPasteFixTssEventArgs(ITsString tss, TextSelInfo tsi)
		{
			TsString = tss;
			TextSelInfo = tsi;
			EventHandled = false;
		...
		/// </summary>
		internal ITsString TsString { get; set; }

		/// <summary>
		/// The TextSelInfo of the selection at the start of the paste
		/// </summary>
		internal TextSelInfo TextSelInfo { get; }

		/// <summary>
		/// Gets or sets a value indicating whether the event was handled.
		/// </summary>
		internal bool EventHandled { get; set; }
	}
}