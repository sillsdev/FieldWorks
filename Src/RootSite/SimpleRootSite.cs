...
namespace SIL.FieldWorks.Common.RootSites
{
	...
	internal class SimpleRootSite : UserControl, IVwRootSite, IRootSite, IFlexComponent, IEditingCallbacks, IReceiveSequentialMessages, IMessageFilter
	{
		...
		internal virtual void Print(PrintDocument printDoc)
		{
			...
			{
				var errorMsg = string.Format(RootSiteStrings.kstidPrintingException, e.Message);
				MessageBox.Show(FindForm(), errorMsg, RootSiteStrings.kstidPrintErrorCaption, MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
		#endregion
...
#pragma warning restore 219
		...
		public virtual void MakeRoot()
		{
			...
			m_vdrb = Platform.IsMono ? new VwDrawRootBuffered() : (IVwDrawRootBuffered)VwDrawRootBufferedClass.Create();
		...
		private sealed class VwDrawRootBuffered : IVwDrawRootBuffered
		{
