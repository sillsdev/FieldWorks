...
namespace SIL.FieldWorks.TE
{
	...
	public class DummyFootnoteView : FootnoteView
	{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public DummyFootnoteView(FdoCache cache) :
			base(cache, 0, null, "DummyFootnoteView", true,
			TeViewType.FootnoteView | TeViewType.Horizontal | TeViewType.Scripture, -1, null)
		{
		}
	...
	public class DummyFootnoteViewForm : Form, IFWDisposable, ISettings
	{
		...
		public void DeleteRegistryKey()
		{
			...
			try
			{
				FwRegistryHelper.FieldWorksRegistryKey.DeleteSubKeyTree("FootnoteViewTest");
			}
			catch
			{
			}
