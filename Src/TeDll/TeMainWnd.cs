...
namespace SIL.FieldWorks.TE
{
		...
		IScrRefTracker
	{
			...
			TeViewType viewType, SBTabItemProperties tabItem)
		{
			...
			KeyTermsViewWrapper keyTermsViewWrapper = new KeyTermsViewWrapper(this, m_cache,
				...
				m_delegate.GetProjectName(m_cache));
		...
		public void InitializeInsertBookMenus()
		{
			...
			{
				string bookName = ScrFdoResources.ResourceManager.GetString("kstidBookName" + bookNum);
	...
	public DraftViewWrapper TheDraftViewWrapper
		...
		{
			TeImportManager.ImportSf(this, this, m_app, m_app);
			return true;
		}
		...
		{
			TeImportManager.ImportXml(this, this, m_app, m_app);
			return true;
		}
		...
		protected bool OnBookFilter(object args)
		{
			...
			using (FilterBookDialog dlg = new FilterBookDialog(m_cache, m_bookFilter.SavedFilter, m_app))
			{
				if (dlg.ShowDialog() == DialogResult.OK)
				{
					IScrBook[] filteredBooks = dlg.GetListOfIncludedScripture();
			...
			if (m_usfmBrowser == null)
			{
				...
				try
				{
					...
					if (!m_usfmBrowser.Install(this.splitContainer.Panel2, Cache,
						m_StyleSheet.FindStyle(ScrStyleNames.Normal), m_app))
					{
						m_usfmBrowser = null;
						return;
					}
