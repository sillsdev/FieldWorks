...
namespace SIL.FieldWorks.SharpViews
{
	...
	public class AssembledStyles
	{
		...
		private FwTextAlign m_paraAlignment = FwTextAlign.ktalLeft;
		private string m_paragraphStyleName;
		...
		{
			get { return m_paragraphStyleName; }
			set
			{
				var stylesheet = Stylesheet;
				var paragraphStyle = stylesheet.Style(value);
				if(!paragraphStyle.IsParagraphStyle)
					return;
				m_paragraphStyleName = value;
				ParagraphStyle = paragraphStyle;
				m_styleName = value;

				ApplyParagraphStyleInfo(paragraphStyle.ParagraphStyleInfo);
				ApplyCharacterStyleInfo(paragraphStyle.DefaultCharacterStyleInfo);
				// if WS is known apply overrides.
				if (Ws != 0)
					ApplyCharacterStyleInfo(paragraphStyle.OverrideCharacterStyleInfo(Ws));
			}
		}

		public IStyle ParagraphStyle { get; set; }
		...
		public AssembledStyles WithRightToLeft(bool rtl)
		{
			return m_styleCache.GetDerivedStyle(this, (int)FwTextPropType.ktptRightToLeft, rtl,
												(newStyles, w) => newStyles.RightToLeft = rtl);
		}
		...
		public string StyleName
		{
			...
			private set
			{
				...
				if (style.IsParagraphStyle)
					...
					m_styleName = value;
				ApplyCharacterStyleInfo(Stylesheet.Style(m_styleName).DefaultCharacterStyleInfo);
				// if WS is known apply overrides.
				if (Ws != 0)
					ApplyCharacterStyleInfo(Stylesheet.Style(m_styleName).OverrideCharacterStyleInfo(Ws));
		...
		/// <summary>
		/// Length in millipoints of the indent of the first line of the paragraph.
		/// </summary>
		public int FirstLineIndent { get { return m_firstLineIndent; } }
		public AssembledStyles WithFirstLineIndent(int mp)
		{
			return m_styleCache.GetDerivedStyle(this, (int)FwTextPropType.ktptFirstIndent, mp,
												(newStyles, w) => newStyles.m_firstLineIndent = mp);
		}

		public FwTextAlign ParaAlignment { get { return m_paraAlignment; } }
		...
		/// <summary>
		/// Return an object which, when passed to WithProperties, will return an assembled styles
		/// with the specified first line indent.
		/// </summary>
		public static PropSetter FirstLineIndentSetter(int indent)
		{
			var result = new FirstLineIndentPropSetter();
			result.SetToValue = indent;
			return result;
		}
		...
		public static PropSetter UnderlineColorSetter(Color underlineColor)
		{
			...
			result.SetToValue = underlineColor;
			return result;
		}

		/// <summary>
		/// Return an object which, when passed to WithProperties, will return an assembled styles
		/// with the specified RTL value.
		/// </summary>
		public static PropSetter RtlSetter(bool rtl)
		{
			var result = new RtlPropSetter();
			result.Value = rtl;
			return result;
		}
		/// <summary>
		...
		{
			internal int SetToValue;

			public override bool Equals(object obj)
			{
				return base.Equals(obj) && SetToValue == ((IntPropSetter) obj).SetToValue;
			}

			public override int GetHashCode()
			{
				return base.GetHashCode() ^ SetToValue.GetHashCode();
			}
		...
		{
			internal Thickness SetToValue;

			public override bool Equals(object obj)
			{
				return base.Equals(obj) && SetToValue == ((ThicknessPropSetter)obj).SetToValue;
			}
		...
		private abstract class StringPropSetter : PropSetterImpl
		{
			...
			public override bool Equals(object obj)
			{
				return base.Equals(obj) && SetToValue == ((StringPropSetter)obj).SetToValue;
			}

			public override int GetHashCode()
			{
				return base.GetHashCode() ^ (SetToValue == null ? 0 : SetToValue.GetHashCode());
			}
		}
		...
		private class FontSizePropSetter : IntPropSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
				styles.m_chrp.dympHeight = SetToValue;
			}
		}
		...
		private class FirstLineIndentPropSetter : IntPropSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
			...
			public override string ToString()
			{
				...
				switch (SetToValue)
				{
					...
					case (int) FwTextToggleVal.kttvInvert:
						...
						break;
					default:
						extra = "some unexpected value " + SetToValue;
						break;
				}
		...
		private class UnderlinePropSetter : IntPropSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
				styles.m_chrp.unt = SetToValue;
			}

			public override string ToString()
			{
				return "UnderlinPropSetter for " + ((FwUnderlineType)SetToValue);
			}
		}
		...
		{
			internal Color SetToValue;
			internal uint Argb { get { return (uint) SetToValue.ToArgb(); } }

			public override bool Equals(object obj)
			{
				return base.Equals(obj) && SetToValue.ToArgb() == ((ColorSetter)obj).SetToValue.ToArgb();
			}

			public override int GetHashCode()
			{
				return base.GetHashCode() ^ SetToValue.ToArgb().GetHashCode();
			}
		}
		...
		{
			internal Color SetToValue;
			internal uint Bgr { get { return ColorUtil.ConvertColorToBGR(SetToValue); } }

			public override bool Equals(object obj)
			{
				return base.Equals(obj) && ColorUtil.ConvertColorToBGR(SetToValue) ==
					ColorUtil.ConvertColorToBGR(((BgrSetter)obj).SetToValue);
			}

			public override int GetHashCode()
			{
				return base.GetHashCode() ^ ColorUtil.ConvertColorToBGR(SetToValue).GetHashCode();
			}
		}

		/// <summary>
		/// Base class for properties that should be set to a bool value.
		/// </summary>
		private abstract class BoolSetter : PropSetterImpl
		{
			internal bool Value;

			public override bool Equals(object obj)
			{
				return base.Equals(obj) && Value == ((BoolSetter)obj).Value;
			}

			public override int GetHashCode()
			{
				return base.GetHashCode() ^ (Value ? 1 : 0);
			}
		}
		...
		private class BorderColorPropSetter : ColorSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
				styles.m_borderColor = SetToValue;
			}
		}
		...
		private class BordersPropSetter : ThicknessPropSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
				styles.m_borders = SetToValue;
			}
		}

		private class RtlPropSetter : BoolSetter
		{
			internal override void SetOwnProperty(AssembledStyles styles)
			{
				styles.RightToLeft = Value;
			}
		}
	}
