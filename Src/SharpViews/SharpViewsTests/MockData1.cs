...
namespace SIL.FieldWorks.SharpViews.SharpViewsTests
{
	...
	public class MockData1 : ICmObject
	{
		public MockData1()
		{
			var temp = new MonitoredList<MockData1>();
			ObjSeq2 = temp;
		...
		private MockMultiAccessor m_simpleOneAccessor;
		...
		internal MockMultiAccessor MlSimpleOne
		{
			get
			{
				if (m_simpleOneAccessor == null)
				{
					m_simpleOneAccessor = new MockMultiAccessor(VernWs, AnalysisWs);
				}
