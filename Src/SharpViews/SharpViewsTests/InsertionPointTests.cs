...
namespace SIL.FieldWorks.SharpViews.SharpViewsTests
{
	...
	public class InsertionPointTests : GraphicsTestBase
	{
		...
		public void UserPrompt()
		{
			...
			var promptField = Display.Of(() => data1.SimpleThree, 34).WhenEmpty("type here ", 35);
		...
		/// <summary>
		/// Uncomforably similar to the UserPrompt test, this one uses a TsString property.
		/// </summary>
		[Test]
		public void UserPromptTss()
		{
			...
			var promptField = Display.Of(() => data1.SimpleTwo).WhenEmpty("type here ", 35);
