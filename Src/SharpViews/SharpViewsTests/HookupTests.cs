...
namespace SIL.FieldWorks.SharpViews.SharpViewsTests
{
	...
	public class HookupTests : GraphicsTestBase
	{
		...
		public void HookupMlString()
		{
			...
			MlsHookup mlHook = new MlsHookup(data1, data1.MlSimpleOne, m_wsFrn, mockPara);
		...
		public void ParaSequenceTest()
		{
			...
			// The first string we insert is deliberately the widest. After that, the with of the pile
			// remains constant, allowing us to test smarter, smaller invalidate rectangles; whe the width
