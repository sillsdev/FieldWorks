...
light -nologo wixca.wixlib Actions.wixobj CopyFiles.wixobj Environment.wixobj Features.wixobj FW.wixobj FwUI.wixobj ProcessedMergeModules.wixobj ProcessedFiles.wixobj ProcessedProperties.wixobj Registry.wixobj Shortcuts.wixobj -out SetupFW.msi >WixLink.log