...
# PROP Scc_ProjName "CodeGenerator"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD LINK32 xmlparse.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386 /out:"Release/cmcg.exe" /libpath:"..\..\..\Lib"
# SUBTRACT LINK32 /nodefaultlib
# Begin Special Build Tool
TargetDir=.\Release
TargetPath=.\Release\cmcg.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Copy
PostBuild_Cmds=copy $(TargetPath) $(TargetDir)\..\..\..
...
# ADD LINK32 xmlparse.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"libc" /out:"Debug/cmcg.exe" /pdbtype:sept /libpath:"..\..\..\Lib"
# SUBTRACT LINK32 /nodefaultlib
# Begin Special Build Tool
TargetDir=.\Debug
TargetPath=.\Debug\cmcg.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Copy
PostBuild_Cmds=copy $(TargetPath) $(TargetDir)\..\..\..
# End Special Build Tool
