...
BUILD_PRODUCT=dumpxml
BUILD_EXTENSION=exe
BUILD_REGSVR=1

# EXE_MODULE is defined, to get correct ModuleEntry sections for DumpXML.
DEFS=$(DEFS) /DEXE_MODULE=1

CELLAR_XML=$(BUILD_ROOT)\src\Cellar\XML
PROG_SRC=$(BUILD_ROOT)\Bin\Src\dumpxml
...
OBJ_DUMPXML=\
	$(INT_DIR)\autopch\dumpxml.obj\
	$(INT_DIR)\autopch\ModuleEntry.obj\

OBJ_ALL=$(OBJ_DUMPXML) $(OBJ_GENERIC)
