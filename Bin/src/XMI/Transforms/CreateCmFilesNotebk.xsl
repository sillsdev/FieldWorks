...
<!--This transform will output notebk.cmt from xmi2cellar3.xml in the XMITempOutputs directory.-->
<!--History
...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:text>&#xA;</xsl:text>
   <xsl:template match="/">
	  <xsl:apply-templates select="EntireModel/CellarModule[@id='Notebk']"/>
   </xsl:template>
