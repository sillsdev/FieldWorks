...
<!--This transform will output cm files to their respective src\*\xml directories.-->
<!--IMPORTANT XSLT note. L. Hayashi
As of April 9, 2002 this file requires SAXON XSLT processor because it used xsl:document to generate the *.cm files.
...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="/">
	  <xsl:apply-templates select="CellarModule[@id='Cellar']"/>
   </xsl:template>
   <xsl:template match="CellarModule">
	  <!--xsl:document href="..\..\..\..\src\{@id}\xml\{@id}.cm"-->
	  <xsl:document href="XMITempOutputs\{@id}.cmt">
		 <xsl:text>&#xA;</xsl:text>
		 <xsl:comment>This is a temp cm file generated from \bin\scr\xmi\FieldWorks.xmi. Do NOT edit this file directly!!!</xsl:comment>
		 <xsl:text>&#xA;</xsl:text>
