...
namespace SIL.FieldWorks.Build.Tasks
{
	...
	public class XmlAssemblyCollection : CollectionBase
	{
		...
		/// <seealso cref='SIL.FieldWorks.Build.Tasks.XmlAssemblyCollection.AddRange(SIL.FieldWorks.Build.Tasks.XmlAssembly[])'/>
		/// ------------------------------------------------------------------------------------
		...
		/// <see cref='SIL.FieldWorks.Build.Tasks.XmlAssemblyCollection'/> contains the
		/// specified <see cref='SIL.FieldWorks.Build.Tasks.XmlAssembly'/>.
		/// </summary>
		/// <param name='value'>The <see cref='SIL.FieldWorks.Build.Tasks.XmlAssembly'/> to
		/// locate.</param>
		/// <returns>
		/// <c>true</c> if the <see cref='SIL.FieldWorks.Build.Tasks.XmlAssembly'/> is contained
		/// in the collection;
		/// otherwise, <c>false</c>.
		/// </returns>
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Copies the <see cref='SIL.FieldWorks.Build.Tasks.XmlAssemblyCollection'/> values to
		/// a one-dimensional <see cref='System.Array'/> instance at the specified index.
		/// </summary>
		...
		///		<see cref='SIL.FieldWorks.Build.Tasks.XmlAssemblyCollection'/> is greater than
		///		the available space between <paramref name='index'/> and the end of
		///		<paramref name='array'/>.</para>
		/// </exception>
		/// <exception cref='System.ArgumentNullException'><paramref name='array'/> is
		///		<see langword='null'/>.
		/// </exception>
		...
		public class XmlAssemblyEnumerator : object, IEnumerator
		{
			...
			private readonly IEnumerator m_BaseEnumerator;

			private readonly IEnumerable m_Temp;
			...
			/// --------------------------------------------------------------------------------
			public XmlAssemblyEnumerator(IEnumerable mappings)
			{
				m_Temp = mappings;
			...
			public XmlAssembly Current
			{
				get
				{
					return ((XmlAssembly)(m_BaseEnumerator.Current));
				}
			}
			...
			object IEnumerator.Current
			{
				get
				{
					return m_BaseEnumerator.Current;
				}
			}
