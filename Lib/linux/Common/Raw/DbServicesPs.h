...
EXTERN_C const IID IID_IBackupDelegates;
...
EXTERN_C const IID IID_DIFwBackupDb;
...
EXTERN_C const IID IID_IDisconnectDb;
...
EXTERN_C const IID IID_IRemoteDbWarn;
...
EXTERN_C const IID IID_IDbWarnSetup;
