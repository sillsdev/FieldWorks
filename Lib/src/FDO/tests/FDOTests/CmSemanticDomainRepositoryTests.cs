...
namespace SIL.FieldWorks.FDO.FDOTests
{
	...
	@"<?xml version='1.0' encoding='UTF-8'?>
		...
		public void FindDomains_TimingOnLargerDataSet()
		{
			//Setup
			const string searchString = "sun";
			const string filePath = "semdom.xml";
			LoadSemDomTestDataFromFile(Path.Combine(TestDirectoryFinder.TemplateDirectory, filePath));
		...
		public void SenseSearch_KeysNotInFirstAnalysisWs()
		{
			...
			CoreWritingSystemDefinition wsFr;
