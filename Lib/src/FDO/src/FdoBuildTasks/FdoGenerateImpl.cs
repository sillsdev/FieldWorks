...
namespace SIL.FieldWorks.FDO.Build.Tasks
{
	...
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	public class FdoGenerateImpl
	{
		/// <summary></summary>
		public static FdoGenerateImpl Generator;
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Initializes a new instance of the <see cref="SIL.FieldWorks.FDO.FdoGenerate"/> class.
		/// </summary>
		/// <param name="doc">The XMI document.</param>
		/// <param name="outputDir">The output dir.</param>
		/// ------------------------------------------------------------------------------------
		public FdoGenerateImpl(XmlDocument doc, string outputDir)
