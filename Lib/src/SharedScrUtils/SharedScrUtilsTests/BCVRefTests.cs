	...
	public class BCVRefTests
	{
		...
		public static void InitializeVersificationTable()
		{
			...
			File.WriteAllBytes(Path.Combine(vrsPath,
				VersificationTable.GetFileNameForVersification(Paratext.ScrVers.English)), Properties.Resource.eng);
			File.WriteAllBytes(Path.Combine(vrsPath,
				VersificationTable.GetFileNameForVersification(Paratext.ScrVers.Septuagint)), Properties.Resource.lxx);
			File.WriteAllBytes(Path.Combine(vrsPath,
				VersificationTable.GetFileNameForVersification(Paratext.ScrVers.Original)), Properties.Resource.org);
