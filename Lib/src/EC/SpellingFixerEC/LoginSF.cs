...
namespace SpellingFixerEC
{
	...
	internal class LoginSF : System.Windows.Forms.Form
	{
		...
		private const string    cstrProjectMemoryKey = @"SOFTWARE\SIL\SilEncConverters31\SpellingFixerEC";
		...
		internal static string GetMapTableFolderPath
		{
			get
			{
				string strMapsTableDir = Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData);
