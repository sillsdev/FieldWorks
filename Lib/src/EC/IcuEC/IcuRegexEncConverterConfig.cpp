// IcuRegex.cpp : Implementation of CIcuRegexEncConverterConfig
...
STDMETHODIMP CIcuRegexEncConverterConfig::Configure
(
	IEncConverters* pECs,
...
)
{
	...
	*bRet = 0;   // false (pessimistic)
	...
	CIcuRegexAutoConfigDlg dlgConfig
		(
			pECs,
			strFriendlyName,
...
STDMETHODIMP CIcuRegexEncConverterConfig::DisplayTestPage
(
	IEncConverters*     pECs,
	BSTR                strFriendlyName,
