// IcuConvEncConverterConfig.cpp : Implementation of CIcuConvEncConverterConfig
...
STDMETHODIMP CIcuConvEncConverterConfig::Configure
(
	IEncConverters* pECs,
...
)
{
	...
	*bRet = 0;   // false (pessimistic)
	...
	CIcuConvAutoConfigDlg dlgConfig
		(
			pECs,
			strFriendlyName,
...
STDMETHODIMP CIcuConvEncConverterConfig::DisplayTestPage
(
	IEncConverters*     pECs,
	BSTR                strFriendlyName,
