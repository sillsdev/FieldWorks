namespace SILConvertersOffice
{
	...
	[GuidAttribute("3B11D94D-43B6-49a2-A430-03FF0A211D70"), ProgId("SILConvertersOffice.Connect")]
	public class Connect : Object, Extensibility.IDTExtensibility2
	{
		...
		internal static string GetAppDataDir
		{
			get
			{
				return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + cstrAppFolderExtra;
			}
		}
