// PerlExpression.cpp : Implementation of CPerlExpressionEncConverterConfig
...
STDMETHODIMP CPerlExpressionEncConverterConfig::Configure
(
	IEncConverters* pECs,
...
)
{
	...
	*bRet = 0;   // false (pessimistic)
	...
	CPerlExpressionAutoConfigDlg dlgConfig
		(
			pECs,
			strFriendlyName,
...
STDMETHODIMP CPerlExpressionEncConverterConfig::DisplayTestPage
(
	IEncConverters*     pECs,
	BSTR                strFriendlyName,
