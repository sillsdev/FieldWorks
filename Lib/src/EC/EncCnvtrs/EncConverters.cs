...
namespace SilEncConverters40
{
	...
	public class EncConverters : Hashtable, IEncConverters
	{
		...
		protected void GetConversionEnginesSupported()
		{
			...
			System.Diagnostics.Debug.Assert(astrPluginXmlFiles.Length > 0, String.Format(@"You don't have any plug-ins installed (e.g. {0}\SilEncConverters40 Plugin Details.xml)", strPluginXmlFilesFolder));
