...
#define	TECKIT_PROGID	L"SilEncConverters31.TecFormEncConverter"
...
{
protected:
	CComBSTR        m_strProgramID;     // indicates the Program ID from the registry (e.g. "SilEncConverters31.TecEncConverter")
...
{
protected:
	CString             m_strProgramID;         // eg. "SilEncConverters31.PyScriptEncConverter" rather than the implementation type
