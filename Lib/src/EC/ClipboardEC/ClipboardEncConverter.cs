...
namespace ClipboardEC
{
	...
	public class FormClipboardEncConverter : System.Windows.Forms.Form
	{
		...
		public const string  cstrProjectMemoryKey = @"SOFTWARE\SIL\SilEncConverters31\ClipboardEC";
		...
		static private string strInstallerLocationRegKey    = @"SOFTWARE\SIL\SilEncConverters31\Installer";
		static private string strInstallerPathKey           = "InstallerPath";
		static private string strSetupSCExe                 = @"\SetupSC.exe";
