...
namespace SIL.LCModel.DomainImpl
{
	...
	/// ----------------------------------------------------------------------------------------
	[TestFixture]
	public class ScriptureTests: ScrInMemoryLcmTestBase
	{
		...
		public void TestCreateAnnotationResponse()
		{
			...
			ILcmOwningSequence<IScrScriptureNote> genesisNotes = m_scr.BookAnnotationsOS[0].NotesOS;
		...
		public void CreateScriptureCreatesBookAnnotations()
		{
			...
			ILcmOwningSequence<IScrBookAnnotations> bookNotes = Cache.LangProject.TranslatedScriptureOA.BookAnnotationsOS;
		...
		public void SavedVersion_TestFootnoteOrder()
		{
			...
			ILcmOwningSequence<IStPara> s2Paras = revSection2.ContentOA.ParagraphsOS;
		...
		{
			var ui = (DummyLcmUI) Cache.ServiceLocator.GetInstance<ILcmUI>();
			ui.Reset();
			...
			ILcmOwningSequence<IStPara> s1Paras = revision.SectionsOS[0].ContentOA.ParagraphsOS;
		...
		public void SavedVersion_TestBtFootnotes()
		{
			...
			ILcmOwningSequence<IScrFootnote> revFootnotes = revPhilemon.FootnotesOS;
			...
			LcmTestHelper.VerifyBtFootnote(revFootnotes[0], revTitle, ws, 25);
			LcmTestHelper.VerifyBtFootnote(revFootnotes[1], revSectionHead, ws, 0);
			LcmTestHelper.VerifyBtFootnote(revFootnotes[2], revPara1, ws, 4);
			LcmTestHelper.VerifyBtFootnote(revFootnotes[3], revPara2, ws, 0);
			LcmTestHelper.VerifyBtFootnote(revFootnotes[4], revPara2, ws, 25);
		}
	...
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Tests of Scripture.FindCorrespondingVernParaForSegment method.
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	[TestFixture]
	public class FindCorrespondingVernParaForSegmentTests: ScrInMemoryLcmTestBase
	{
		#region Data members
