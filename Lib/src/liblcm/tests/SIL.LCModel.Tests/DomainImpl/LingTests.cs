...
namespace SIL.LCModel.DomainImpl
{
	...
	public class MorphologyTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		/// the required type.
		/// </summary>
		IMoInflAffixSlot MakeSlot(ILcmServiceLocator services, ILcmOwningCollection<IMoInflAffixSlot> dest, Guid slotType)
		{
	...
	public class LingTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		public void MergeEntryMSAs()
		{
			...
			ILcmOwningSequence<ICmPossibility> posSeq = Cache.LangProject.PartsOfSpeechOA.PossibilitiesOS;
		...
		IPartOfSpeech CreatePartOfSpeech(ILcmOwningSequence<ICmPossibility> owningSeq,
