...
namespace SIL.LCModel.DomainServices.DataMigration
{
	...
	{
		readonly string kguidLexTypIrregInflectionVar = LexEntryTypeTags.kguidLexTypIrregInflectionVar.ToString();
		/// <summary>(Deprecated. See LexEntryInflTypeTags.) Plural Variant item in LexEntry Types list</summary>
		readonly string kguidLexTypPluralVar = LexEntryTypeTags.kguidLexTypPluralVar.ToString();
		/// <summary>(Deprecated. See LexEntryInflTypeTags.) Past Variant item in LexEntry Types list</summary>
		readonly string kguidLexTypPastVar = LexEntryTypeTags.kguidLexTypPastVar.ToString();
