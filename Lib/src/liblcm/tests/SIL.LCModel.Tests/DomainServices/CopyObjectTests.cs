...
namespace SIL.LCModel.DomainServices
{
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Tests for CopyObject LCM domain service. All of the following tests test the method
	/// CloneLcmObjects in DomainServices.CopyObject (which is a static object).
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	[TestFixture]
	public class CopyObjectTests : MemoryOnlyBackendProviderRestoredForEachTestTestBase
	{
		...
		/// <summary>
		/// Test CloneLcmObjects for (owned) IStTxtPara
		/// </summary>
		[Test]
		public void CopyParagraph()
		{
			...
			// SUT
			var newPara = CopyObject<IStTxtPara>.CloneLcmObject(srcObj, x => m_stTxt.ParagraphsOS.Add(x));
		...
		/// <summary>
		/// Test CloneLcmObjects for owned DsConstChart
		...
		public void CopyConstChart()
		{
			...
			// SUT
			var newChart = CopyObject<IDsConstChart>.CloneLcmObject(srcObj,
		...
		/// <summary>
		/// Test CloneLcmObjects for unrelated collection of LCM Objects
		/// </summary>
		[Test]
		public void CopySeveralObjects_unrelated()
		{
			...
			// SUT
			var newCollection = CopyObject<ICmObject>.CloneLcmObjects(source,
		...
		/// <summary>
		/// Test CloneLcmObjects for inter-related collection of LCM Objects
		...
		public void CopySeveralObjects_interrelated()
		{
			...
			// SUT
			var copyColl = CopyObject<ICmObject>.CloneLcmObjects(source,
