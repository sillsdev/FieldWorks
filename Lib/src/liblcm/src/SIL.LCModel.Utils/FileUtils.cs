...
namespace SIL.LCModel.Utils
{
	...
	public static class FileUtils
	{
		...
		/// </summary>
		internal static string ProduceCaseInsenstiveCombinationsFromMultipleTokens(string input)
		{
		...
		/// </summary>
		internal static string ProduceCaseInsenstiveCombinations(string input)
		{
			StringBuilder output = new StringBuilder();
		...
		/// </remarks>
		internal static string ApplyCaseByBinary(string input, int caseSpecification)
		{
