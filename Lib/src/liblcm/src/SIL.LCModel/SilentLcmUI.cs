...
{
	/// <summary>
	/// Silent implementation of LcmUserAction with reasonable defaults for
	/// actions which should not require user intervention
	/// </summary>
	public class SilentLcmUI : ILcmUI
	{
		private readonly ISynchronizeInvoke m_synchronizeInvoke;

		/// <summary>
		/// Initializes a new instance of the <see cref="SilentLcmUI"/> class.
		/// </summary>
		/// <param name="synchronizeInvoke">The synchronize invoke.</param>
		public SilentLcmUI(ISynchronizeInvoke synchronizeInvoke)
		{
