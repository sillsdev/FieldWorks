...
// Add additional methods/properties to domain object in InterfaceAdditions.cs.
// Add new interfaces to the InterfaceDeclarations file.
namespace SIL.LCModel
{
	#region ILcm Interfaces
	/// <summary>
	/// Interface for the two types of LCM vector classes (sets and collections).
	/// </summary>
	public interface ILcmVector
	{
		/// <summary>
	...
	/// <summary>
	/// Internal interface that supports persistence for LCM vectors.
	/// </summary>
	internal interface ILcmVectorInternal
	{
		/// <summary>
	...
	/// <summary>
	/// Internal interface implemented by LcmSet and LcmList that allows a special
	/// Clear() operation needed during object deletion.
	/// </summary>
	internal interface ILcmClearForDelete
	{
		/// <summary>
	...
	/// <summary>
	/// Interface for the sort of Replace that ILcmSet handles. It used to be part of that interface,
	...
	///<summary>
	/// Interface for LCM unordered sets (collection properties)
	///</summary>
	///<typeparam name="T"></typeparam>
	public interface ILcmSet<T> : ICollection<T>, ILcmVector, IReplaceInSet
	...
	public interface ILcmOwningCollection<T> : ILcmSet<T>
		where T : class, ICmObject
	{
	}
	...
	/// </summary>
	/// <typeparam name="T"></typeparam>
	internal interface ILcmOwningCollectionInternal<T>
		where T : class, ICmObject
	{
		/// <summary>
	...
	/// </summary>
	/// <typeparam name="T">Some kind of CmObject class.</typeparam>
	public interface ILcmReferenceCollection<T> : ILcmSet<T>
		where T : class, ICmObject
	{
		...
		/// <returns></returns>
		bool IsEquivalent(ILcmReferenceCollection<T> other);
		...
		/// ------------------------------------------------------------------------------------
		void AddTo(ILcmSet<T> dest);
	}

	///<summary>
	/// Interface for LCM ordered lists (sequence properties)
	///</summary>
	///<typeparam name="T"></typeparam>
	public interface ILcmList<T> : IList<T>, ILcmVector
		where T : class, ICmObject
	{
		/// ------------------------------------------------------------------------------------
		/// <summary>
	...
	/// </summary>
	/// <typeparam name="T">Some kind of CmObject class.</typeparam>
	public interface ILcmOwningSequence<T> : ILcmList<T>
		where T : class, ICmObject
	{
		/// ------------------------------------------------------------------------------------
		/// <summary>
		...
		/// ------------------------------------------------------------------------------------
		void MoveTo(int iStart, int iEnd, ILcmOwningSequence<T> seqDest, int iDestStart);
	}
	...
	/// </summary>
	/// <typeparam name="T"></typeparam>
	internal interface ILcmOwningSequenceInternal<T>
		where T : class, ICmObject
	{
		/// <summary>
		/// Remove an object without deleting it.
	...
	/// </summary>
	/// <typeparam name="T">Some kind of CmObject class.</typeparam>
	public interface ILcmReferenceSequence<T> : ILcmList<T>
		where T : class, ICmObject
	{
		/// ------------------------------------------------------------------------------------
		/// <summary>
		...
		/// ------------------------------------------------------------------------------------
		void CopyTo(ILcmList<T> dest, int destIndex);
	}
	#endregion
	...
	#region ILcmFactory interfaces
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Interface for internal methods defined on factories.
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	internal interface ILcmFactoryInternal
	{
		/// ------------------------------------------------------------------------------------
		/// <summary>
	...
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public interface ILcmFactory<T> where T : ICmObject
	{
		/// <summary>
		/// Basic creation method for an ICmObject.
		/// </summary>
	...
	/// <summary>
	/// Extend the regular ICmObject to add methods useful inside the LCM assembly,
	...
	internal interface ICmObjectInternal : ICmObject
	{
		...
		void InitializeNewOwnerlessCmObject(LcmCache cache);
		...
		/// </remarks>
		void InitializeNewCmObject(LcmCache cache, ICmObject owner, int owningFlid, int ord);

		/// <summary>
		/// This method checks the core validity of a CmObject.
		/// It checks the LcmCache and the Hvo, to make sure they are usable.
		/// </summary>
		...
		/// <summary>
		/// Delete the object.
		/// Should only be called by the LCM cache or the vector code!
		...
		/// </summary>
		void LoadFromDataStore(LcmCache cache, XElement reader, LoadingServices loadingServices);
	...
	public class SaveEventArgs : EventArgs
	{
		...
		/// </summary>
		public LcmCache Cache { get; internal set; }
	}
	#endregion
	...
	#region Interface IStoresLcmCache
	/// <summary>
	/// This interface is common to objects which can be initialized with an LcmCache.
	/// </summary>
	public interface IStoresLcmCache
	{
		/// <summary>
	...
	#endregion Interface IStoresLcmCache
	...
	{
		/// <summary>
		/// This allows the GetHvoFromObjectOrId method of BackendProvider to be implemented as a virtual method
		/// call rather than a mess of "if X is Y...."
		/// </summary>
		int GetHvo(IdentityMap map);
	}
	...
	/// <summary>
	/// This interface represents various writing systems in LCM.
	/// </summary>
