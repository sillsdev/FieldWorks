...
#foreach( $prop in $class.AtomicProperties )
				case $prop.Number:
					lock (SyncRoot)
						...
						return $prop.NiuginianPropName == null ? LcmCache.kNullHvo : ${prop.NiuginianPropName}.Hvo;
#else
						return m_$prop.NiuginianPropName == null ? LcmCache.kNullHvo : ${prop.NiuginianPropName}.Hvo;
#end
#end
			}
		}
