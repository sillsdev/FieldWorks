...
namespace SIL.LCModel.DomainServices.BackupRestore
{
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Settings used to restore a LCM project from a backup. Used by the retore project presenter,
	...
	public class RestoreProjectSettings : BackupSettings
	{
		...
		public bool UsingSendReceive
		{
			get
			{
				var otherRepoPath = Path.Combine(ProjectPath, LcmFileHelper.OtherRepositories);
