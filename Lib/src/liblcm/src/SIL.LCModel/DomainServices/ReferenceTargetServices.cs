...
namespace SIL.LCModel.DomainServices
{
	...
	public class ReferenceTargetServices
	{
		...
		/// </summary>
		public static ICmObject RnGenericRecReferenceTargetOwner(LcmCache cache, int flid)
		{
			switch (flid)
			{
		...
		/// </summary>
		public static ICmObject CmObjectReferenceTargetOwner(LcmCache cache, int flid)
		{
