...
namespace SIL.LCModel.DomainServices
{
	...
	public class WfiWordformServices
	{
		...
		public static IWfiWordform FindOrCreateWordform(LcmCache cache, ITsString tssContents)
		{
			IWfiWordform wf;
		...
		/// ------------------------------------------------------------------------------------
		public static IWfiWordform FindOrCreateWordform(LcmCache cache, string form, CoreWritingSystemDefinition ws)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public static void DisableVernacularSpellingDictionary(LcmCache cache)
		{
		...
		/// </summary>
		public static IPunctuationForm FindOrCreatePunctuationform(LcmCache cache, ITsString form)
		{
		...
		public static string FixDuplicates(LcmCache cache, IProgress progressBar)
		{
