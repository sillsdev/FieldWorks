...
namespace SIL.LCModel.DomainServices
{
	...
	public class ProjectLockingService
	{
		...
		/// </summary>
		public static void LockCurrentProject(LcmCache cache)
		{
		...
		/// </summary>
		public static void UnlockCurrentProject(LcmCache cache)
		{
		...
		public static bool CanLockProject(LcmCache cache)
		{
			var ds = cache.ServiceLocator.GetInstance<IDataStorer>() as XMLBackendProvider;
			if (ds != null)
				return false;
		...
		public static bool IsProjectLocked(string projectPath)
		{
			...
			return ext != null && ext.Equals(LcmFileHelper.ksFwDataXmlFileExtension, StringComparison.InvariantCultureIgnoreCase)
