...
namespace SIL.LCModel.Infrastructure
{
	...
	public interface IDataSetup : IDisposable
	{
		...
		/// </summary>
		/// <param name="projectId">Identifies the project to create.</param>
		/// <param name="sourceCache">The source LCM cache. (The source data store is already opened.)</param>
		void InitializeFromSource(IProjectIdentifier projectId, LcmCache sourceCache);
		...
		///// </remarks>
		//void PortLanguageProject(IProjectIdentifier projectId, LcmCache sourceCache, int portVersion);
