...
namespace SIL.LCModel.Infrastructure.Impl
{
	...
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Interface for undo actions which modify a property of an LCM object.
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	internal interface ILcmPropertyChanged : IUndoAction
	{
		/// <summary>
	...
	#region LcmStateChangeBase class
	/// <summary>
	...
	/// </summary>
	[ComVisible(true)]
	internal abstract class LcmStateChangeBase : IUndoAction
	{
		/// <summary>
		/// The changed object.
		/// </summary>
		...
		internal LcmStateChangeBase(ICmObject changedObject)
		{
		...
		internal abstract void AddToUnitOfWork(UnitOfWork uow);
	...
	#region LcmStateChangeObjectCreation class
	/// <summary>
	/// Undo Action for newly created CmObjects.
	/// </summary>
	internal class LcmStateChangeObjectCreation : LcmStateChangeBase, IFirstPassRedo
	{
		...
		internal LcmStateChangeObjectCreation(ICmObject newObject)
			: base(newObject)
		{
		...
		internal override void AddToUnitOfWork(UnitOfWork uow)
		{
	...
	#region LcmStateChangeObjectDeletion class
	/// <summary>
	/// Undo Action for deleted CmObjects.
	/// </summary>
	internal class LcmStateChangeObjectDeletion : LcmStateChangeBase, IFirstPassUndo
	{
		private readonly int m_previousHvo;
		private readonly LcmCache m_cache;
		...
		internal LcmStateChangeObjectDeletion(ICmObject deletedObject, string beforeStateXML)
			: base(deletedObject)
		{
	...
	internal static class ObjectRestoreService
	{
		...
		internal static void ResetBasics(IdentityMap identityMap, ICmObjectInternal obj, LcmCache cache, int newHvo)
		{
		...
		/// <param name="xml"></param>
		internal static void ResetFull(IdentityMap identityMap, ICmObjectInternal obj, LcmCache cache, int restoredHvo, string xml)
		{
			if (identityMap == null) throw new ArgumentNullException("identityMap");
			if (obj == null) throw new ArgumentNullException("obj");
	...
	#region LcmPropertyChangedBase class
	/// <summary>
	/// Base class for all CmObject property (of any kind) Undo Actions.
	/// </summary>
	internal abstract class LcmPropertyChangedBase : LcmStateChangeBase, ILcmPropertyChanged
	{
		/// <summary>
		/// The modified flid.
		/// </summary>
		...
		internal LcmPropertyChangedBase(ICmObject modifiedObject, int modifiedFlid)
			: base(modifiedObject)
		{
		...
		#region ILcmPropertyChanged members
		/// <summary>
		/// This may be overridden by subclasses that need to know whether the current state is undone
		/// (fForUndo true) or done/Redone (fForUndo false)
		/// </summary>
		...
		internal abstract void UpdateNewState(LcmPropertyChangedBase newChange);
		...
		internal override void AddToUnitOfWork(UnitOfWork uow)
		{
			...
			if (uow.IsModified(Object))
			{
				...
				LcmPropertyChangedBase earlierModAction;
	...
	#region LcmVirtualReferenceCollectionChangedAction class
	...
	internal class LcmVirtualReferenceCollectionChangedAction<T> : LcmPropertyChangedBase
	{
		private Func<IEnumerable<T>> m_reader;
		private HashSet<T> m_added;
		private HashSet<T> m_removed;
		public LcmVirtualReferenceCollectionChangedAction(ICmObject modifiedObject, int modifiedFlid,
		...
		/// </summary>
		/// <param name="newChange"></param>
		internal override void UpdateNewState(LcmPropertyChangedBase newChange)
		{
			var update = (LcmVirtualReferenceCollectionChangedAction<T>)newChange;
	...
	#region LcmPropertyChangedAction class
	/// <summary>
	...
	/// </remarks>
	internal abstract class LcmPropertyChangedAction<T> : LcmPropertyChangedBase
	{
		...
		internal LcmPropertyChangedAction(ICmObject modifiedObject, int modifiedFlid, T originalValue, T newValue)
			: base(modifiedObject, modifiedFlid)
		{
		...
		internal override void UpdateNewState(LcmPropertyChangedBase newChange)
		{
			m_newValue = ((LcmPropertyChangedAction<T>) newChange).m_newValue;
		}
	}
	#endregion

	#region LcmOwnerChanged class
	/// <summary>
	/// Supports Undo/Redo for modified owner when change is the result of moving object from
	/// one vector to another.
	/// </summary>
	internal class LcmOwnerChanged : LcmStateChangeBase
	{
		...
		internal LcmOwnerChanged(ICmObject modifiedObject, Guid originalOwner, int originalFlid, Guid newOwner, int newFlid) : base(modifiedObject)
		{
	...
	#region LcmVectorPropertyChanged class
	/// <summary>
	...
	/// </summary>
	internal class LcmVectorPropertyChanged : LcmPropertyChangedAction<Guid[]>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmVectorPropertyChanged(ICmObject modifiedObject, int modifiedFlid, Guid[] originalValue, Guid[] newValue)
		...
		#region Overrides of LcmPropertyChangedBase
	...
	#region LcmVectorVirtualChanged class
	/// <summary>
	...
	/// </summary>
	internal class LcmVectorVirtualChanged : LcmVectorPropertyChanged
	{
		internal LcmVectorVirtualChanged(ICmObject modifiedObject, int modifiedFlid, Guid[] originalValue, Guid[] newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	internal class LcmGuidPropertyChanged : LcmPropertyChangedAction<Guid>
	{
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmGuidPropertyChanged(ICmObject modifiedObject, int modifiedFlid, Guid originalValue, Guid newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmAtomicRefPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified Refernce atomic properties.
	/// </summary>
	internal class LcmAtomicRefPropertyChanged : LcmGuidPropertyChanged
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmAtomicRefPropertyChanged(ICmObject modifiedObject, int modifiedFlid, Guid originalValue, Guid newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmTsStringPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified ITsString strings.
	/// </summary>
	internal class LcmTsStringPropertyChanged : LcmPropertyChangedAction<ITsString>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmTsStringPropertyChanged(ICmObject modifiedObject, int modifiedFlid, ITsString originalValue, ITsString newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmTsStringVirtualChanged class
	/// <summary>
	/// This one is used for virtual property changes. These don't require Undoing or Redoing, and aren't considered data changes,
	/// but a PropChanged is needed.
	/// </summary>
	internal class LcmTsStringVirtualChanged : LcmTsStringPropertyChanged
	{
		internal LcmTsStringVirtualChanged(ICmObject modifiedObject, int modifiedFlid, ITsString originalValue, ITsString newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmMultiTsStringPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified multi-ITsString properties.
	/// </summary>
	internal class LcmMultiTsStringPropertyChanged : LcmPropertyChangedAction<ITsString>
	{
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmMultiTsStringPropertyChanged(ICmObject modifiedObject, int modifiedFlid, int ws, ITsString originalValue, ITsString newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
			m_ws = ws;
		}
	...
	#region LcmMultiTsStringVirtualChanged class
	/// <summary>
	/// This one is used for virtual property changes. These don't require Undoing or Redoing, and aren't considered data changes,
	/// but a PropChanged is needed.
	/// </summary>
	internal class LcmMultiTsStringVirtualChanged : LcmMultiTsStringPropertyChanged
	{
		internal LcmMultiTsStringVirtualChanged(ICmObject modifiedObject, int modifiedFlid, int ws, ITsString originalValue, ITsString newValue)
	...
	#region LcmTsTextPropsPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified ITsTextProps properties.
	/// </summary>
	internal class LcmTsTextPropsPropertyChanged : LcmPropertyChangedAction<ITsTextProps>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmTsTextPropsPropertyChanged(ICmObject modifiedObject, int modifiedFlid, ITsTextProps originalValue, ITsTextProps newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmStringPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified string (Unicode) properties.
	/// </summary>
	internal class LcmStringPropertyChanged : LcmPropertyChangedAction<string>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmStringPropertyChanged(ICmObject modifiedObject, int modifiedFlid, string originalValue, string newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmStringVirtualChanged class
	/// <summary>
	/// This one is used for virtual property changes. These don't require Undoing or Redoing, and aren't considered data changes,
	/// but a PropChanged is needed.
	/// </summary>
	internal class LcmStringVirtualChanged : LcmStringPropertyChanged
	{
		internal LcmStringVirtualChanged(ICmObject modifiedObject, int modifiedFlid, string originalValue, string newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmBooleanPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified boolean properties.
	/// </summary>
	internal class LcmBooleanPropertyChanged : LcmPropertyChangedAction<bool>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmBooleanPropertyChanged(ICmObject modifiedObject, int modifiedFlid, bool originalValue, bool newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmBooleanVirtualChanged class
	/// <summary>
	/// This one is used for virtual property changes. These don't require Undoing or Redoing, and aren't considered data changes,
	/// but a PropChanged is needed.
	/// </summary>
	internal class LcmBooleanVirtualChanged : LcmBooleanPropertyChanged
	{
		internal LcmBooleanVirtualChanged(ICmObject modifiedObject, int modifiedFlid, bool originalValue, bool newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmDateTimePropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified DateTime properties.
	/// </summary>
	internal class LcmDateTimePropertyChanged : LcmPropertyChangedAction<DateTime>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmDateTimePropertyChanged(ICmObject modifiedObject, int modifiedFlid, DateTime originalValue, DateTime newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmIntegerPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified GenDate and integer properties.
	/// </summary>
	internal class LcmIntegerPropertyChanged : LcmPropertyChangedAction<int>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmIntegerPropertyChanged(ICmObject modifiedObject, int modifiedFlid, int originalValue, int newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmIntegerVirtualChanged class
	/// <summary>
	/// This one is used for virtual property changes. These don't require Undoing or Redoing, and aren't considered data changes,
	/// but a PropChanged is needed.
	/// </summary>
	internal class LcmIntegerVirtualChanged : LcmIntegerPropertyChanged
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmIntegerVirtualChanged(ICmObject modifiedObject, int modifiedFlid, int originalValue, int newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmBinaryPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified Binary properties.
	/// </summary>
	internal class LcmBinaryPropertyChanged : LcmPropertyChangedAction<byte[]>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmBinaryPropertyChanged(ICmObject modifiedObject, int modifiedFlid, byte[] originalValue, byte[] newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmCustomPropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified custom properties.
	/// </summary>
	internal class LcmCustomPropertyChanged : LcmPropertyChangedAction<object>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmCustomPropertyChanged(ICmObject modifiedObject, int modifiedFlid, object originalValue, object newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmGenDatePropertyChanged class
	/// <summary>
	/// Supports Undo/Redo for modified GenDate properties.
	/// </summary>
	internal class LcmGenDatePropertyChanged : LcmPropertyChangedAction<GenDate>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="originalValue"></param>
		/// <param name="newValue"></param>
		internal LcmGenDatePropertyChanged(ICmObject modifiedObject, int modifiedFlid, GenDate originalValue, GenDate newValue)
			: base(modifiedObject, modifiedFlid, originalValue, newValue)
		{
		}
	...
	#region LcmStateChangeCustomFieldDefnModified class
	/// <summary>
	...
	/// </summary>
	internal class LcmStateChangeCustomFieldDefnModified : LcmStateChangeBase
	{
		public LcmStateChangeCustomFieldDefnModified(ICmObject changedObject, int modifiedFlid)
			: base(changedObject)
		{
		...
		internal override void AddToUnitOfWork(UnitOfWork uow)
		{
			if (uow.IsModified(Object))
			{
				...
				{
					var ua = uow.Changes[i] as LcmPropertyChangedBase;
