...
{
	/// <summary>
	/// This interface provides methods for notifying LCM of read operations on worker threads.
	/// This allows for proper synchronization of access to LCM. It is not necessary for the main
