...
{
	/// <summary>
	/// Implementation of the IFwMetaDataCacheManaged interface which works with a stateful LCM system for most data issues.
	...
	/// the LcmMetaDataCache (IFwMetaDataCacheManaged) for regular metadata access.
	/// </summary>
	public abstract class LcmMetaDataCacheDecoratorBase : IFwMetaDataCacheManaged
	{
		...
		/// Constructor.
		/// </summary>
		/// <param name="metaDataCache">The LCM LcmMetaDataCache implementation,
		...
		/// </remarks>
		protected LcmMetaDataCacheDecoratorBase(IFwMetaDataCacheManaged metaDataCache)
		{
