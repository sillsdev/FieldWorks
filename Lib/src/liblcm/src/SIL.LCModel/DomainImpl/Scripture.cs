...
namespace SIL.LCModel.DomainImpl
{
	...
	internal partial class Scripture : IScrProjMetaDataProvider, IPictureLocationBridge, IPropertyChangeNotifier
	{
		...
		/// assemblies</summary>
		public static System.Resources.ResourceManager Resources = ScrResources.ResourceManager;
		...
		public IScrBook CopyBookToCurrent(IScrBook book)
		{
			...
			IScrBook copiedBook = CopyObject<IScrBook>.CloneLcmObject(book,
	...
	internal partial class ScrDraft
	{
		...
		public IScrBook AddBookCopy(IScrBook book)
		{
			...
			IScrBook archivedBook = CopyObject<IScrBook>.CloneLcmObject(book, x => BooksOS.Insert(iInsert, x));
