...
namespace SIL.LCModel
{
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// Implementation of the IDisposable interface pattern for LcmCache.
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	public sealed partial class LcmCache : IDisposable
	{
		/// <summary>
		...
		/// <summary>
		/// Occurs when the LCM cached is getting disposed. This event is called at the beginning
