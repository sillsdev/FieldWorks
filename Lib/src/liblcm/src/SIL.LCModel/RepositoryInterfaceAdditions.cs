...
namespace SIL.LCModel
{
	...
	public partial interface ILexEntryRepository
	{
		...
		/// </summary>
		int HomographMorphOrder(LcmCache cache, IMoMorphType morphType);
		...
		/// <returns></returns>
		List<ILexEntry> FindEntriesForWordform(LcmCache cache, ITsString tssWf, IWfiAnalysis wfa, ref bool duplicates);
