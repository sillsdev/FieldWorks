...
namespace SIL.FieldWorks.Common.UIAdapters
{
	...
	public class TMAdapter : ITMAdapter, IDisposable
	{
		...
		// Stores the item on the Window menu that was last clicked by the user.
		protected ToolStripMenuItem m_windowListItemClicked = null;
		...
		public void Dispose()
		{
			...
			if (m_tsPanel != null)
				m_tsPanel.Parent = null;
			if (m_tsContainer != null)
				m_tsContainer.Parent = null;
	...
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	public class ToolStripItemExtender
	{
