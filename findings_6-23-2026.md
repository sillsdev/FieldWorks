...
### JIRA tickets filed for the deferrals (2026-06-24, project LT, type Improvement, labels `avalonia-migration`/`phase-1-followup`)
- **WIRE-01** → [LT-22582](https://jira.sil.org/browse/LT-22582) — flip-to-Legacy leaves Avalonia refresh listeners attached until Dispose
- **FP-01** → [LT-22583](https://jira.sil.org/browse/LT-22583) — morph-type stem↔affix conversion (legacy parity)
- **A11Y-01** → [LT-22584](https://jira.sil.org/browse/LT-22584) — dialog keyboard mnemonics (Alt access keys)
- **TEST-01** → [LT-22585](https://jira.sil.org/browse/LT-22585) — generate Avalonia `-after` parity images
Each ticket carries the problem, `file:line` evidence, the deferral rationale, and the proposed fix.
