...
HV_SRC=$(BUILD_ROOT)\Samples\HelloWorld\HelloView
HV_RES=$(BUILD_ROOT)\Samples\HelloWorld\HelloView\Res
...
UI=$(HV_SRC);$(HV_RES);$(GENERIC_SRC);$(AFCORE_SRC);$(AFCORE_RES);$(CELLAR_SRC);$(WIDGETS_SRC);$(VIEW_LIB_SRC)
...
RCFILE=HelloView.rc
LINK_LIBS= AfLib.lib Widgets.lib Generic.lib Version.lib HtmlHelp.lib atl.lib uuid.lib advapi32.lib kernel32.lib ole32.lib oleaut32.lib odbc32.lib xmlparse.lib $(LINK_LIBS)

# === Object Lists ===

OBJ_HW=\
	$(INT_DIR)\autopch\HelloView.obj\
...
$(INT_DIR)\$(RCFILE:.rc=.res): $(HV_RES)\*.h
$(INT_DIR)\$(RCFILE:.rc=.res): $(HV_RES)\*.rc
