...
HW_SRC=$(BUILD_ROOT)\Samples\HelloWorld\ActiveX
HW_RES=$(BUILD_ROOT)\Samples\HelloWorld\ActiveX\Res
...
UI=$(HW_SRC);$(HW_RES);$(GENERIC_SRC);$(AFCORE_SRC);$(AFCORE_RES);$(CELLAR_SRC);$(WIDGETS_SRC);$(VIEW_LIB_SRC)
...
OBJ_HW=\
	$(INT_DIR)\autopch\HelloWorld.obj\
	$(INT_DIR)\autopch\ModuleEntry.obj\

OBJ_ALL=$(OBJ_HW) $(OBJ_GENERIC)

# === Targets ===
BUILD_TARGETS=$(BUILD_TARGETS) $(OUT_DIR)\baluchi.wav

!INCLUDE "$(BUILD_ROOT)\bld\_targ.mak"

$(INT_DIR)\$(RCFILE:.rc=.res): $(HW_RES)\*.bmp
$(INT_DIR)\$(RCFILE:.rc=.res): $(HW_RES)\*.h
$(INT_DIR)\$(RCFILE:.rc=.res): $(HW_RES)\*.rc
$(INT_DIR)\$(RCFILE:.rc=.res): $(AFCORE_RES)\*.bmp
$(INT_DIR)\$(RCFILE:.rc=.res): $(AFCORE_RES)\*.h
$(INT_DIR)\$(RCFILE:.rc=.res): $(AFCORE_RES)\*.rc

$(OUT_DIR)\baluchi.wav: $(HW_SRC)\baluchi.wav
	$(DISPLAY) Copying $? to $@
	if exist "$?" $(COPYFILE) $(HW_SRC)\baluchi.wav $(OUT_DIR)
