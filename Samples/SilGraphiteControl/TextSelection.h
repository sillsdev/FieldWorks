...
class TextSelection: public ITextSelection
{
public:
	TextSelection();
	TextSelection(BSTR text);
	~TextSelection();
	STDMETHODIMP TypeText(BSTR bstr);
	STDMETHODIMP GetType(BSTR *pbstr);
	STDMETHODIMP EndKey(long Unit, long Extend, long *pDelta);
	STDMETHODIMP HomeKey(long Unit, long Extend, long *pDelta);
	STDMETHODIMP GetFlags(long *pFlags);
	STDMETHODIMP SetFlags(long Flags);
	STDMETHODIMP MoveUp(long Unit, long Count, long Extend,long *pDelta);
	STDMETHODIMP MoveDown(long Unit, long Count, long Extend, long *pDelta);
	STDMETHODIMP MoveRight(long Unit, long Count, long Extend, long *pDelta);
	STDMETHODIMP MoveLeft(long Unit, long Count, long Extend, long *pDelta);
