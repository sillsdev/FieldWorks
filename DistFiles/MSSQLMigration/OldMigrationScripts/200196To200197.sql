-- Update database from version 200196 to 200197
BEGIN TRANSACTION  --( will be rolled back if wrong version#)

-------------------------------------------------------------------------------
-- FDB-186 Update UpdateClassView$
-------------------------------------------------------------------------------
...
IF @dbVersion = 200196
BEGIN
	UPDATE Version$ SET DbVer = 200197
	COMMIT TRANSACTION
	PRINT 'database updated to version 200197'
END
ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200196 (DbVer = ' +
