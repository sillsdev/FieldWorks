-- Update database from version 200193 to 200194
BEGIN TRANSACTION  --( will be rolled back if wrong version#)

-------------------------------------------------------------------------------
-- FDB-185: Fix Field$ Delete Trigger
-------------------------------------------------------------------------------
...
IF @dbVersion = 200193
BEGIN
	UPDATE Version$ SET DbVer = 200194
	COMMIT TRANSACTION
	PRINT 'database updated to version 200194'
END
ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200193 (DbVer = ' +
