-- Update database from version 200203 to 200204
BEGIN TRANSACTION  --( will be rolled back if wrong version#)


-------------------------------------------------------------------------------
-- LT-8002: Fix DefineCreateProc$
-------------------------------------------------------------------------------
...
IF @dbVersion = 200203
BEGIN
	UPDATE Version$ SET DbVer = 200204
	COMMIT TRANSACTION
	PRINT 'database updated to version 200204'
END
ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200203 (DbVer = ' +
