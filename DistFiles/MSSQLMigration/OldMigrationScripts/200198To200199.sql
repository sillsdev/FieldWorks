-- Update database from version 200198 to 200199
BEGIN TRANSACTION  --( will be rolled back if wrong version#)

-------------------------------------------------------------------------------
-- LT-7465, LT-7297: Fix Lex Entry Find when no lexeme form exists
-------------------------------------------------------------------------------
...
IF @dbVersion = 200198
BEGIN
	UPDATE Version$ SET DbVer = 200199
	COMMIT TRANSACTION
	PRINT 'database updated to version 200199'
END
ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200198 (DbVer = ' +
