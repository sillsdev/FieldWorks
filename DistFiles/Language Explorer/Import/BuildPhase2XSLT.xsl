...
<!-- xsl:preserve-space elements="lx gl ex "/-->
	  ...
	  <sfm:template
		match=" Sense | Example | ExampleTranslation | Function | Subentry | Variant | Etymology | Picture | Pronunciation | SemanticDomain | ExtendedNote | ExtendedNoteExample | ExtendedNoteExampleTranslation">
