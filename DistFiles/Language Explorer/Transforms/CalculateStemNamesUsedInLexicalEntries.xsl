...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="sAllStemNamesUsedInLexicalEntries">
		<xsl:for-each select="$LexEntries">
			...
			<xsl:variable name="stemallos" select="//MoStemAllomorph[@Id=$allos/@dst and @IsAbstract='0' and @MorphType!=$sPhrase and @MorphType!=$sDiscontiguousPhrase and @StemName!='0']"/>
