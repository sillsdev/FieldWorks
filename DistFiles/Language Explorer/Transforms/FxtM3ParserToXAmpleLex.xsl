...
\lx </xsl:text>
			   ...
			   <xsl:apply-templates select="$MoStemMsas[@Id=$thisMsa] | $MoInflAffMsas[@Id=$thisMsa] | $MoDerivAffMsas[@Id=$thisMsa] | $MoUnclassifiedAffixMsas[@Id=$thisMsa]">
...
\mp </xsl:text>
		 ...
		 <xsl:variable name="stemallos" select="$MoStemAllomorphs[@Id=$allos/@dst and @IsAbstract='0' and @MorphType!=$sDiscontiguousPhrase and @StemName!='0']"/>
