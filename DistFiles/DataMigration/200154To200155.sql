-- update database FROM version 200154 to 200155
...
IF @dbVersion = 200154
BEGIN
	UPDATE [Version$] SET [DbVer] = 200155
	COMMIT TRANSACTION
	PRINT 'database updated to version 200155'
END

ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200154 (DbVer = ' +
