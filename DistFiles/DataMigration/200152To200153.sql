-- update database FROM version 200152 to 200153
BEGIN TRANSACTION  --( will be rolled back if wrong version#)

-------------------------------------------------------------------------------
-- SetAgentEval had conflicting locking hints. Took readuncommitteds out.
-------------------------------------------------------------------------------
...
IF @dbVersion = 200152
BEGIN
	UPDATE [Version$] SET [DbVer] = 200153
	COMMIT TRANSACTION
	PRINT 'database updated to version 200153'
END

ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200152 (DbVer = ' +
