-- Update database from version 200048 to 200049
BEGIN TRANSACTION  --( will be rolled back if wrong version#

---------------------------------------------------------------------
-- Once more, with feeling...FDB-94: Make sure custom fields drop to
...
'
	...
	IF LEN(@sDynSQLCustomParamList) != 0
...
if @dbVersion = 200048
begin
	update Version$ set DbVer = 200049
	COMMIT TRANSACTION
	print 'database updated to version 200049'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200048 (DbVer = ' +
