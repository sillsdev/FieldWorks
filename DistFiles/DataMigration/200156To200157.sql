-- update database FROM version 200156 to 200157
BEGIN TRANSACTION  --( will be rolled back if wrong version#)

-------------------------------------------------------------------------------
-- Migration from 200152To200153 had a constant in SetAgentEval.
-------------------------------------------------------------------------------
...
IF @dbVersion = 200156
BEGIN
	UPDATE [Version$] SET [DbVer] = 200157
	COMMIT TRANSACTION
	PRINT 'database updated to version 200157'
END

ELSE
BEGIN
	ROLLBACK TRANSACTION
	PRINT 'Update aborted: this works only if DbVer = 200156 (DbVer = ' +
