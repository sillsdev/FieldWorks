-- update database from version 200025 to 200026
...
if @dbVersion = 200025
begin
	update Version$ set DbVer = 200026
	COMMIT TRANSACTION
	print 'database updated to version 200026'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200025 (DbVer = ' +
