-- update database FROM version 200136 to 200137
BEGIN TRANSACTION  --( will be rolled back if wrong version#

-------------------------------------------------------------------------------
-- Make sure that the Field$ delete trigger rebuilds the class delete trigger.
-------------------------------------------------------------------------------
...
if @dbVersion = 200136
begin
	UPDATE Version$ SET DbVer = 200137
	COMMIT TRANSACTION
	print 'database updated to version 200137'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200136 (DbVer = ' +
