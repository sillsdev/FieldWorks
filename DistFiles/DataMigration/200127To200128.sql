-- update database FROM version 200127 to 200128
BEGIN TRANSACTION  --( will be rolled back if wrong version#

-- (LT-3510) Result of GetMultiTableName needs to go in NVARCHAR(60); 40 is too small for one field.
...
if @dbVersion = 200127
begin
	UPDATE Version$ SET DbVer = 200128
	COMMIT TRANSACTION
	print 'database updated to version 200128'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200127 (DbVer = ' +
