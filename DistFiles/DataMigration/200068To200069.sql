-- Update database from version 200068 to 200069
BEGIN TRANSACTION  --( will be rolled back if wrong version#)
---------------------------------------------------------------------

-- Fixed problem in 200067 to 200068 migration
...
if @dbVersion = 200068
begin
	update Version$ set DbVer = 200069
	COMMIT TRANSACTION
	print 'database updated to version 200069'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200068 (DbVer = ' +
