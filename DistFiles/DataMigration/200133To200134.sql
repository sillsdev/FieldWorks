-- update database FROM version 200133 to 200134
...
if @dbVersion = 200133
begin
	UPDATE Version$ SET DbVer = 200134
	COMMIT TRANSACTION
	print 'database updated to version 200134'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200133 (DbVer = ' +
