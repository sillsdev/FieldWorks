-- update database from version 200031 to 200032
BEGIN TRANSACTION  --( will be rolled back if wrong version#


-------------------------------------------------------------
-- Updated SP from LingSP.sql to allow for caseless comparison for vernacular strings.
-------------------------------------------------------------
...
if @dbVersion = 200031
begin
	update Version$ set DbVer = 200032
	COMMIT TRANSACTION
	print 'database updated to version 200032'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200031 (DbVer = ' +
