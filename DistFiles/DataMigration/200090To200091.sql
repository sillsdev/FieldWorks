-- Update database from version 200090 to 200091
 ...
 **********************************************************************************************/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CopyObj$]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CopyObj$]
GO
...
if @dbVersion = 200090
begin
	update Version$ set DbVer = 200091
	COMMIT TRANSACTION
	print 'database updated to version 200091'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200090 (DbVer = ' +
