-- Update database from version 200079 to 200080
...
if @dbVersion = 200079
begin
	update Version$ set DbVer = 200080
	COMMIT TRANSACTION
	print 'database updated to version 200080'
end
else
begin
	ROLLBACK TRANSACTION
	print 'Update aborted: this works only if DbVer = 200079 (DbVer = ' +
