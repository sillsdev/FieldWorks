...
1. This defaults to UTF-8, which is readable by Toolbox and some other applications. If desired, you can change the output encoding below from UTF-8 to any of the following:
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:silfw="http://fieldworks.sil.org/2002/silfw/Codes" xmlns:user="http://mycompany.com/mynamespace" exclude-result-prefixes="silfw">
	<silfw:file title="Standard format - Toolbox (*.db) -- UTF-8" outputext="db" description="Converts FwExport format to Standard format UTF-8" views="dataentry document"/>
