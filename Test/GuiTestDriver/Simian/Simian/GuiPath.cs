...
namespace Simian
{
	public class GuiPath
	{
		...
		/// <summary>
		/// Checks validity of this GuiPath.
		/// </summary>
		/// <returns>true if the path is valid.</returns>
		public bool isValid()
		{   // These cases indicate whether or not it is valid
			if (count() > 0) return true;
			if (Role == AccessibleRole.None) return false;
			if (Name.Equals("") && Role == AccessibleRole.Alert) return true;
