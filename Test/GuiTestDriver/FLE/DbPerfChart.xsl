...
<body>
  <h1><xsl:value-of select="$dataBase"/> Db FLEx <span style="font-size:16pt">Performance from
...
<svg:svg width="6in" height="4in" viewBox="0 0 600 400" contentScriptType = "text/ecmascript" xmlns="http://www.w3.org/2000/svg">
 ...
 <xsl:apply-templates select="$actions" mode="path"/>
  ...
  <table border="1">
  <tr><td align="center">All times in seconds</td><td align="center">Min</td><td align="center">Ave</td><td align="center">Max</td><td align="center">Range</td><td align="center">StDev</td><td align="center">Zalue</td></tr>
