...
<?xml-stylesheet type="text/xsl" href="UpdateTimes1Sena3Db.xsl"?>
...
<xsl:output method="xml" encoding="UTF-8" indent="yes" standalone="yes" />
  ...
  <xsl:variable name="log-files">
	 <log>C:\fw\Test\GuiTestDriver\TeScripts\aExportOxes.xlg</log>
	 <log>C:\fw\Test\GuiTestDriver\TeScripts\aImportOxes.xlg</log>
  </xsl:variable>
