...
SET Fwte_FW60_Bld=1
SET Fwte_Branch_Bld=0
SET Fwte_Trunk_Bld=0
SET Fwte_Dallas_Bld=0
SET Fwte_Downloads_Bld=0
SET Fwte_Nightly_Bld=0
...
IF %Install_and_Run_All_Tests% EQU 1 (GOTO StartInstallAndRunAllTests)
IF %Install_New_TE_Only% EQU 1 (GOTO StartInstallNewTEOnly)

REM =====  Test_OtherSF  =====
IF %Test_OtherSF% EQU 0 (GOTO EndTestOtherSF)
SET CreateProjSF=1
SET Run_OtherSF_Test_Cases=1
::SET OtherSF_Test_Cases=2,10,11,16,24,30,31,38
...
SET CreateProj5=1
SET Run_PT5_Test_Cases=5
::SET PT5_Test_Cases=4,9
SET PT5_Test_Cases=3
:EndTestPT5
...
SET PT5_BT_Test_Cases=5
::SET PT5_BT_Test_Cases=7,20,33,34,56,74,79
:EndTestPT5BT
...
::SET PT6_BT_Test_Cases=56,74,75
SET PT6_BT_Test_Cases=5
...
IF %Fwte_FW60_Bld% EQU 1 (
	CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "Copy the latest FW_6_0 build"
	copy \\jar-file\SilLangSoft\FW_6_0\FieldWorks\SetupFW.msi c:\)
...
IF %Fwte_Downloads_Bld% EQU 1 (
	CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "Copy the latest 'My Downloads' build"
	copy "D:\Personal\My Downloads\SetupFW.msi" c:\)

IF %Fwte_Nightly_Bld% EQU 1 (
	CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "Copy the latest 'My Downloads' build"
	copy "\\jar-file\SilLangSoft\NightlyBuild\FieldWorks\SetupFW.msi" c:\)
...
del "C:\Documents and Settings\All Users\Application Data\SIL\FieldWorks\Data\MALVI OTHERSF IMPORT TEST*.*"
...
IF %Install_New_TE_Only% EQU 1 (GOTO FinalEnd)

REM ######### Delete OLD Result Files  ##########

REM - Delete the old result files
del/q "C:\GuiTestResults\ImportOtherSF\*.*"
del/q "C:\GuiTestResults\ImportParatext5\*.*"
del/q "C:\GuiTestResults\ImportParatext5BT\*.*"
del/q "C:\GuiTestResults\ImportParatext6\*.*"
del/q "C:\GuiTestResults\ImportParatext6BT\*.*"
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Create_OtherSF_Project" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\ImportOtherSF_CreateBaseProj.log"
...
REM If Test Case Number is Less Than 10
	IF %%t LSS 10 (
		CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "Test_Case_%%t"

		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF\TestCase0%%t.log"
...
REM If Test Case Number is Greater Than or Equal to 10
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %OtherSF_TEST_FAILURES%
			ECHO Test_Case_%%t >> %OtherSF_TEST_FAILURES%
			set /a OtherSF_Failures = OtherSF_Failures + 1
		)
	)
)
...
REM If Test Case Number is Less Than 10
	IF %%t LSS 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF_BT\TestCase0%%t.log"
...
REM If Test Case Number is Greater Than or Equal to 10
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF_BT\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\OtherSF_BT\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %OtherSF_BT_TEST_FAILURES%
			ECHO Test_Case_%%t >> %OtherSF_BT_TEST_FAILURES%
			set /a OtherSF_BT_Failures = OtherSF_BT_Failures + 1
		)
	)
)
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Create_PT_Project" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\ImportPT5_CreateBaseProject.log"
...
REM If Test Case Number is Less Than 10
	IF %%t LSS 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5\TestCase0%%t.log"
...
REM If Test Case Number is Greater Than or Equal to 10
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %Ipt5_TEST_FAILURES%
			ECHO Test_Case_%%t >> %Ipt5_TEST_FAILURES%
			set /a PT5_Failures = PT5_Failures + 1
		)
	)
)
...
for %%t in (%PT5_BT_Test_Cases%) do (
	...
	IF %%t LSS 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5BT\TestCase0%%t.log"
...
REM If Test Case Number is Greater Than or Equal to 10
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5BT\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt5BT\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %Ipt5BT_TEST_FAILURES%
			ECHO Test_Case_%%t >> %Ipt5BT_TEST_FAILURES%
			set /a PT5_BT_Failures = PT5_BT_Failures + 1
		)
	)
)
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Create_PT_Project" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\ImportPT6_CreateBaseProject.log"
...
for %%t in (%PT6_Test_Cases%) do (
	...
	IF %%t LSS 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6\TestCase0%%t.log"
	...
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %Ipt6_TEST_FAILURES%
			ECHO Test_Case_%%t >> %Ipt6_TEST_FAILURES%
			set /a PT6_Failures = PT6_Failures + 1
		)
	)
)
...
for %%t in (%PT6_BT_Test_Cases%) do (
	...
	IF %%t LSS 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6BT\TestCase0%%t.log"
	...
	IF %%t GEQ 10 (
		...
		"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Test_Case_%%t" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6BT\TestCase%%t.log"

		FIND ", Failures: 0," "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Ipt6BT\TestCase%%t.log" >NUL
		IF ERRORLEVEL 1 (
			CALL "C:\Documents and Settings\%user%\Desktop\ECHO_LOG.bat" %TEST_PROCESSING_MSGS% "* Failed *"
			ECHO. >> %Ipt6BT_TEST_FAILURES%
			ECHO Test_Case_%%t >> %Ipt6BT_TEST_FAILURES%
			set /a PT6_BT_Failures = PT6_BT_Failures + 1
		)
	)
)
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Create_Pt_Restore_Project" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\RestorePT6_CreateBaseProject.log"
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Restore_Options_Replace_Version" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Pt6RestoreOptReplaceVer.log"
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Restore_Options_Seperate_Database" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\Pt6RestoreOptSeperateDb.log"
...
"C:\PROGRAM FILES\NUnit 2.4.5\bin\nunit-console" "C:\PROGRAM FILES\SIL\FieldWorks\TE_Tests.dll" "/include:Roundtrip_Export_Import_Compare" >> "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\RndTripExpImpCompare.log"
...
REM - Create the new GuiTestResults folder for permanently storing the export output files
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults"

REM - Copy the result files into the new GuiTestResults sub-folders for safe keeping
REM - Delete any GuiTestResults sub-folders if they are empty
IF %Run_OtherSF_Test_Cases% EQU 1 (
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportOtherSF"
copy "C:\GuiTestResults\ImportOtherSF\*.*" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportOtherSF\"
"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportOtherSF")

IF %Run_PT5_Test_Cases% EQU 1 (
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5"
copy "C:\GuiTestResults\ImportParatext5\*.*" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5\"
"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5")

IF %Run_PT5_BT_Test_Cases% EQU 1 (
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5BT"
copy "C:\GuiTestResults\ImportParatext5BT\*.*" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5BT\"
"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext5BT")

IF %Run_PT6_Test_Cases% EQU 1 (
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6"
copy "C:\GuiTestResults\ImportParatext6\*.*" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6\"
"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6")

IF %Run_PT6_BT_Test_Cases% EQU 1 (
md "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6BT"
copy "C:\GuiTestResults\ImportParatext6BT\*.*" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6BT\"
"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults\ImportParatext6BT")

REM - For some reason, this next line does not work ???
::"C:\Documents and Settings\JonesT\Desktop\DelEmptyDir" "C:\Documents and Settings\%user%\Desktop\Tests Results\%yymmdd_hhmmss%\GuiTestResults"
