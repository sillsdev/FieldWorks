...
preference, follow it and say so. The script decides where worktrees go -- read
it rather than trusting a path written here, and match what `git worktree list`
already shows.
