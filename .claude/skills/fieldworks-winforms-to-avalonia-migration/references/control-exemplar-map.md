...
| BaseGoDlg/EntryGoDlg family (Go, Merge, Link*, AddAllomorph) | EntryGo kit + per-consumer launcher | `Src/Common/FwAvaloniaDialogs/EntryGoDialog*`; dependent auxiliary picker: dialog-conversion.md §2c; WS-aware search box: §2d |
