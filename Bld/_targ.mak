...
!IF "$(BUILD_OUTPUT)"==""
CL_OPTS_PS=/c /Ox /W0 /I"$(BUILD_ROOT)\Output\Common\Raw" /I"$(COM_OUT_DIR_RAW)" $(CL_OPTS_PS) /DWIN64 /D_WIN64_WINNT=0x0500 /DREGISTER_PROXY_DLL
!ELSE
CL_OPTS_PS=/c /Ox /W0 /I"$(BUILD_OUTPUT)\Common\Raw" /I"$(COM_OUT_DIR_RAW)" $(CL_OPTS_PS) /DWIN64 /D_WIN64_WINNT=0x0500 /DREGISTER_PROXY_DLL
!ENDIF
!ENDIF
