...
$(PS_DLL_MAIN): $(PS_H_MAIN) $(PS_DEF_MAIN) $(PS_OBJ)
	link /dll /out:$(PS_DLL_MAIN) /def:$(PS_DEF_MAIN) $(LINK_OPTS_PS) /entry:DllMain /implib:$(COM_INT_DIR)\$(PS_MAIN).lib $(PS_OBJ) $(PS_OBJ_DEPS) kernel32.lib rpcns4.lib rpcrt4.lib oleaut32.lib uuid.lib ole32.lib
