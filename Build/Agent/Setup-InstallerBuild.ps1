...
$installerProject = Join-Path $repoRoot "FLExInstaller\wix6\FieldWorks.Installer.wixproj"
$bundleProject = Join-Path $repoRoot "FLExInstaller\wix6\FieldWorks.Bundle.wixproj"
...
$heatFromRepoPackages = Join-Path $repoRoot "packages\wixtoolset.heat\6.0.2\tools\net472\x64\heat.exe"
