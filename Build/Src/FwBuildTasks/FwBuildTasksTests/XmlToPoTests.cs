...
namespace SIL.FieldWorks.Build.Tasks.FwBuildTasksTests
{
	...
	public class XmlToPoTests
	{
		...
		{
			var result = XmlToPo.ComputeAutoCommentFilePath(
				@"E:\fwrepo/fw\DistFiles",
				@"E:\fwrepo\fw\DistFiles\Language Explorer\DefaultConfigurations\Dictionary\Hybrid.fwdictconfig"
			);
			Assert.That(
				result,
				Is.EqualTo(
					@"/Language Explorer/DefaultConfigurations/Dictionary/Hybrid.fwdictconfig"
				)
			);

			result = XmlToPo.ComputeAutoCommentFilePath(
				@"C:\fwrepo\fw\DistFiles",
				@"E:\fwrepo\fw\DistFiles\Language Explorer\DefaultConfigurations\Dictionary\Hybrid.fwdictconfig"
			);
			Assert.That(
				result,
			...
			result = XmlToPo.ComputeAutoCommentFilePath(
				"/home/steve/fwrepo/fw/DistFiles",
				"/home/steve/fwrepo/fw/DistFiles/Language Explorer/Configuration/Parts/LexEntry.fwlayout"
			);
			Assert.That(
				result,
				Is.EqualTo("/Language Explorer/Configuration/Parts/LexEntry.fwlayout")
			);

			result = XmlToPo.ComputeAutoCommentFilePath(
				"/home/john/fwrepo/fw/DistFiles",
				"/home/steve/fwrepo/fw/DistFiles/Language Explorer/Configuration/Parts/LexEntry.fwlayout"
			);
			Assert.That(
				result,
		...
		private static readonly string FwlayoutData =
			...
			+ Environment.NewLine
			+ "      <indent><part ref=\"VariantForms\"/></indent>"
			+ Environment.NewLine
			+ "    </part>"
			+ Environment.NewLine
			...
			+ "  </layout>"
			+ Environment.NewLine
			+ "  <layout class=\"LexEntry\" type=\"detail\" name=\"AsVariantForm\">"
			+ Environment.NewLine
			+ "    <part ref=\"AsVariantForm\"/>"
			+ Environment.NewLine
			+ "  </layout>"
			+ Environment.NewLine
			+ "  <layout class=\"LexEntry\" type=\"jtview\" name=\"CrossRefPub\">"
			+ Environment.NewLine
			+ "    <part ref=\"MLHeadWordPub\" label=\"Headword\" before=\" CrossRef:\" after=\". \" visibility=\"ifdata\" ws=\"vernacular\" sep=\"; \" showLabels=\"false\" style=\"Dictionary-CrossReferences\"/>"
			+ Environment.NewLine
			+ "  </layout>"
			+ Environment.NewLine
			+ "  <layout class=\"LexEntry\" type=\"jtview\" name=\"SubentryUnderPub\">"
			+ Environment.NewLine
			+ "    <part ref=\"MLHeadWordPub\" label=\"Headword\" before=\" [\" after=\"]\" visibility=\"ifdata\" ws=\"vernacular\" sep=\"; \" hideConfig=\"true\" showLabels=\"false\" style=\"Dictionary-CrossReferences\"/>"
			+ Environment.NewLine
			+ "  </layout>"
			+ Environment.NewLine
			+ "</LayoutInventory>";
		...
		public void TestReadingDetailConfigData()
		{
			...
			//SUT
			XmlToPo.ProcessConfigElement(
				xdoc.Root,
				"/Language Explorer/Configuration/Parts/LexEntry.fwlayout",
				poStrings
			);
			...
			Assert.That(
				postr5.MsgId[0],
				Is.EqualTo("Grammatical Info. Details"),
				"Detail Config string[5].MsgId[0]"
			);
			Assert.That(
				postr5.MsgIdAsString(),
				Is.EqualTo("Grammatical Info. Details"),
				"Detail Config string[5] is 'Grammatical Info. Details'"
			);
			...
			Assert.That(
				...
				Is.EqualTo(1),
				"Detail Config string[5].AutoComments.Count"
			);
			Assert.That(
				...
				"Detail Config string[5].AutoComments[0]"
			);
			...
			Assert.That(
				postr8.MsgId[0],
				Is.EqualTo("Headword"),
				"Detail Config string[8].MsgId[0]"
			);
			Assert.That(
				poStrings[8].MsgIdAsString(),
				Is.EqualTo("Headword"),
				"Detail Config string[8] is 'Headword'"
			);
			...
			Assert.That(
				postr8.AutoComments.Count,
				Is.EqualTo(1),
				"Detail Config string[8].AutoComments.Count"
			);
			Assert.That(
				postr8.AutoComments[0],
				Is.EqualTo(
				...
				"Detail Config string[8].AutoComments[0]"
			);
			...
			Assert.That(
				postr10.MsgId.Count,
				Is.EqualTo(1),
				"Detail Config string[10].MsgId.Count"
			);
			Assert.That(
				postr10.MsgId[0],
				Is.EqualTo(" CrossRef:"),
				"Detail Config string[10].MsgId[0]"
			);
			Assert.That(
				poStrings[10].MsgIdAsString(),
				Is.EqualTo(" CrossRef:"),
				"Detail Config string[8] is ' CrossRef:'"
			);
			Assert.That(
				postr10.HasEmptyMsgStr,
				Is.True,
				"Detail Config string[10].HasEmptyMsgStr"
			);
			...
			Assert.That(
				postr10.AutoComments,
				Is.Not.Null,
				"Detail Config string[10].AutoComments"
			);
			Assert.That(
				postr10.AutoComments.Count,
				Is.EqualTo(1),
				"Detail Config string[10].AutoComments.Count"
			);
			Assert.That(
				postr10.AutoComments[0],
				Is.EqualTo(
				...
				"Detail Config string[10].AutoComments[0]"
			);
			...
			Assert.That(
				postr11.MsgId.Count,
				Is.EqualTo(1),
				"Detail Config string[11].MsgId.Count"
			);
			Assert.That(
				postr11.MsgId[0],
				Is.EqualTo("Headword"),
				"Detail Config string[11].MsgId[0]"
			);
			Assert.That(
				poStrings[11].MsgIdAsString(),
				Is.EqualTo("Headword"),
				"Detail Config string[8] is 'Headword'"
			);
			Assert.That(
				postr11.HasEmptyMsgStr,
				Is.True,
				"Detail Config string[11].HasEmptyMsgStr"
			);
			...
			Assert.That(
				postr11.AutoComments,
				Is.Not.Null,
				"Detail Config string[11].AutoComments"
			);
			Assert.That(
				postr11.AutoComments.Count,
				Is.EqualTo(1),
				"Detail Config string[11].AutoComments.Count"
			);
			Assert.That(
				postr11.AutoComments[0],
				Is.EqualTo(
				...
				"Detail Config string[11].AutoComments[0]"
			);
		}

		#region DictConfigData
		private const string DictConfigData =
			@"<?xml version=""1.0"" encoding=""utf-8""?>
<DictionaryConfiguration name=""Root-based (complex forms as subentries)"" allPublications=""true"" version=""1"" lastModified=""2014-10-07"">
	...
	<SharedItems>
		...
		public void TestReadingDictConfigData()
		{
			...
			Assert.That(xdoc.Root, Is.Not.Null);
			//SUT
			XmlToPo.ProcessFwDictConfigElement(
				xdoc.Root,
				"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig",
				poStrings
			);
			...
			Assert.That(
				postr0.MsgId[0],
				Is.EqualTo("Root-based (complex forms as subentries)"),
				"fwdictconfig string[0].MsgId[0]"
			);
			Assert.That(
				postr0.MsgIdAsString(),
				Is.EqualTo("Root-based (complex forms as subentries)"),
				"fwdictconfig string[0] is 'Root-based (complex forms as subentries)'"
			);
			...
			Assert.That(
				...
				Is.EqualTo(1),
				"fwdictconfig string[0].AutoComments.Count"
			);
			Assert.That(
				postr0.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://DictionaryConfiguration/@name"
				),
				"fwdictconfig string[0].AutoComments[0]"
			);
			...
			Assert.That(
				postr5.MsgId[0],
				Is.EqualTo("Grammatical Info."),
				"fwdictconfig string[5].MsgId[0]"
			);
			Assert.That(
				postr5.MsgIdAsString(),
				Is.EqualTo("Grammatical Info."),
				"fwdictconfig string[5] is 'Grammatical Info.'"
			);
			...
			Assert.That(
				postr5.AutoComments.Count,
				Is.EqualTo(1),
				"fwdictconfig string[5].AutoComments.Count"
			);
			Assert.That(
				postr5.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Senses']/ConfigurationItem/@name"
				),
				"fwdictconfig string[5].AutoComments[0]"
			);
			...
			Assert.That(
				postr34.MsgId.Count,
				Is.EqualTo(1),
				"fwdictconfig string[34].MsgId.Count"
			);
			Assert.That(
				postr34.MsgId[0],
				Is.EqualTo("Date Modified"),
				"fwdictconfig string[34].MsgId[0]"
			);
			Assert.That(
				postr34.MsgIdAsString(),
				Is.EqualTo("Date Modified"),
				"fwdictconfig string[34] is 'Date Modified'"
			);
			Assert.That(
				postr34.HasEmptyMsgStr,
				Is.True,
				"fwdictconfig string[34].HasEmptyMsgStr"
			);
			...
			Assert.That(
				postr34.AutoComments,
				Is.Not.Null,
				"fwdictconfig string[34].AutoComments"
			);
			Assert.That(
				postr34.AutoComments.Count,
				Is.EqualTo(1),
				"fwdictconfig string[34].AutoComments.Count"
			);
			Assert.That(
				postr34.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Minor Entry (Complex Forms)']/ConfigurationItem/@name"
				),
				"fwdictconfig string[34].AutoComments[0]"
			);
			...
			Assert.That(
				postr35.MsgId.Count,
				Is.EqualTo(1),
				"fwdictconfig string[35].MsgId.Count"
			);
			Assert.That(
				postr35.MsgId[0],
				Is.EqualTo("modified on: "),
				"fwdictconfig string[35].MsgId[0]"
			);
			Assert.That(
				postr35.MsgIdAsString(),
				Is.EqualTo("modified on: "),
				"fwdictconfig string[35] is 'modified on: '"
			);
			Assert.That(
				postr35.HasEmptyMsgStr,
				Is.True,
				"fwdictconfig string[35].HasEmptyMsgStr"
			);
			...
			Assert.That(
				postr35.AutoComments,
				Is.Not.Null,
				"fwdictconfig string[35].AutoComments"
			);
			Assert.That(
				postr35.AutoComments.Count,
				Is.EqualTo(1),
				"fwdictconfig string[35].AutoComments.Count"
			);
			Assert.That(
				postr35.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Date Modified']/@before"
				),
				"fwdictconfig string[35].AutoComments[0]"
			);
			...
			Assert.That(
				postr38.MsgId.Count,
				Is.EqualTo(1),
				"fwdictconfig string[38].MsgId.Count"
			);
			Assert.That(
				postr38.MsgId[0],
				Is.EqualTo("Subsubentries"),
				"fwdictconfig string[38].MsgId[0]"
			);
			Assert.That(
				postr38.MsgIdAsString(),
				Is.EqualTo("Subsubentries"),
				"fwdictconfig string[38].MsgIdAsString()"
			);
			...
			Assert.That(
				postr38.AutoComments,
				Is.Not.Null,
				"fwdictconfig string[38].AutoComments"
			);
			Assert.That(
				postr38.AutoComments.Count,
				Is.EqualTo(1),
				"fwdictconfig string[38].AutoComments.Count"
			);
			Assert.That(
				postr38.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='MainEntrySubentries']/ConfigurationItem/@name"
				),
				"fwdictconfig string[38].AutoComments[0]"
			);

			Assert.That(
				poStrings.Any(poStr => poStr.MsgIdAsString() == "MainEntrySubentries"),
				Is.False,
				"Shared Items' labels should not be translatable"
			);
		}
		...
		public void TestWriteAndReadPoFile()
		{
			...
			Assert.That(
				posHeadword.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/Configuration/Parts/LexEntry.fwlayout::/LayoutInventory/layout[\"LexEntry-jtview-CrossRefPub\"]/part[@ref=\"MLHeadWordPub\"]/@label"
				)
			);
			Assert.That(
				posHeadword.AutoComments[1],
				Is.EqualTo(
					"/Language Explorer/Configuration/Parts/LexEntry.fwlayout::/LayoutInventory/layout[\"LexEntry-jtview-SubentryUnderPub\"]/part[@ref=\"MLHeadWordPub\"]/@label"
				)
			);
			Assert.That(
				posHeadword.AutoComments[2],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Main Entry']/ConfigurationItem/@name"
				)
			);
			Assert.That(
				posHeadword.AutoComments[3],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='MainEntrySubentries']/ConfigurationItem/@name"
				)
			);
			Assert.That(
				posHeadword.AutoComments[4],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Minor Entry (Complex Forms)']/ConfigurationItem/@name"
				)
			);
			...
			Assert.That(
				posComma.AutoComments[0],
				Is.EqualTo(
					"/Language Explorer/DefaultConfigurations/Dictionary/Root.fwdictconfig:://ConfigurationItem[@name='Allomorphs']/@between"
				)
			);
		...
		public void POString_Sort()
		{
			var poStrings = new[]
			{
				...
				.Select(msgId => new POString(null, new[] { msgId }))
				.ToList();
			// SUT
			poStrings.Sort(POString.CompareMsgIds);
		...
		private static void AssertArraysAreEqual(
			IReadOnlyList<string> arr1,
			IReadOnlyList<string> arr2
		)
		{
		...
		{
			var poStr = new POString(
				new[]
				{
					"Displayed in a message box.",
					"/Src/FwResources//FwStrings.resx::kstidFatalError2",
				},
				new[]
				{
					@"\n",
			...
			Assert.That(
				poStr.MsgId.Count,
				Is.EqualTo(5),
				"First resx string has five lines of MsgId data"
			);
			Assert.That(
				poStr.MsgId[0],
				Is.EqualTo("\\n"),
			...
			Assert.That(
				poStr.MsgId[4],
				Is.EqualTo("You should be able to restart it normally.\\n"),
				"First resx string has the expected MsgId data line five"
			);
			Assert.That(
				poStr.HasEmptyMsgStr,
				Is.True,
				"First resx string has no MsgStr data (as expected)"
			);
			Assert.That(
				poStr.UserComments,
				Is.Null,
				"First resx string has no User Comments (as expected)"
			);
			Assert.That(
				poStr.References,
				Is.Null,
				"First resx string has no Reference data (as expected)"
			);
			...
			Assert.That(
				poStr.AutoComments.Count,
				Is.EqualTo(2),
				"First resx string has two lines of Auto Comments"
			);
			Assert.That(
				poStr.AutoComments[0],
				Is.EqualTo("Displayed in a message box."),
				"First resx string has the expected Auto Comment line one"
			);
			Assert.That(
				poStr.AutoComments[1],
				Is.EqualTo("/Src/FwResources//FwStrings.resx::kstidFatalError2"),
				"First resx string has the expected Auto Comment line two"
			);
			...
			Assert.That(
				serializedPo,
				Is.Not.Null,
				"Writing resx strings' po data produced output"
			);
			var poLines = serializedPo.Split(
			...
			Assert.That(
				poStrB,
				Is.Not.Null,
				"Read second message from leading newline test data"
			);
			...
			CheckStringList(
				poStr.MsgId,
				poStrA.MsgId,
				"Preserve MsgId in first message from leading newline test data"
			);
			CheckStringList(
				poStr.MsgStr,
				poStrA.MsgStr,
				"Preserve MsgStr in first message from leading newline test data"
			);
			CheckStringList(
				poStr.UserComments,
				poStrA.UserComments,
				"Preserve UserComments in first message from leading newline test data"
			);
			CheckStringList(
				poStr.References,
				poStrA.References,
				"Preserve Reference in first message from leading newline test data"
			);
			CheckStringList(
				poStr.Flags,
				poStrA.Flags,
				"Preserve Flags in first message from leading newline test data"
			);
			CheckStringList(
				poStr.AutoComments,
				poStrA.AutoComments,
