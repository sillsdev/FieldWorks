...
namespace SIL.FieldWorks.Build.Tasks.FwBuildTasksTests
{
	...
	internal class GoldEticToXliffTests
	{
		...
		public void IntegrationTest()
		{
			...
			{
				SourceXml = @"..\..\..\..\DistFiles\Templates\GOLDEtic.xml", Is.True, XliffOutputDir = outputDir
			}.Execute());
			...
			{
				XliffSourceFiles = outputFiles, Is.True, OutputXml = Path.Combine(outputDir, "..", "GOLDEticRoundtripped.xml")
			}.Execute());
		}
	}
}