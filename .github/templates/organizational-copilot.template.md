...
## Purpose
This folder groups related FieldWorks components and does not contain code directly. Use the subfolder map below to navigate to concrete implementations.
